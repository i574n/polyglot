...
{ . "../apps/parser/target/bin/Release/net8.0/DibParser$(if ($IsWindows) { '.exe' } else { '' })" "Async.dib;AsyncSeq.dib;Common.dib;FileSystem.dib;Networking.dib;Runtime.dib;Toml.dib" } | Invoke-Block
