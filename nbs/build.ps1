...
{ dotnet repl --run ../apps/parser/DibParser.dib --exit-after-run } | Invoke-Block -EnvironmentVariables @{ "OUTPUT" = "Async.dib;AsyncSeq.dib;Common.dib;FileSystem.dib;Networking.dib;Runtime.dib" }
