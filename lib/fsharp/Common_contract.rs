pub mod Polyglot {
    ...
    pub mod Common {
        ...
        pub enum TraceLevel { Verbose, Debug, Info, Warning, Critical, }
        ...
        /// ## trace
        pub fn to_trace_level(_arg: LrcPtr<Polyglot::Common::TraceLevel>)
         -> US0 {
            match _arg.as_ref() {
        ...
        pub fn trace(level: LrcPtr<Polyglot::Common::TraceLevel>,
                     r#fn: Func0<string>, locals: Func0<string>) {
