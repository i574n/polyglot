pub mod Networking {
    ...
    #[derive(Clone, Copy, Debug, PartialEq, PartialOrd, Hash, Eq,)]
    pub enum US1 { US1_0(Networking::US0), US1_1, }
    ...
    pub fn closure0(unitVar: (), v0: Networking::US0)
     ->
            ...
            let x_2: (Networking::US1, Networking::US2) =
                (Networking::US1::US1_1,
                 if match &_v88.get().clone() {
                     ...
                     Networking::US2::US2_0(near_sdk::env::block_timestamp()
                                                as i64)
                 });
            _v3.set(Some(x_2))
        }
        {
            let patternInput: (Networking::US1, Networking::US2) =
                match &_v3.get().clone() {
                    None =>
    ...
    pub fn closure6(v0: Networking::US0, v1: Func0<string>,
        ...
        }
        {
            ...
            let _v334: LrcPtr<MutCell<Option<Networking::US2>>> =
                refCell(None::<Networking::US2>);
            {
                let x_2: Option<Networking::US2> =
                    match &v18 {
            ...
            }
            {
                ...
                }
                {
                    ...
                    let v985: Networking::US3 =
                        if if let Networking::US0::US0_0 = &v0 {
                               true
                           } else { false } {
                            Networking::US3::US3_0(string("Verbose"))
                        } else { Networking::US3::US3_1 };
                    let v1034: Networking::US3 =
                        match &v985 {
                            Networking::US3::US3_0(v985_0_0) =>
                            Networking::US3::US3_0(match &v985 {
                                                       Networking::US3::US3_0(x)
                                                       => x.clone(),
                                                       _ => unreachable!(),
                                                   }),
                            _ => {
                                let v994: Networking::US3 =
                                    if if let Networking::US0::US0_1 = &v0 {
                                           true
                                       } else { false } {
                                ...
                                match &v994 {
                                    ...
                                    _ => {
                                        let v1003: Networking::US3 =
                                            if if let Networking::US0::US0_2 =
                                                      &v0 {
                                                   true
                                               } else { false } {
                                        ...
                                        match &v1003 {
                                            ...
                                            _ => {
                                                let v1012: Networking::US3 =
                                                    if if let Networking::US0::US0_3
                                                              = &v0 {
                                                           true
                                                       } else { false } {
                                                ...
                                                match &v1012 {
                                                    ...
                                                    _ => {
                                                        let v1021:
                                                                Networking::US3 =
                                                            if if let Networking::US0::US0_4
                                                                      = &v0 {
                                                                   true
                                                               } else {
                                                                   false
                    ...
                    let v1051: string =
                        padLeft(toLower(match &v1034 {
                                            Networking::US3::US3_0(v1034_0_0)
                                            =>
                                            match &v1034 {
                                                Networking::US3::US3_0(x) =>
                                                x.clone(),
                    ...
                    }
                    {
                        ...
                        let v1218: LrcPtr<Networking::Mut4> =
                            LrcPtr::new(Networking::Mut4{l0:
                                                             MutCell::new(string("")),});
                        Networking::method8(v1218.clone(),
    ...
    pub fn method4(v0: Networking::US0, v1: Func0<string>,
                   v2_1: Func0<(i32, string)>) {
        Networking::method12(v0.clone(),
                             Func0::new({
                                            let v0 = v0.clone();
                                            let v1 = v1.clone();
                                            let v2_1 = v2_1.clone();
                                            move ||
                                                Networking::closure6(v0.clone(),
                                                                     v1.clone(),
                                                                     v2_1.clone(),
                                                                     ())
                                        }));
    ...
    pub fn closure3(v0: string, v1: i32) -> Arc<Async<bool>> {
        let _v4: MutCell<Option<Arc<Async<bool>>>> =
            MutCell::new(None::<Arc<Async<bool>>>);
        { let x: Arc<Async<bool>> = defaultOf(); _v4.set(Some(x)) }
        match &_v4.get().clone() {
    ...
    pub fn closure13(v0: i32, unitVar: ()) -> i32 { v0 }
    ...
    pub fn closure14(v0: Networking::US0, v1: Func0<string>, v2_1: Func0<i32>,
                     unitVar: ()) -> string {
        if Networking::State::trace_state().get().clone().is_none() {
            Networking::State::trace_state().set(Some(Networking::closure0((),
                                                                           Networking::US0::US0_0)));
            ...
            }
            {
                ...
                }
                {
                    ...
                    }
                    {
                        ...
                        let v1214: i64 =
                            (patternInput.0.clone()).l0.get().clone();
                        let v1217: LrcPtr<Networking::Mut4> =
                            LrcPtr::new(Networking::Mut4{l0:
                                                             MutCell::new(string("")),});
    ...
    pub fn closure16(v0: i32, v1: LrcPtr<Exception>, unitVar: ())
     -> (i32, string) {
        let _v4: MutCell<Option<string>> = MutCell::new(None::<string>);
        { let x: string = sprintf!("{:?}", v1); _v4.set(Some(x)) }
        (v0,
         match &_v4.get().clone() {
             None => panic!("{}", string("base.run_target / _v4=None"),),
             Some(_v4_0_0) => _v4_0_0.clone(),
    ...
    pub fn closure17(v0: Networking::US0, v1: Func0<string>,
                     v2_1: Func0<(i32, string)>, unitVar: ()) -> string {
        if Networking::State::trace_state().get().clone().is_none() {
            Networking::State::trace_state().set(Some(Networking::closure0((),
                                                                           Networking::US0::US0_0)));
                ...
                }
                {
                    ...
                    }
                    {
                        ...
                        let v1218: LrcPtr<Networking::Mut4> =
                            LrcPtr::new(Networking::Mut4{l0:
                                                             MutCell::new(string("")),});
                        Networking::method16(v1218.clone(),
                                             patternInput_1.0.clone(),
                                             patternInput_1.1.clone());
                        {
                            let v1219: string = v1218.l0.get().clone();
    ...
    pub fn method15(v0: Networking::US0, v1: Func0<string>,
                    v2_1: Func0<(i32, string)>) {
        Networking::method12(v0.clone(),
                             Func0::new({
                                            let v0 = v0.clone();
    ...
    pub fn closure9(v0: i32, v1: string, v2_1: i32) -> Arc<Async<bool>> {
        let _v5: MutCell<Option<Arc<Async<bool>>>> =
            MutCell::new(None::<Arc<Async<bool>>>);
        { let x: Arc<Async<bool>> = defaultOf(); _v5.set(Some(x)) }
        match &_v5.get().clone() {
    ...
    pub fn closure7(unitVar: (), v0: i32)
    ...
    pub fn closure23(v0: Option<i32>, v1: bool, v2_1: i32, v3_1: i64,
                     unitVar: ()) -> (i32, i64, Option<i32>, bool) {
        (v2_1, v3_1, v0, v1)
    }
    ...
    pub fn method19(v0: LrcPtr<Networking::Mut4>, v1: i32, v2_1: i64,
                    v3_1: Option<i32>, v4: bool) {
        Networking::method9(v0.clone(), string("{ "));
        Networking::method10(v0.clone());
        Networking::method9(v0.clone(), string("port"));
        Networking::method9(v0.clone(), string(" = "));
    ...
    pub fn closure24(v0: Networking::US0, v1: Func0<string>,
                     v2_1: Func0<(i32, i64, Option<i32>, bool)>, unitVar: ())
     -> string {
        if Networking::State::trace_state().get().clone().is_none() {
            Networking::State::trace_state().set(Some(Networking::closure0((),
                                                                           Networking::US0::US0_0)));
            ...
            }
            {
                ...
                }
                {
                    ...
                    }
                    {
                        ...
                        let v1214: i64 =
                            (patternInput.0.clone()).l0.get().clone();
                        let patternInput_1: (i32, i64, Option<i32>, bool) =
                            v2_1();
                        let v1220: LrcPtr<Networking::Mut4> =
                            LrcPtr::new(Networking::Mut4{l0:
                                                             MutCell::new(string("")),});
                        Networking::method19(v1220.clone(),
                                             patternInput_1.0.clone(),
                                             patternInput_1.1.clone(),
    ...
    pub fn method18(v0: Networking::US0, v1: Func0<string>,
        ...
        Networking::method12(v0.clone(),
                             Func0::new({
                                            ...
                                            let v2_1 = v2_1.clone();
                                            move ||
                                                Networking::closure24(v0.clone(),
                                                                      v1.clone(),
                                                                      v2_1.clone(),
                                                                      ())
                                        }));
    }
    pub fn method17(v0: Option<i32>, v1: bool, v2_1: string, v3_1: i32,
                    v4: i64) -> Arc<Async<i64>> {
        let _v7: MutCell<Option<Arc<Async<i64>>>> =
            MutCell::new(None::<Arc<Async<i64>>>);
        { let x: Arc<Async<i64>> = defaultOf(); _v7.set(Some(x)) }
        match &_v7.get().clone() {
            None => panic!("{}", string("base.run_target / _v7=None"),),
            Some(_v7_0_0) => _v7_0_0.clone(),
        }
    }
    pub fn closure21(v0: Option<i32>, v1: bool, v2_1: string, v3_1: i32)
     -> Arc<Async<i64>> {
        Networking::method17(v0, v1, v2_1, v3_1, 0_i64)
    }
    pub fn closure20(v0: Option<i32>, v1: bool, v2_1: string)
     -> Func1<i32, Arc<Async<i64>>> {
        Func1::new({
                       ...
                       let v2_1 = v2_1.clone();
                       move |v: i32|
                           Networking::closure21(v0.clone(), v1, v2_1.clone(),
                                                 v)
                   })
    }
    pub fn closure19(v0: Option<i32>, v1: bool)
     -> Func1<string, Func1<i32, Arc<Async<i64>>>> {
        Func1::new({
                       let v0 = v0.clone();
                       let v1 = v1.clone();
                       move |v: string|
                           Networking::closure20(v0.clone(), v1, v)
                   })
    }
    pub fn closure18(unitVar: (), v0: Option<i32>)
    ...
    pub fn method23(v0: Option<i32>, v1: string, v2_1: i32)
     -> Arc<Async<i32>> {
        let _v5: MutCell<Option<Arc<Async<i32>>>> =
            MutCell::new(None::<Arc<Async<i32>>>);
        { let x: Arc<Async<i32>> = defaultOf(); _v5.set(Some(x)) }
        match &_v5.get().clone() {
            None => panic!("{}", string("base.run_target / _v5=None"),),
            Some(_v5_0_0) => _v5_0_0.clone(),
        }
    }
    pub fn closure27(v0: Option<i32>, v1: string, v2_1: i32)
     -> Arc<Async<i32>> {
        Networking::method23(v0, v1, v2_1)
    }
    pub fn closure26(v0: Option<i32>, v1: string)
     -> Func1<i32, Arc<Async<i32>>> {
        Func1::new({
                       let v0 = v0.clone();
                       let v1 = v1.clone();
                       move |v: i32|
                           Networking::closure27(v0.clone(), v1.clone(), v)
                   })
    }
    pub fn closure25(unitVar: (), v0: Option<i32>)
    ...
    pub fn v2()
     ->
         Func1<Networking::US0,
               (LrcPtr<Networking::Mut0>, LrcPtr<Networking::Mut1>,
                LrcPtr<Networking::Mut2>, LrcPtr<Networking::Mut3>,
                Option<i64>)> {
        static v2:
         OnceInit<Func1<Networking::US0,
                        (LrcPtr<Networking::Mut0>, LrcPtr<Networking::Mut1>,
                         LrcPtr<Networking::Mut2>, LrcPtr<Networking::Mut3>,
                         Option<i64>)>> =
            OnceInit::new();
        v2.get_or_init(||
                           Func1::new(move |v: Networking::US0|
                                          Networking::closure0((),
                                                               v))).clone()
    }
    ...
    on_startup!(if Networking::State::trace_state().get().clone().is_none() {
    Networking::State::trace_state().set(Some((Networking::v2())(Networking::v3())));
});
    pub fn v9() -> Func1<string, Func1<i32, Arc<Async<bool>>>> {
        static v9: OnceInit<Func1<string, Func1<i32, Arc<Async<bool>>>>> =
            OnceInit::new();
        v9.get_or_init(||
