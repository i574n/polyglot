pub mod Networking {
    ...
    pub fn closure21(v0_1: i32, v1_1: LrcPtr<Exception>, unitVar: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let v567: LrcPtr<Networking::Mut4> =
                LrcPtr::new(Networking::Mut4{l0:
                                                 MutCell::new(Networking::method8()),});
            let v578: () =
                {
                    Networking::closure10(v567.clone(),
                                          sprintf!("{}",
                                                   sprintf!("{:?}",
            ...
            let v589: LrcPtr<Networking::Mut4> =
                LrcPtr::new(Networking::Mut4{l0:
                                                 MutCell::new(Networking::method8()),});
            let v600: () =
                {
                    Networking::closure10(v589.clone(),
                                          sprintf!("{}",
                                                   sprintf!("{:?}",
                                                            Networking::US0::US0_4)),
                                          ());
                    ()
                };
            let v610: Networking::US1 =
                if startsWith(v589.l0.get().clone(), v585, false) {
                    Networking::US1::US1_0(string("Verbose"))
                } else { Networking::US1::US1_1 };
            let v799: Networking::US1 =
                match &v610 {
                    Networking::US1::US1_0(v610_0_0) =>
                    Networking::US1::US1_0(match &v610 {
                    ...
                    _ => {
                        ...
                        let v648: LrcPtr<Networking::Mut4> =
                            LrcPtr::new(Networking::Mut4{l0:
                                                             MutCell::new(Networking::method8()),});
                        let v659: () =
                            {
                                Networking::closure10(v648.clone(),
                                                      sprintf!("{}",
                                                               sprintf!("{:?}",
                                                                        Networking::US0::US0_4)),
                                                      ());
                        ...
                        let v669: Networking::US1 =
                            if startsWith(v648.l0.get().clone(), v644, false)
                               {
                                Networking::US1::US1_0(string("Debug"))
                            } else { Networking::US1::US1_1 };
                        match &v669 {
                            Networking::US1::US1_0(v669_0_0) =>
                            Networking::US1::US1_0(match &v669 {
                                                       Networking::US1::US1_0(x)
                                                       => x.clone(),
                                                       _ => unreachable!(),
                                                   }),
                            _ => {
                                ...
                                let v685: LrcPtr<Networking::Mut4> =
                                    LrcPtr::new(Networking::Mut4{l0:
                                                                     MutCell::new(Networking::method8()),});
                                let v696: () =
                                    {
                                        Networking::closure10(v685.clone(),
                                                              sprintf!("{}",
                                                                       sprintf!("{:?}",
                                ...
                                let v707: LrcPtr<Networking::Mut4> =
                                    LrcPtr::new(Networking::Mut4{l0:
                                                                     MutCell::new(Networking::method8()),});
                                let v718: () =
                                    {
                                        Networking::closure10(v707.clone(),
                                                              sprintf!("{}",
                                                                       sprintf!("{:?}",
                                                                                Networking::US0::US0_4)),
                                                              ());
                                ...
                                match &v728 {
                                    ...
                                    _ => {
                                        ...
                                        let v755: () =
                                            {
                                                Networking::closure10(v744.clone(),
                                                                      sprintf!("{}",
                                                                               sprintf!("{:?}",
                                        ...
                                        let v777: () =
                                            {
                                                Networking::closure10(v766.clone(),
                                                                      sprintf!("{}",
                                                                               sprintf!("{:?}",
                                                                                        Networking::US0::US0_4)),
                                                                      ());
                                        ...
                                        match &v787 {
                                            ...
                                            _ =>
                                            Networking::US1::US1_0(string("Critical")),
                                        }
                                    }
                                }
                            }
            ...
            let v898: LrcPtr<Networking::Mut4> =
                LrcPtr::new(Networking::Mut4{l0:
                                                 MutCell::new(Networking::method8()),});
            let v905: () =
                {
                    Networking::closure10(v898.clone(),
                                          sprintf!("{}", string("{ ")), ());
                    ()
                };
            let v914: () =
    ...
    pub fn method11(v0_1: Option<i32>, v1_1: bool, v2_1: string, v3: i32,
    ...
    pub fn method12(v0_1: Option<i32>, v1_1: string, v2_1: i32)
     -> Arc<Async<i32>> {
        defaultOf()
    }
