...
import { trimStart, trimEnd, padRight } from "../../deps/Fable/src/fable-library-ts/String.js";
...
export function method3(): ((arg0: int64) => US2_$union) {
    return (v: int64): US2_$union => closure6(void 0, v);
}
...
export function method2(v0_1: US0_$union, v1_1: (() => string), v2_1: (() => string)): void {
    method5(v0_1, (): string => closure5(v0_1, v1_1, v2_1, void 0));
}
...
export function closure12(v0_1: int32, unitVar: void): string {
    return `timeout: ${v0_1} / ${closure4(void 0, void 0)}`;
}
...
export function method7(): ((arg0: int32) => US6_$union) {
    return (v: int32): US6_$union => closure17(void 0, v);
}
...
export function closure19(v0_1: int32, v1_1: int64, unitVar: void): string {
    return `port: ${v0_1} / retry: ${v1_1} / ${closure4(void 0, void 0)}`;
}
...
export const v1 = (v: int32): any => closure2(void 0, v);

export function test_port_open(x: int32): any {
    return v1(x);
}

export const v2 = (v: int32): ((arg0: int32) => any) => closure7(void 0, v);

export function test_port_open_timeout(x: int32): ((arg0: int32) => any) {
    return v2(x);
}

export const v3 = (v: Option<int32>): ((arg0: boolean) => ((arg0: int32) => any)) => closure14(void 0, v);

export function wait_for_port_access(x: Option<int32>): ((arg0: boolean) => ((arg0: int32) => any)) {
    return v3(x);
}

export const v4 = (v: Option<int32>): ((arg0: int32) => any) => closure20(void 0, v);
