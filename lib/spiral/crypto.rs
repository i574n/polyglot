pub mod Crypto {
    ...
    pub fn closure6(
        ...
        let v9: Crypto::US2 = if string("Verbose") == v3.clone() {
            Crypto::US2::US2_0(Crypto::US0::US0_0)
        } else {
            Crypto::US2::US2_1
        };
        let v54: Crypto::US2 = match &v9 {
            Crypto::US2::US2_0(v9_0_0) => Crypto::US2::US2_0(match &v9 {
                Crypto::US2::US2_0(x) => x.clone(),
                _ => unreachable!(),
            }),
            _ => {
                let v17: Crypto::US2 = if string("Debug") == v3.clone() {
                    Crypto::US2::US2_0(Crypto::US0::US0_1)
                } else {
                    Crypto::US2::US2_1
                };
                match &v17 {
                    Crypto::US2::US2_0(v17_0_0) => Crypto::US2::US2_0(match &v17 {
                        Crypto::US2::US2_0(x) => x.clone(),
                        _ => unreachable!(),
                    }),
                    _ => {
                        let v25: Crypto::US2 = if string("Info") == v3.clone() {
                            Crypto::US2::US2_0(Crypto::US0::US0_2)
                        } else {
                            Crypto::US2::US2_1
                        };
                        match &v25 {
                            Crypto::US2::US2_0(v25_0_0) => Crypto::US2::US2_0(match &v25 {
                                Crypto::US2::US2_0(x) => x.clone(),
                                _ => unreachable!(),
                            }),
                            _ => {
                                let v33: Crypto::US2 = if string("Warning") == v3.clone() {
                                    Crypto::US2::US2_0(Crypto::US0::US0_3)
                                } else {
                                    Crypto::US2::US2_1
                                };
                                match &v33 {
                                    Crypto::US2::US2_0(v33_0_0) => Crypto::US2::US2_0(match &v33 {
                                        Crypto::US2::US2_0(x) => x.clone(),
                                        _ => unreachable!(),
                                    }),
                                    _ => {
                                        let v41: Crypto::US2 = if string("Critical") == v3.clone() {
                                            Crypto::US2::US2_0(Crypto::US0::US0_4)
                                        } else {
                                            Crypto::US2::US2_1
                                        };
                                        match &v41 {
                                            Crypto::US2::US2_0(v41_0_0) => {
                                                Crypto::US2::US2_0(match &v41 {
                                                    Crypto::US2::US2_0(x) => x.clone(),
                                                    _ => unreachable!(),
                                                })
                                            }
    ...
    pub fn closure5(
        ...
        }
        {
            ...
            let _v11: LrcPtr<MutCell<Option<Crypto::US1>>> = refCell(None::<Crypto::US1>);
            {
            ...
            {
                let v16: Crypto::US1 = defaultValue(Crypto::US1::US1_1, _v11.get().clone());
                let v35: DateTime = match &v16 {
                    Crypto::US1::US1_0(v16_0_0) => {
