pub mod Crypto {
    ...
    pub fn closure6(
        ...
        let v24: Crypto::US2 = if string("Verbose") == v3.clone() {
        ...
        }
        {
            ...
            let v139: Crypto::US2 = patternInput.1.clone();
            let v138: Crypto::US1 = patternInput.0.clone();
            let v147: LrcPtr<Crypto::Mut4> = LrcPtr::new(Crypto::Mut4 {
            ...
            (
                ...
                LrcPtr::new(Crypto::Mut3 {
                    l0: MutCell::new(match &v139 {
                        Crypto::US2::US2_0(v139_0_0) => match &v139 {
                ...
                match &v138 {
                    Crypto::US1::US1_0(v138_0_0) => Some(match &v138 {
            ...
            }
            {
                ...
                }
                {
                    ...
                    let v160: string = padLeft(
                        toLower(match &v0_1 {
                            Crypto::US0::US0_1 => string("Debug"),
                            Crypto::US0::US0_2 => string("Info"),
                            Crypto::US0::US0_0 => string("Verbose"),
                            Crypto::US0::US0_3 => string("Warning"),
                            _ => string("Critical"),
                        }),
                        7_i32,
                        ' ',
