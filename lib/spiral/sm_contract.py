...
def closure7(unit_var: None, v0_1: int) -> Callable[[str], str]:
    def _arrow14(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure12(unit_var: None, v0_1: int) -> Callable[[int, str], str]:
    def _arrow18(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure17(unit_var: None, v0_1: Array[str]) -> Callable[[str], Array[str]]:
    def _arrow22(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure27(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    def _arrow27(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure38(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow32(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure40(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow33(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow34(v: str) -> Callable[[str], bool]:
    return closure0(None, v)


v0: Callable[[str, str], bool] = _arrow34

def contains(x: str) -> Callable[[str], bool]:
    return v0(x)


def _arrow35(v: str) -> Callable[[str], bool]:
    return closure2(None, v)


v1: Callable[[str, str], bool] = _arrow35

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow36(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow36

def pad_left(x: int) -> Callable[[str, str], str]:
    return v2(x)


def _arrow37(v: int) -> Callable[[str], str]:
    return closure7(None, v)


v3: Callable[[int, str], str] = _arrow37

def pad_right(x: int) -> Callable[[str], str]:
    return v3(x)


def _arrow38(v: str) -> Callable[[str, str], str]:
    return closure9(None, v)


v4: Callable[[str, str, str], str] = _arrow38
...
v5: Callable[[int, int, str], str] = _arrow39

def slice(x: int) -> Callable[[int, str], str]:
    return v5(x)


def _arrow40(v: str) -> Callable[[str], Array[str]]:
    return closure15(None, v)


v6: Callable[[str, str], Array[str]] = _arrow40

def split(x: str) -> Callable[[str], Array[str]]:
    return v6(x)


def _arrow41(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure17(None, v)


v7: Callable[[Array[str], str], Array[str]] = _arrow41

def split_string(x: Array[str]) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow42(v: str) -> Callable[[str], bool]:
    return closure19(None, v)


v8: Callable[[str, str], bool] = _arrow42
...
v9: Callable[[int, int, str], str] = _arrow43
...
v13: Callable[[Array[str], str], str] = _arrow47
...
v14: Callable[[Array[str], str], str] = _arrow48

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v14(x)


def _arrow49(v: int) -> Callable[[str], str]:
    return closure31(None, v)


v15: Callable[[int, str], str] = _arrow49

def ellipsis(x: int) -> Callable[[str], str]:
    return v15(x)


def _arrow50(v: int64) -> Callable[[str], str]:
    return closure33(None, v)


v16: Callable[[int64, str], str] = _arrow50

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v16(x)


def _arrow51(v: Exception) -> str:
    return closure35(None, v)


v17: Callable[[Exception], str] = _arrow51

def format_exception(x: Exception) -> str:
    return v17(x)


def _arrow52(v: str) -> Callable[[Array[str]], str]:
    return closure36(None, v)


v18: Callable[[str, Array[str]], str] = _arrow52
...
def _arrow54(v: str) -> Callable[[Array[str]], str]:
    return closure40(None, v)


v20: Callable[[str, Array[str]], str] = _arrow54
...
v21: Callable[[str], Array[str]] = _arrow55
