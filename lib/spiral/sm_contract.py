...
def closure0(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow15(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure10(v0_1: str, v1_1: str) -> Callable[[str], str]:
    def _arrow24(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> str:
...
def closure12(unit_var: None, v0_1: int) -> Callable[[int, str], str]:
    def _arrow38(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure17(unit_var: None, v0_1: Array[str]) -> Callable[[str], Array[str]]:
    def _arrow41(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure19(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow42(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure22(v0_1: int, v1_1: int) -> Callable[[str], str]:
    def _arrow43(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> str:
...
def closure21(unit_var: None, v0_1: int) -> Callable[[int, str], str]:
    def _arrow44(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure27(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    def _arrow45(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure29(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    def _arrow46(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure36(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow49(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure38(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow50(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure40(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow51(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow52
...
v1: Callable[[str, str], bool] = _arrow53

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow54(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow54
...
v3: Callable[[int, str], str] = _arrow55
...
v4: Callable[[str, str, str], str] = _arrow56
...
v5: Callable[[int, int, str], str] = _arrow57

def slice(x: int) -> Callable[[int, str], str]:
    return v5(x)


def _arrow58(v: str) -> Callable[[str], Array[str]]:
    return closure15(None, v)


v6: Callable[[str, str], Array[str]] = _arrow58

def split(x: str) -> Callable[[str], Array[str]]:
    return v6(x)


def _arrow59(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure17(None, v)


v7: Callable[[Array[str], str], Array[str]] = _arrow59

def split_string(x: Array[str]) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow60(v: str) -> Callable[[str], bool]:
    return closure19(None, v)


v8: Callable[[str, str], bool] = _arrow60

def starts_with(x: str) -> Callable[[str], bool]:
    return v8(x)


def _arrow61(v: int) -> Callable[[int, str], str]:
    return closure21(None, v)


v9: Callable[[int, int, str], str] = _arrow61
...
v10: Callable[[str], str] = _arrow63

def to_lower(x: str) -> str:
    return v10(x)


def _arrow64(v: str) -> str:
    return closure25(None, v)


v11: Callable[[str], str] = _arrow64

def to_upper(x: str) -> str:
    return v11(x)


def _arrow65(v: str) -> str:
    return closure26(None, v)


v12: Callable[[str], str] = _arrow65

def trim(x: str) -> str:
    return v12(x)


def _arrow67(v: Array[str]) -> Callable[[str], str]:
    return closure27(None, v)


v13: Callable[[Array[str], str], str] = _arrow67

def trim_end(x: Array[str]) -> Callable[[str], str]:
    return v13(x)


def _arrow68(v: Array[str]) -> Callable[[str], str]:
    return closure29(None, v)


v14: Callable[[Array[str], str], str] = _arrow68

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v14(x)


def _arrow69(v: int) -> Callable[[str], str]:
    return closure31(None, v)


v15: Callable[[int, str], str] = _arrow69

def ellipsis(x: int) -> Callable[[str], str]:
    return v15(x)


def _arrow70(v: int64) -> Callable[[str], str]:
    return closure33(None, v)


v16: Callable[[int64, str], str] = _arrow70

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v16(x)


def _arrow71(v: Exception) -> str:
    return closure35(None, v)


v17: Callable[[Exception], str] = _arrow71

def format_exception(x: Exception) -> str:
    return v17(x)


def _arrow72(v: str) -> Callable[[Array[str]], str]:
    return closure36(None, v)


v18: Callable[[str, Array[str]], str] = _arrow72

def concat_array_trailing(x: str) -> Callable[[Array[str]], str]:
    return v18(x)


def _arrow73(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure38(None, v)


v19: Callable[[str, IEnumerable_1[str]], str] = _arrow73

def concat(x: str) -> Callable[[IEnumerable_1[str]], str]:
    return v19(x)


def _arrow74(v: str) -> Callable[[Array[str]], str]:
    return closure40(None, v)


v20: Callable[[str, Array[str]], str] = _arrow74

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v20(x)


def _arrow75(v: str) -> Array[str]:
    return closure42(None, v)


v21: Callable[[str], Array[str]] = _arrow75
