pub mod Sm {
    ...
    pub fn method1(v0_1: string) -> string { v0_1 }
    ...
    pub fn closure15(v0_1: string, v1_1: string, v2_1: string) -> string {
        ...
        { let x: string = unbox::<string>(&defaultOf()); _v6.set(Some(x)) }
        match &_v6.get().clone() {
    ...
    pub fn closure22(v0_1: Array<string>, v1_1: string) -> Array<string> {
        let _v4: MutCell<Option<Array<string>>> =
            MutCell::new(None::<Array<string>>);
        let v51: LrcPtr<dyn IEnumerable_1<string>> = ofArray(v0_1);
        {
            let x: Array<string> =
                split_1(v1_1, join(Sm::method3(), toArray(v51)), -1_i32,
                        0_i32);
            _v4.set(Some(x))
        }
        match &_v4.get().clone() {
    ...
    pub fn closure41(unitVar: (), v0_1: LrcPtr<Exception>) -> string {
        ...
        { let x: string = sprintf!("{:?}", v0_1); _v3.set(Some(x)) }
        match &_v3.get().clone() {
