...
def closure1(unit_var: None, unit_var_1: None) -> str:
    def _arrow120(__unit: None=None, unit_var: Any=unit_var, unit_var_1: Any=unit_var_1) -> bool:
        raise Exception(("platform.is_windows / target: " + str(US1(4, US0(0)))) + "")
...
def _arrow121(__unit: None=None) -> bool:
    return closure0(None, None)


v0: Callable[[], bool] = _arrow121

def is_windows(__unit: None=None) -> bool:
    return v0(None)


def _arrow122(__unit: None=None) -> str:
    return closure1(None, None)


v1: Callable[[], str] = _arrow122
