pub mod Runtime {
    ...
    pub fn closure0(
        ...
        let v9: Runtime::US1 = if string("Verbose") == v3_1.clone() {
        ...
        };
        {
            let x: (Runtime::US1, Runtime::US2) = (
                match &v9 {
                    Runtime::US1::US1_0(v9_0_0) => Runtime::US1::US1_0(match &v9 {
                        Runtime::US1::US1_0(x) => x.clone(),
                        _ => unreachable!(),
                    }),
                    _ => {
                        let v17: Runtime::US1 = if string("Debug") == v3_1.clone() {
                            Runtime::US1::US1_0(Runtime::US0::US0_1)
                        } else {
                            Runtime::US1::US1_1
                        };
                        match &v17 {
                            Runtime::US1::US1_0(v17_0_0) => Runtime::US1::US1_0(match &v17 {
                                Runtime::US1::US1_0(x) => x.clone(),
                                _ => unreachable!(),
                            }),
                            _ => {
                                let v25: Runtime::US1 = if string("Info") == v3_1.clone() {
                                    Runtime::US1::US1_0(Runtime::US0::US0_2)
                                } else {
                                    Runtime::US1::US1_1
                                };
                                match &v25 {
                                    Runtime::US1::US1_0(v25_0_0) => {
                                        Runtime::US1::US1_0(match &v25 {
                                            Runtime::US1::US1_0(x) => x.clone(),
                                            _ => unreachable!(),
                                        })
                                    }
                                    _ => {
                                        let v33: Runtime::US1 = if string("Warning") == v3_1.clone()
                                        {
                                        ...
                                        match &v33 {
                                            Runtime::US1::US1_0(v33_0_0) => {
                                                Runtime::US1::US1_0(match &v33 {
                                                    Runtime::US1::US1_0(x) => x.clone(),
                                                    _ => unreachable!(),
                                                })
                                            }
                                            _ => {
                                                ...
                                                match &v41 {
                                                    Runtime::US1::US1_0(v41_0_0) => {
                                                        Runtime::US1::US1_0(match &v41 {
                                                            Runtime::US1::US1_0(x) => x.clone(),
                                                            _ => unreachable!(),
                                                        })
                                                    }
    ...
    pub fn closure6(
        ...
        }
        {
            ...
            let _v11: LrcPtr<MutCell<Option<Runtime::US2>>> = refCell(None::<Runtime::US2>);
            {
            ...
            {
                let v16: Runtime::US2 = defaultValue(Runtime::US2::US2_1, _v11.get().clone());
                let v35: DateTime = match &v16 {
                    Runtime::US2::US2_0(v16_0_0) => {
