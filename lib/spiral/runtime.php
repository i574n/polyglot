...
class UH0_UH0_1 extends UH0 implements IComparable {
    ...
    function CompareTo($other) {
        ...
        $_cmp__8 = $this->Item1->CompareTo($other->Item1);
        if ($_cmp__8 != 0) {
            return $_cmp__8;
        }        
        $_cmp__9 = $this->Item2->CompareTo($other->Item2);
        if ($_cmp__9 != 0) {
            return $_cmp__9;
        }        
        return 0;
...
abstract class US2 implements FSharpUnion {
    static function allCases() {
        return [ '\\Runtime\\US2_US2_0', '\\Runtime\\US2_US2_1' ];
    }
}
...
abstract class US1 implements FSharpUnion {
    static function allCases() {
        return [ '\\Runtime\\US1_US1_0', '\\Runtime\\US1_US1_1', '\\Runtime\\US1_US1_2' ];
    }
}
...
class US1_US1_1 extends US1 implements IComparable {
    ...
    function CompareTo($other) {
        ...
        $_cmp__14 = $this->f1_0->CompareTo($other->f1_0);
        if ($_cmp__14 != 0) {
            return $_cmp__14;
        }        
        return 0;
...
class Mut0 implements IComparable {
    ...
    function CompareTo($other) {
        $_cmp__19 = $this->l0 > $other->l0 ? 1 : ($this->l0 < $other->l0 ? -1 : 0);
        if ($_cmp__19 != 0) {
            return $_cmp__19;
        }        
        return 0;
...
abstract class US8 implements FSharpUnion {
    static function allCases() {
        return [ '\\Runtime\\US8_US8_0', '\\Runtime\\US8_US8_1' ];
    }
}
...
class US8_US8_0 extends US8 implements IComparable {
    ...
    function CompareTo($other) {
        ...
        $_cmp__35 = $this->f0_0->CompareTo($other->f0_0);
        if ($_cmp__35 != 0) {
            return $_cmp__35;
        }        
        return 0;
...
#44
function method2($v0_1, $v1_1, $v2_1, $v3_1) {
    if ($v2_1->get_Tag() == 1) {
        $v5 = $v2_1->Item2;
        $v4 = $v2_1->Item1;
        if ('"' === $v4) {
            if ($v1_1 === '') {
                return method2($v0_1, $v1_1, $v5, new US1_US1_1(new US2_US2_0()));
            } else {
                switch ($v3_1->get_Tag())
                {
                    case 1:
                        if ($v3_1->f1_0->get_Tag() == 0) {
                            return method2($v0_1, $v1_1, $v5, new US1_US1_1(new US2_US2_1()));
                        } else {
                            if (' ' === $v4) {
                                return method2($v0_1, $v1_1, $v5, new US1_US1_2());
                            } else {
                                return method2($v0_1, NULL, $v5, $v3_1);
                            }
                        }
                    case 0:
                        if (' ' === $v4) {
                    ...
                    default:
                        return method2(NULL, $v1_1, $v5, new US1_US1_2());
                }
            }
        } else {
            if ('\'' === $v4) {
                ...
                switch ($v3_1->get_Tag())
                {
                    case 1:
                        if ($v3_1->f1_0->get_Tag() == 0) {
                            if (' ' === $v4) {
                                return method2($v0_1, NULL, $v5, new US1_US1_1(new US2_US2_0()));
                            } else {
                                return method2($v0_1, NULL, $v5, $v3_1);
                            }
                        } else {
...
#47
function closure6($v0_1, $v1_1, $v2_1, $v3_1, $v4, $unitVar) {
    return \String\toText(\String\interpolate('execute_with_options_async / options: %A%P()', [ [ $v0_1, $v1_1, $v2_1, $v3_1, $v4 ] ]));
}

#48
function closure7($unitVar, $unitVar_1) {
    return '';
}

#49
function method4($unitVar) {
    return function ($arg10_0040) use ($closure7) {     return closure7(NULL, NULL);
 };
}

#50
function method6($v0_1) {
    return $v0_1;
}
...
function closure9($v0_1, $v1_1, $v2_1, $unitVar) {
    if (\Util\equals($GLOBALS['State_trace_state'], NULL)) {
        $GLOBALS['State_trace_state'] = closure8(NULL, NULL);
    } else {
    }
...
function method5($v0_1, $v1_1, $v2_1) {
    $v3_1 = function ($arg10_0040) use ($closure8) {     return closure8(NULL, NULL);
 };
    if (\Util\equals($GLOBALS['State_trace_state'], NULL)) {
...
#61
function closure11($v0_1, $v1_1, $v2_1, $v3_1, $v4, $v5, $v6, $v7) {
    $_v8 = NULL;
    $x = \Util\defaultOf();
    $_v8 = $x;
    $v32 = \Option\value($_v8);
    $_v33 = NULL;
    \Util\defaultOf();
    $_v33 = NULL;
    \Option\value($_v33);
...
#62
function closure14($v0_1, $v1_1, $v2_1, $v3_1, $v4, $v5, $v6, $v7) {
    $_v8 = NULL;
    $x = \Util\defaultOf();
    $_v8 = $x;
    $v33 = \Option\value($_v8);
    $_v34 = NULL;
    \Util\defaultOf();
    $_v34 = NULL;
    \Option\value($_v34);
...
#77
$GLOBALS['v2'] = function ($v) use ($closure2) { return closure2(NULL, $v);
 };
...
#79
$GLOBALS['v3'] = function ($arg10_0040) use ($closure20) { return closure20(NULL, $arg10_0040);
 };
