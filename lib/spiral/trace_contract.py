...
def _arrow124(v: US0) -> Callable[[Callable[[], str], Callable[[], str]], None]:
    return closure0(None, v)


v0: Callable[[US0, Callable[[], str], Callable[[], str]], None] = _arrow124
...
v1: Callable[[], tuple[Mut0, Mut1, Mut1, Mut2, int64 | None]] = _arrow125
