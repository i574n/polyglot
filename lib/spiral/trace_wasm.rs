pub mod Trace {
    ...
    pub fn method0(
        ...
        let _run_target_args__v1: (Trace::US1, Trace::US2) = (Trace::US1::US1_1, Trace::US2::US2_1);
    ...
    pub fn method7(
        ...
        let v152: Trace::US2 = defaultValue(Trace::US2::US2_1, map(Trace::method8(), v5));
        let v249: DateTime = match &v152 {
            Trace::US2::US2_0(v152_0_0) => {
