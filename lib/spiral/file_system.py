...
def closure4(unit_var: None, v0_1: US0) -> Callable[[str], Async[int64]]:
    def _arrow88(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def closure9(unit_var: None, v0_1: str) -> Callable[[str], Async[bool]]:
    def _arrow89(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def closure11(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow90(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def closure13(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow91(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def closure18(v0_1: US3, v1: Callable[[], str], v2: Callable[[], str], unit_var: None) -> str:
    ...
    _v9 = None
    v59: str = value(_v9)
    v60: int64 = pattern_input[0].l0
    v70: str = "Debug" if (v0_1.tag == 1) else ("Info" if (v0_1.tag == 2) else ("Verbose" if (v0_1.tag == 0) else ("Warning" if (v0_1.tag == 3) else "Critical")))
    return trim_end(trim_start(((((((((("" + v59) + " #") + str(v60)) + " [") + v70.lower()) + "] ") + v1(None)) + " / ") + v2(None)) + ""), " ", "/")
...
def method19(v0_1_mut: str, v1_mut: bool, v2_mut: str, v3_mut: str) -> str:
    while True:
        ...
        _v4: str | None = None
        _v4 = None
        def _arrow96(v: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3) -> bool:
            return closure41(None, v)

        def _arrow97(v_1: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3) -> bool:
            return closure42(None, v_1)

        if (_arrow96 if v1 else _arrow97)(value(_v4)):
            return v3

        else: 
            v36: str | None = method17()(v3)
...
def method16(v0_1: str, v1: bool, v2: str) -> str:
    _v3: str | None = None
    _v3 = None
    def _arrow98(v: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> bool:
        return closure41(None, v)

    def _arrow99(v_1: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> bool:
        return closure42(None, v_1)

    if (_arrow98 if v1 else _arrow99)(value(_v3)):
        return v2

    else: 
        v35: str | None = method17()(v2)
        v38: US8 = default_arg(map(method18(), v35), US8(1))
        if v38.tag == 0:
...
def closure39(v0_1: str, v1: bool) -> Callable[[str], str]:
    def _arrow100(v: str, v0_1: Any=v0_1, v1: Any=v1) -> str:
...
def closure38(unit_var: None, v0_1: str) -> Callable[[bool, str], str]:
    def _arrow101(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure45(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow102(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow103(__unit: None=None) -> str:
    return closure32(None, None)


v11: Callable[[], str] = _arrow103

def create_temp_directory_name(__unit: None=None) -> str:
    return v11(None)


def _arrow104(__unit: None=None) -> tuple[str, IDisposable]:
    return closure34(None, None)


v12: Callable[[], tuple[str, IDisposable]] = _arrow104
...
v13: Callable[[], str] = _arrow105

def get_source_directory(__unit: None=None) -> str:
    return v13(None)


def _arrow106(v: str) -> Callable[[bool, str], str]:
    return closure38(None, v)


v14: Callable[[str, bool, str], str] = _arrow106

def find_parent(x: str) -> Callable[[bool, str], str]:
    return v14(x)


def _arrow107(v: str) -> Callable[[str], str]:
    return closure45(None, v)


v15: Callable[[str, str], str] = _arrow107
