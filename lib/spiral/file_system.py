...
Disposable_reflection = _expr128
...
def method6(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr143())) >= find(v15_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr144()))):
...
def closure8(unit_var: None, v0_1: US2) -> Callable[[str], Async[int64]]:
    def _arrow145(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def closure14(unit_var: None, v0_1: str) -> Callable[[str], Async[bool]]:
    def _arrow146(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def closure18(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow148(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def closure23(unit_var: None, v0_1: str) -> Callable[[str], Async[int64]]:
    def _arrow149(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def method23(__unit: None=None) -> Callable[[std_io_Error], std_string_String]:
    def _arrow150(v: std_io_Error) -> std_string_String:
...
def method25(v0_1: str) -> Callable[[], None]:
    def _arrow152(__unit: None=None, v0_1: Any=v0_1) -> None:
        closure47(v0_1, None)
...
def method28(v0_1_mut: str, v1_1_mut: bool, v2_1_mut: str, v3_1_mut: str) -> str:
    while True:
        ...
        def _arrow154(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3_1: Any=v3_1) -> bool:
            return closure52(None, v)

        def _arrow155(v_1: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3_1: Any=v3_1) -> bool:
            return closure53(None, v_1)

        if (_arrow154 if v1_1 else _arrow155)(method14(v3_1, v0_1)):
            return v3_1
...
def method26(v0_1: str, v1_1: bool, v2_1: str) -> str:
    def _arrow156(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure52(None, v)

    def _arrow157(v_1: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure53(None, v_1)

    if (_arrow156 if v1_1 else _arrow157)(method14(v2_1, v0_1)):
        return v2_1
...
def closure50(v0_1: str, v1_1: bool) -> Callable[[str], str]:
    def _arrow158(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> str:
...
def closure49(unit_var: None, v0_1: str) -> Callable[[bool, str], str]:
    def _arrow159(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure55(unit_var: None, v0_1: str) -> str:
    ...
    _v1 = None
    v29: str = value_3(_v1)
    def _arrow160(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
        _arg: str = v29[0]
        return _arg.lower()

    return replace(((("" + _arrow160()) + "") + v29[1:len(v29)]) + "", "\\", "/")
...
def closure58(unit_var: None, v0_1: bool) -> None:
    ...
    pattern_input: tuple[Mut0, Mut1, Mut2, int64 | None, Mut3] = value_3(State_trace_state())
    def _arrow166(v_1: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure59(None, v_1)

    def _arrow168(v_2: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure1(None, v_2)

    v10_1: Callable[[str], None] = _arrow166 if v0_1 else _arrow168
...
def closure60(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow170(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
        return closure61(v0_1, v)

    return _arrow170


def _arrow172(v: US0) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, v)


v0: Callable[[US0], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow172
...
def _arrow174(v: str) -> Async[int64]:
    return closure2(None, v)


v2: Callable[[str], Async[int64]] = _arrow174

def delete_directory_async(x: str) -> Async[int64]:
    return v2(x)


def _arrow176(v: US2) -> Callable[[str], Async[int64]]:
    return closure8(None, v)


v3: Callable[[US2, str], Async[int64]] = _arrow176
...
def _arrow180(v: str) -> Async[str]:
    return closure13(None, v)


v5: Callable[[str], Async[str]] = _arrow180
...
v6: Callable[[str, str], Async[bool]] = _arrow182
...
v7: Callable[[str, str], Async[None]] = _arrow183
...
v8: Callable[[str, str], Async[None]] = _arrow184
...
v9: Callable[[str], Async[int64]] = _arrow185
...
v10: Callable[[str, str], Async[int64]] = _arrow186

def move_file_async(x: str) -> Callable[[str], Async[int64]]:
    return v10(x)


def _arrow188(v: str) -> Async[str | None]:
    return closure27(None, v)


v11: Callable[[str], Async[str | None]] = _arrow188

def read_all_text_retry_async(x: str) -> Async[str | None]:
    return v11(x)


def _arrow189(__unit: None=None) -> str:
    return closure35(None, None)


v12: Callable[[], str] = _arrow189
...
v13: Callable[[], tuple[str, IDisposable]] = _arrow191

def create_temp_directory(__unit: None=None) -> tuple[str, IDisposable]:
    return v13(None)


def _arrow193(__unit: None=None) -> str:
    return closure48(None, None)


v14: Callable[[], str] = _arrow193

def get_source_directory(__unit: None=None) -> str:
    return v14(None)


def _arrow194(v: str) -> Callable[[bool, str], str]:
    return closure49(None, v)


v15: Callable[[str, bool, str], str] = _arrow194
...
def _arrow196(v: str) -> str:
    return closure56(None, v)


v17: Callable[[str], str] = _arrow196

def new_file_uri(x: str) -> str:
    return v17(x)


def _arrow197(__unit: None=None) -> str:
    return closure57(None, None)


v18: Callable[[], str] = _arrow197

def get_workspace_root(__unit: None=None) -> str:
    return v18(None)


def _arrow198(v: bool) -> None:
    closure58(None, v)


v19: Callable[[bool], None] = _arrow198

def init_trace_file(x: bool) -> None:
    v19(x)


def _arrow199(v: str) -> Callable[[str], str]:
    return closure60(None, v)


v20: Callable[[str, str], str] = _arrow199
