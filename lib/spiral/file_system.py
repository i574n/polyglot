...
def method1(__unit: None=None) -> tuple[US1, US2]:
    ...
    def _arrow316(__unit: None=None) -> US1:
    ...
    return (US1(0, v6.fields[0]) if (v6.tag == 0) else _arrow316(), US2(1) if (method2("AUTOMATION") != "True") else US2(0, from_value(ticks_1(now()), False)))
...
def method11(v0_1: US0) -> bool:
    ...
    if pattern_input[2].l0 == False:
        ...
        return find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr317())) >= find(v35_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr318()))
...
def method8(v0_1: str, v1_1: int64) -> Async[int64]:
    def _arrow325(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
        def _arrow320(__unit: None=None) -> Async[int64]:
            method9(True, v0_1)
            return singleton.Return(v1_1)

        def _arrow324(_arg: Exception) -> Async[int64]:
            ...
            def _arrow323(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v1598, _arrow322)

            return singleton.Combine(_arrow321() if v1519 else singleton.Zero(), singleton.Delay(_arrow323))
...
def method27(v0_1: US6, v1_1: str, v2_1: int64, v3: US8, v4: US7) -> Async[int64]:
    def _arrow332(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4) -> Async[int64]:
        def _arrow327(__unit: None=None) -> Async[int64]:
            def _arrow326(_arg: Any) -> Async[int64]:
                return singleton.Return(v2_1)

            return singleton.Using(None, _arrow326)

        def _arrow331(_arg_1: Exception) -> Async[int64]:
            ...
            def _arrow330(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v2391, _arrow329)

            return singleton.Combine(_arrow328() if v2312 else singleton.Zero(), singleton.Delay(_arrow330))

        return singleton.TryWith(singleton.Delay(_arrow327), _arrow331)
...
def closure10(unit_var: None, v0_1: US6) -> Callable[[str], Async[int64]]:
    def _arrow333(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def method39(v0_1: str, v1_1: str) -> Async[bool]:
    def _arrow337(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
        if method33(v0_1) == False:
            return singleton.Return(False)

        else: 
            v61: Async[str] = method31(v0_1)
            def _arrow336(_arg: str) -> Async[bool]:
                v63: bool = v1_1 == _arg
                return singleton.Return(v63)

            return singleton.Bind(v61, _arrow336)
...
def method37(v0_1: str, v1_1: str) -> Async[None]:
    def _arrow342(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[None]:
        v51: Async[bool] = method38(v0_1, v1_1)
        def _arrow341(_arg: bool) -> Async[None]:
            v53: bool = _arg == False
            def _arrow339(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v54, _arrow338)

            def _arrow340(__unit: None=None) -> Async[None]:
                return singleton.Zero()

            return singleton.Combine(_arrow339() if v53 else singleton.Zero(), singleton.Delay(_arrow340))

        return singleton.Bind(v51, _arrow341)
...
def method43(__unit: None=None) -> Callable[[std_io_error], str]:
    def _arrow344(v: std_io_error) -> str:
...
def method45(__unit: None=None) -> Callable[[], US9]:
    def _arrow345(__unit: None=None) -> US9:
...
def method42(v0_1: str, v1_1: int64) -> Async[int64]:
    def _arrow352(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
        ...
        def _arrow351(_arg: Exception) -> Async[int64]:
            ...
            def _arrow350(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v2750, _arrow349)

            return singleton.Combine(_arrow348() if v2671 else singleton.Zero(), singleton.Delay(_arrow350))
...
def method55(v0_1: str, v1_1: str, v2_1: int64) -> Async[int64]:
    def _arrow358(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int64]:
        ...
        def _arrow357(_arg: Exception) -> Async[int64]:
            ...
            def _arrow356(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v1574, _arrow355)

            return singleton.Combine(_arrow354() if v1494 else singleton.Zero(), singleton.Delay(_arrow356))
...
def method66(__unit: None=None) -> Callable[[Exception], US10]:
    def _arrow361(v: Exception) -> US10:
...
def method64(v0_1: Async[Any]) -> Async[US10]:
    def _arrow363(__unit: None=None, v0_1: Any=v0_1) -> Async[US10]:
        def _arrow362(_arg: Any) -> Async[US10]:
...
def method67(v0_1: Async[US10]) -> Async[US11]:
    def _arrow365(__unit: None=None, v0_1: Any=v0_1) -> Async[US11]:
        def _arrow364(_arg: US10) -> Async[US11]:
            v74: US10 = _arg
            v80: US11 = US11(1, v74.fields[0]) if (v74.tag == 1) else US11(0, v74.fields[0])
            return singleton.Return(v80)

        return singleton.Bind(v0_1, _arrow364)
...
def method68(v0_1: int, v1_1: Async[US11]) -> Async[US2]:
    def _arrow367(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[US2]:
        def _arrow366(_arg: US11) -> Async[US2]:
            v1019: US11 = _arg
            v1143: US2
            if v1019.tag == 0:
...
def method74(v0_1: Async[str]) -> Async[str | None]:
    def _arrow371(__unit: None=None, v0_1: Any=v0_1) -> Async[str | None]:
        def _arrow370(_arg: str) -> Async[str | None]:
...
def method61(v0_1: str, v1_1: int64) -> Async[str | None]:
    def _arrow377(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[str | None]:
        def _arrow375(__unit: None=None) -> Async[str | None]:
            ...
            def _arrow373(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v1692, _arrow372)
            ...
            return singleton.Combine(_arrow373() if v1675 else singleton.Zero(), singleton.Delay(_arrow374))

        def _arrow376(_arg_1: Exception) -> Async[str | None]:
        ...
        return singleton.TryWith(singleton.Delay(_arrow375), _arrow376)
...
def method79(__unit: None=None) -> Callable[[chrono_date_time_1[chrono_utc]], US12]:
    def _arrow378(v: chrono_date_time_1[chrono_utc]) -> US12:
...
def method90(__unit: None=None) -> Callable[[std_io_error], std_string_string]:
    def _arrow379(v: std_io_error) -> std_string_string:
...
def method91(__unit: None=None) -> Callable[[], US13]:
    def _arrow380(__unit: None=None) -> US13:
...
def method92(__unit: None=None) -> Callable[[std_string_string], US13]:
    def _arrow381(v: std_string_string) -> US13:
...
def method89(v0_1: str) -> IDisposable:
    ...
    class ObjectExpr386(IDisposable):
...
def method105(v0_1: int, v1_1: str, v2_1: int) -> Callable[[str], str]:
    def _arrow387(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> str:
...
def method109(__unit: None=None) -> Callable[[std_path_path_buf], US14]:
    def _arrow388(v: std_path_path_buf) -> US14:
...
def method123(__unit: None=None) -> Callable[[std_path_path_buf], US15]:
    def _arrow392(v: std_path_path_buf) -> US15:
...
def method106(v0_1: str) -> str:
    if v0_1 == "":
        ...
        if v66 == "":
            ...
            def _arrow393(__unit: None=None, v0_1: Any=v0_1) -> str:
                _arg: str = v71[0]
                return _arg.lower()

            return replace(concat(_arrow393(), *v71[1:len(v71)]), "\\", "/")
...
def closure59(unit_var: None, unit_var_1: None) -> str:
    ...
    def _arrow394(__unit: None=None, unit_var: Any=unit_var, unit_var_1: Any=unit_var_1) -> str:
        raise Exception("Option does not have a value.")

    return method86(v107.fields[0] if (v107.tag == 0) else _arrow394(), "polyglot")
...
def closure63(unit_var: None, v0_1: bool) -> None:
    ...
    v3 = None
    pattern_input: tuple[Mut0, Mut1, Mut2, Mut3, Mut4, int64 | None] = value_10(TraceState_trace_state())
    def _arrow395(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure61(None, v)

    def _arrow396(v_1: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure2(None, v_1)

    v37: Callable[[str], None] = _arrow395 if v0_1 else _arrow396
...
def method132(v0_1: str, v1_1: str) -> None:
    ...
    def _arrow397(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> bool:
        v14: FSharpResult_2[std_path_path_buf, std_io_error] = method107(v1_1)
        return True

    if _arrow397() if method10(v1_1) else False:
        method9(True, v1_1)
...
def closure64(unit_var: None, v0_1: str) -> Callable[[str], None]:
    def _arrow398(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure65(v0_1, v)
...
def closure66(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow399(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow400(__unit: None=None) -> None:
    closure0(None, None)


v1: Callable[[], None] = _arrow400
...
def _arrow402(v: str) -> Async[int64]:
    return closure3(None, v)


v16: Callable[[str], Async[int64]] = _arrow402

def delete_directory_async(x: str) -> Async[int64]:
    return v16(x)


def _arrow403(v: US6) -> Callable[[str], Async[int64]]:
    return closure10(None, v)


v17: Callable[[US6, str], Async[int64]] = _arrow403
...
v18: Callable[[str], Async[int64]] = _arrow404

def wait_for_file_access_read(x: str) -> Async[int64]:
    return v18(x)


def _arrow405(v: str) -> Async[str]:
    return closure14(None, v)


v19: Callable[[str], Async[str]] = _arrow405

def read_all_text_async(x: str) -> Async[str]:
    return v19(x)


def _arrow406(v: str) -> Callable[[str], bool]:
    return closure15(None, v)


v20: Callable[[str, str], bool] = _arrow406
...
v21: Callable[[str, str], Async[None]] = _arrow407
...
v22: Callable[[str, str], Async[None]] = _arrow408

def write_all_text_exists(x: str) -> Callable[[str], Async[None]]:
    return v22(x)


def _arrow409(v: str) -> Async[int64]:
    return closure21(None, v)


v23: Callable[[str], Async[int64]] = _arrow409

def delete_file_async(x: str) -> Async[int64]:
    return v23(x)


def _arrow410(v: str) -> Callable[[str], Async[int64]]:
    return closure27(None, v)


v24: Callable[[str, str], Async[int64]] = _arrow410

def move_file_async(x: str) -> Callable[[str], Async[int64]]:
    return v24(x)


def _arrow411(v: str) -> Async[str | None]:
    return closure30(None, v)


v25: Callable[[str], Async[str | None]] = _arrow411

def read_all_text_retry_async(x: str) -> Async[str | None]:
    return v25(x)


def _arrow412(__unit: None=None) -> str:
    return closure36(None, None)


v26: Callable[[], str] = _arrow412

def create_temp_path(__unit: None=None) -> str:
    return v26(None)


def _arrow413(__unit: None=None) -> tuple[str, IDisposable]:
    return closure38(None, None)


v27: Callable[[], tuple[str, IDisposable]] = _arrow413

def create_temp_dir(__unit: None=None) -> tuple[str, IDisposable]:
    return v27(None)


def _arrow414(v: str) -> tuple[str, IDisposable]:
    return closure47(None, v)


v28: Callable[[str], tuple[str, IDisposable]] = _arrow414

def create_temp_dir_0027(x: str) -> tuple[str, IDisposable]:
    return v28(x)


def _arrow415(__unit: None=None) -> str:
    return closure49(None, None)


v29: Callable[[], str] = _arrow415
...
v30: Callable[[str], str] = _arrow416
...
v31: Callable[[str], str] = _arrow417

def new_file_uri(x: str) -> str:
    return v31(x)


def _arrow418(__unit: None=None) -> str:
    return closure59(None, None)


v32: Callable[[], str] = _arrow418

def get_workspace_root(__unit: None=None) -> str:
    return v32(None)


def _arrow419(v: str) -> None:
    closure61(None, v)


v33: Callable[[str], None] = _arrow419

def trace_file(x: str) -> None:
    v33(x)


def _arrow420(v: bool) -> None:
    closure63(None, v)


v34: Callable[[bool], None] = _arrow420

def init_trace_file(x: bool) -> None:
    v34(x)


def _arrow421(v: str) -> Callable[[str], None]:
    return closure64(None, v)


v35: Callable[[str, str], None] = _arrow421

def link_directory(x: str) -> Callable[[str], None]:
    return v35(x)


def _arrow422(v: str) -> Callable[[str], str]:
    return closure66(None, v)


v36: Callable[[str, str], str] = _arrow422
