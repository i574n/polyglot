...
def closure4(unit_var: None, v0_1: US0) -> Callable[[str], Async[int64]]:
    def _arrow73(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def closure9(unit_var: None, v0_1: str) -> Callable[[str], Async[bool]]:
    def _arrow74(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def closure13(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow76(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def closure16(unit_var: None, v0_1: str) -> Callable[[str], Async[int64]]:
    def _arrow77(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def method14(v0_1_mut: str, v1_mut: bool, v2_mut: str, v3_mut: str) -> str:
    while True:
        ...
        _v4: str | None = None
        _v4 = None
        def _arrow80(v: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3) -> bool:
            return closure33(None, v)

        def _arrow81(v_1: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3) -> bool:
            return closure34(None, v_1)

        if (_arrow80 if v1 else _arrow81)(value(_v4)):
            return v3
...
def method11(v0_1: str, v1: bool, v2: str) -> str:
    _v3: str | None = None
    _v3 = None
    def _arrow82(v: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> bool:
        return closure33(None, v)

    def _arrow83(v_1: str, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> bool:
        return closure34(None, v_1)

    if (_arrow82 if v1 else _arrow83)(value(_v3)):
        return v2
...
def closure31(v0_1: str, v1: bool) -> Callable[[str], str]:
    def _arrow84(v: str, v0_1: Any=v0_1, v1: Any=v1) -> str:
...
def closure30(unit_var: None, v0_1: str) -> Callable[[bool, str], str]:
    def _arrow85(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure37(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow86(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow87(__unit: None=None) -> str:
    return closure24(None, None)


v11: Callable[[], str] = _arrow87

def create_temp_directory_name(__unit: None=None) -> str:
    return v11(None)


def _arrow88(__unit: None=None) -> tuple[str, IDisposable]:
    return closure26(None, None)


v12: Callable[[], tuple[str, IDisposable]] = _arrow88
...
v13: Callable[[], str] = _arrow89

def get_source_directory(__unit: None=None) -> str:
    return v13(None)


def _arrow90(v: str) -> Callable[[bool, str], str]:
    return closure30(None, v)


v14: Callable[[str, bool, str], str] = _arrow90

def find_parent(x: str) -> Callable[[bool, str], str]:
    return v14(x)


def _arrow91(v: str) -> Callable[[str], str]:
    return closure37(None, v)


v15: Callable[[str, str], str] = _arrow91
