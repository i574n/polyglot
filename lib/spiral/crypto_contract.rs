pub mod Crypto {
    ...
    pub fn method5(v0_1: string) -> string {
        let _v3: MutCell<Option<string>> = MutCell::new(None::<string>);
        let v35: Result<std::string::String, std::env::VarError> = std::env::var(&*v0_1);
        let v37: bool = true;
    ...
    pub fn closure4(
        ...
        }
        {
            ...
            let _v334: LrcPtr<MutCell<Option<Crypto::US2>>> = refCell(None::<Crypto::US2>);
            {
            ...
            {
                let v361: Crypto::US2 = defaultValue(Crypto::US2::US2_1, _v334.get().clone());
