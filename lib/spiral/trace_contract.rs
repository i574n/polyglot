pub mod Trace {
        ...
        }
        {
            ...
            if Trace::State::trace_state().get().clone().is_none() {
                let patternInput_2:
                        (LrcPtr<Trace::Mut0>, LrcPtr<Trace::Mut1>,
                         LrcPtr<Trace::Mut2>, LrcPtr<Trace::Mut3>,
                         Option<i64>) = Trace::method0(Trace::US0::US0_0);
                Trace::State::trace_state().set(Some((patternInput_2.0.clone(),
                ...
                if if (patternInput_3.2.clone()).l0.get().clone() == false {
                    ...
                    if Trace::State::trace_state().get().clone().is_none() {
                        let patternInput_4:
                                (LrcPtr<Trace::Mut0>, LrcPtr<Trace::Mut1>,
                                 ...
                                 Option<i64>) =
                            Trace::method0(Trace::US0::US0_0);
                        Trace::State::trace_state().set(Some((patternInput_4.0.clone(),
                    ...
                    }
                    {
                        ...
                        }
                        {
                            ...
                            let v515: Trace::US1 =
                                if if let Trace::US0::US0_0 = &v0_1 {
                                       true
                                   } else { false } {
                            ...
                            let v556: Trace::US1 =
                                match &v515 {
                                    Trace::US1::US1_0(v515_0_0) =>
                                    Trace::US1::US1_0(match &v515 {
                                                          Trace::US1::US1_0(x)
                                                          => x.clone(),
                                                          _ => unreachable!(),
                                                      }),
                            ...
                            let v565: string =
                                padLeft(toLower(match &v556 {
                                                    Trace::US1::US1_0(v556_0_0)
                                                    =>
                                                    match &v556 {
                                                        Trace::US1::US1_0(x)
                                                        => x.clone(),
    ...
    pub fn closure2(v0_1: Trace::US0, v1: Func0<string>)
     -> Func1<Func0<string>, ()> {
        Func1::new({
                       let v0_1 = v0_1.clone();
                       let v1 = v1.clone();
                       move |v: Func0<string>|
                           Trace::closure3(v0_1.clone(), v1.clone(), v)
                   })
    }
    pub fn closure1(unitVar: (), v0_1: Trace::US0)
     -> Func1<Func0<string>, Func1<Func0<string>, ()>> {
        Func1::new({
                       let v0_1 = v0_1.clone();
                       move |v: Func0<string>|
                           Trace::closure2(v0_1.clone(), v)
                   })
    }
    pub fn v0() -> bool {
        static v0: OnceInit<bool> = OnceInit::new();
        v0.get_or_init(||
                           Trace::State::trace_state().get().clone().is_none()).clone()
    }
