pub mod Trace {
    ...
    pub fn closure7(v0_1: Trace::US0, v1_1: Func0<string>,
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let v601: Trace::US1 =
                match &v560 {
                    Trace::US1::US1_0(v560_0_0) =>
                    Trace::US1::US1_0(match &v560 {
                    ...
                    _ => {
                        ...
                        match &v567 {
                            Trace::US1::US1_0(v567_0_0) =>
                            Trace::US1::US1_0(match &v567 {
                                                  Trace::US1::US1_0(x) =>
                                                  x.clone(),
                                                  _ => unreachable!(),
                                              }),
                            _ => {
                                ...
                                match &v574 {
                                    Trace::US1::US1_0(v574_0_0) =>
                                    Trace::US1::US1_0(match &v574 {
                                                          Trace::US1::US1_0(x)
                                                          => x.clone(),
                                                          _ => unreachable!(),
                                                      }),
            ...
            let v610: string =
                padLeft(toLower(match &v601 {
                                    Trace::US1::US1_0(v601_0_0) =>
                                    match &v601 {
                                        Trace::US1::US1_0(x) => x.clone(),
                                        _ => unreachable!(),
                                    },
            ...
            let v754: LrcPtr<Trace::Mut4> =
                LrcPtr::new(Trace::Mut4{l0: MutCell::new(Trace::method8()),});
            let v760: () =
                {
