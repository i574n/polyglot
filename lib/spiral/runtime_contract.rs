pub mod Runtime {
    ...
    pub fn method0(
        ...
        let _v1: (Runtime::US4, Runtime::US5) = (
            ...
            if fable_library_rust::String_::fromString(v131) != string("True") {
                ...
                Runtime::US5::US5_0(near_sdk::env::block_timestamp() as i64)
            },
        );
    ...
    pub fn method7(
        ...
        let v144: Runtime::US5 = defaultValue(Runtime::US5::US5_1, map(Runtime::method8(), v5));
        let v154: u64 = match &v144 {
            Runtime::US5::US5_0(v144_0_0) => {
                v130 - match &v144 {
                    Runtime::US5::US5_0(x) => x.clone(),
                    _ => unreachable!(),
                } as u64
