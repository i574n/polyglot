pub mod Runtime {
    ...
    pub fn method1() -> (Runtime::US1, Runtime::US2) {
        ...
        (
            ...
            if (Runtime::method2(string("AUTOMATION"))) != string("True") {
                ...
                Runtime::US2::US2_0(unbox::<i64>(&getZero()))
            },
        )
    }
    ...
    pub fn method8(
        ...
        let v286: Runtime::US2 = defaultValue(Runtime::US2::US2_1, map(Runtime::method9(), v5));
    ...
    pub fn method40(
        ...
        let v363: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v338),
                (),
            );
            ()
        };
        ...
        let v462: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v437),
                (),
            );
            ()
        };
