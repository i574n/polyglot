pub mod Runtime {
    ...
    pub fn method7(
        ...
        let v144: Runtime::US3 = defaultValue(Runtime::US3::US3_1, map(Runtime::method8(), v5));
    ...
    pub fn method36(
        ...
        let v272: std::string::String = format!("{:#?}", v5);
        let v294: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v272)),
                (),
            );
            ()
        };
        ...
        let v354: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v332)),
                (),
            );
            ()
        };
        ...
        let v428: std::string::String = format!("{:#?}", v8);
        let v450: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v428)),
                (),
            );
            ()
        };
