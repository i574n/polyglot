...
Disposable_reflection = _expr119
...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow121(v: CancellationToken) -> US0:
...
def method2(v0_1: Any) -> Callable[[], None]:
    def _arrow123(__unit: None=None, v0_1: Any=v0_1) -> None:
        closure2(v0_1, None)
...
def _arrow124(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow124
