...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow14(v: CancellationToken) -> US0:
...
def _arrow32(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow32
