...
Disposable_reflection = _expr107
...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow109(v: CancellationToken) -> US0:
...
def method1(v0_1: Any) -> Callable[[], None]:
    def _arrow111(__unit: None=None, v0_1: Any=v0_1) -> None:
        closure2(v0_1, None)
...
def method2(v0_1: Any) -> Callable[[], None]:
    def _arrow112(__unit: None=None, v0_1: Any=v0_1) -> None:
        closure2(v0_1, None)
...
def _arrow114(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow114
