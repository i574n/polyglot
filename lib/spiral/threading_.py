...
Disposable_reflection = _expr101
...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow103(v: CancellationToken) -> US0:
...
def _arrow106(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow106
