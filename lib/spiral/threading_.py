...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow83(v: CancellationToken) -> US0:
...
def _arrow86(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow86
