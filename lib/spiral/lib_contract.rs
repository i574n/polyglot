pub mod Lib {
    ...
    pub mod SpiralCrypto {
        ...
        pub fn hash_text(x: string) -> string { hash_text_1(x) }
        pub fn hash_to_port(x: string) -> u16 { hash_to_port_1(x) }
    }
    pub mod SpiralSm {
        use super::*;
        ...
        pub fn contains(x: string) -> Func1<string, bool> { contains_1(x) }
        pub fn ellipsis(x: i32) -> Func1<string, string> { ellipsis_1(x) }
        pub fn ellipsis_end(x: i64) -> Func1<string, string> {
            ellipsis_end_1(x)
        }
        pub fn ends_with(x: string) -> Func1<string, bool> { ends_with_1(x) }
        ...
        pub fn split(x: string) -> Func1<string, Array<string>> { split_1(x) }
        pub fn split_string(x: Array<string>)
        ...
        pub fn to_lower(x: string) -> string { to_lower_1(x) }
        pub fn trim(x: string) -> string { trim_1(x) }
    ...
    pub mod SpiralFileSystem {
        ...
        use crate::File_system::get_source_directory as
        ...
        pub fn get_workspace_root() -> string { get_workspace_root_1() }
        pub fn get_source_directory() -> string { get_source_directory_1() }
        pub fn normalize_path(x: string) -> string { normalize_path_1(x) }
        pub fn new_file_uri(x: string) -> string { new_file_uri_1(x) }
        pub fn create_temp_dir() -> (string, LrcPtr<dyn IDisposable>) {
            create_temp_dir_1()
        }
        pub fn create_temp_dir_(x: string)
         -> (string, LrcPtr<dyn IDisposable>) {
            create_temp_dir__1(x)
        }
        pub fn create_temp_path() -> string { create_temp_path_1() }
    }
    pub fn set_trace_level(new_level: US0) {
        iterate(Func1::new({
                               ...
                               move
                                   |_arg:
                                        (LrcPtr<Mut0>, LrcPtr<Mut1>,
                                         LrcPtr<Mut2>, LrcPtr<Mut3>,
                                         Option<i64>)|
        ...
        iterate(Func1::new({
                               ...
                               move
                                   |_arg_1:
                                        (LrcPtr<Mut0_1>, LrcPtr<Mut1_1>,
                                         LrcPtr<Mut2_1>, LrcPtr<Mut3_1>,
                                         Option<i64>)|
        ...
        iterate(Func1::new({
                               ...
                               move
                                   |_arg_2:
                                        (LrcPtr<Mut0_2>, LrcPtr<Mut1_2>,
                                         LrcPtr<Mut2_2>, LrcPtr<Mut3_2>,
                                         Option<i64>)|
        ...
        iterate(Func1::new({
                               ...
                               move
                                   |_arg_3:
                                        (LrcPtr<Mut0_3>, LrcPtr<Mut1_3>,
                                         LrcPtr<Mut2_3>, LrcPtr<Mut3_3>,
                                         Option<i64>)|
        ...
        iterate(Func1::new({
                               ...
                               move
                                   |_arg_4:
                                        (LrcPtr<Mut0_4>, LrcPtr<Mut1_4>,
                                         LrcPtr<Mut2_4>, LrcPtr<Mut3_4>,
                                         Option<i64>)|
                                   (_arg_4.3.clone()).l0.set(new_level.clone())
                           }), trace_state_4().get().clone())
    }
    pub fn get_trace_level() -> US0 {
        defaultWith(Func0::new(move ||
                                   panic!("{}",
                                          string("lib.get_trace_level / trace_state=None"),)),
                    map(Func1::new(move
                                       |_arg:
                                            (LrcPtr<Mut0_4>, LrcPtr<Mut1_4>,
                                             LrcPtr<Mut2_4>, LrcPtr<Mut3_4>,
