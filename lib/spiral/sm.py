...
def closure19(unit_var: None, v0_1: str) -> Callable[[str], Array[str]]:
    def _arrow20(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure21(unit_var: None, v0_1: Array[str]) -> Callable[[str], Array[str]]:
    def _arrow24(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure23(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow26(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure32(unit_var: None, v0_1: str) -> Callable[[UH0], UH0]:
    def _arrow33(v: UH0, unit_var: Any=unit_var, v0_1: Any=v0_1) -> UH0:
...
def method2(__unit: None=None) -> Callable[[str, UH0], UH0]:
    def _arrow34(v: str) -> Callable[[UH0], UH0]:
...
def closure42(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow59(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure44(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow60(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure46(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow61(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow62

def contains(x: str) -> Callable[[str], bool]:
    return v0(x)


def _arrow63(v: str) -> Callable[[str], bool]:
    return closure2(None, v)


v1: Callable[[str, str], bool] = _arrow63
...
v2: Callable[[int, str, str], str] = _arrow64

def pad_left(x: int) -> Callable[[str, str], str]:
    return v2(x)


def _arrow66(v: int) -> Callable[[str, str], str]:
    return closure7(None, v)


v3: Callable[[int, str, str], str] = _arrow66
...
v4: Callable[[str, str, str], str] = _arrow67
...
v5: Callable[[str, str, str], str] = _arrow68

def replace_regex(x: str) -> Callable[[str, str], str]:
    return v5(x)


def _arrow69(v: int) -> Callable[[int, str], str]:
    return closure16(None, v)


v6: Callable[[int, int, str], str] = _arrow69

def slice(x: int) -> Callable[[int, str], str]:
    return v6(x)


def _arrow70(v: str) -> Callable[[str], Array[str]]:
    return closure19(None, v)


v7: Callable[[str, str], Array[str]] = _arrow70

def split(x: str) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow72(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure21(None, v)


v8: Callable[[Array[str], str], Array[str]] = _arrow72

def split_string(x: Array[str]) -> Callable[[str], Array[str]]:
    return v8(x)


def _arrow75(v: str) -> Callable[[str], bool]:
    return closure23(None, v)


v9: Callable[[str, str], bool] = _arrow75

def starts_with(x: str) -> Callable[[str], bool]:
    return v9(x)


def _arrow76(v: int) -> Callable[[int, str], str]:
    return closure25(None, v)


v10: Callable[[int, int, str], str] = _arrow76
...
v15: Callable[[Array[str], str], str] = _arrow85

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v15(x)


def _arrow86(v: int) -> Callable[[str], str]:
    return closure37(None, v)


v16: Callable[[int, str], str] = _arrow86

def ellipsis(x: int) -> Callable[[str], str]:
    return v16(x)


def _arrow89(v: int64) -> Callable[[str], str]:
    return closure39(None, v)


v17: Callable[[int64, str], str] = _arrow89

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v17(x)


def _arrow91(v: Exception) -> str:
    return closure41(None, v)


v18: Callable[[Exception], str] = _arrow91

def format_exception(x: Exception) -> str:
    return v18(x)


def _arrow93(v: str) -> Callable[[Array[str]], str]:
    return closure42(None, v)


v19: Callable[[str, Array[str]], str] = _arrow93

def concat_array_trailing(x: str) -> Callable[[Array[str]], str]:
    return v19(x)


def _arrow94(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure44(None, v)


v20: Callable[[str, IEnumerable_1[str]], str] = _arrow94

def concat(x: str) -> Callable[[IEnumerable_1[str]], str]:
    return v20(x)


def _arrow96(v: str) -> Callable[[Array[str]], str]:
    return closure46(None, v)


v21: Callable[[str, Array[str]], str] = _arrow96

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v21(x)


def _arrow97(v: str) -> Array[str]:
    return closure48(None, v)


v22: Callable[[str], Array[str]] = _arrow97
