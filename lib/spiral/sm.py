...
def method4(__unit: None=None) -> Callable[[str, UH0], UH0]:
    def _arrow23(v: str) -> Callable[[UH0], UH0]:
...
v5: Callable[[str, str, str], str] = _arrow50

def replace_regex(x: str) -> Callable[[str, str], str]:
    return v5(x)


def _arrow51(v: int) -> Callable[[int, str], str]:
    return closure16(None, v)


v6: Callable[[int, int, str], str] = _arrow51

def slice(x: int) -> Callable[[int, str], str]:
    return v6(x)


def _arrow52(v: str) -> Callable[[str], Array[str]]:
    return closure19(None, v)


v7: Callable[[str, str], Array[str]] = _arrow52

def split(x: str) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow53(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure21(None, v)


v8: Callable[[Array[str], str], Array[str]] = _arrow53
...
def _arrow62(v: int) -> Callable[[str], str]:
    return closure37(None, v)


v16: Callable[[int, str], str] = _arrow62

def ellipsis(x: int) -> Callable[[str], str]:
    return v16(x)


def _arrow63(v: int64) -> Callable[[str], str]:
    return closure39(None, v)


v17: Callable[[int64, str], str] = _arrow63

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v17(x)


def _arrow64(v: Exception) -> str:
    return closure41(None, v)


v18: Callable[[Exception], str] = _arrow64
...
v19: Callable[[str, Array[str]], str] = _arrow65

def concat_array_trailing(x: str) -> Callable[[Array[str]], str]:
    return v19(x)


def _arrow66(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure44(None, v)


v20: Callable[[str, IEnumerable_1[str]], str] = _arrow66

def concat(x: str) -> Callable[[IEnumerable_1[str]], str]:
    return v20(x)


def _arrow67(v: str) -> Callable[[Array[str]], str]:
    return closure46(None, v)


v21: Callable[[str, Array[str]], str] = _arrow67

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v21(x)


def _arrow68(v: str) -> Array[str]:
    return closure48(None, v)


v22: Callable[[str], Array[str]] = _arrow68
