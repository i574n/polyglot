...
def method4(__unit: None=None) -> Callable[[str, UH0], UH0]:
    def _arrow32(v: str) -> Callable[[UH0], UH0]:
...
def closure31(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    ...
    v8_1: UH0 = fold_back(uncurry2(method4()), v2_1, UH0(0))
    def _arrow33(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
        return closure34(v8_1, v)
...
def closure35(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    v2_1: FSharpList[str] = of_array_1(v0_1)
    v8_1: UH0 = fold_back(uncurry2(method4()), v2_1, UH0(0))
    def _arrow34(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
        return closure36(v8_1, v)
...
def closure42(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow38(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure44(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow39(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow42
...
v1: Callable[[str, str], bool] = _arrow43

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow44(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow44
...
v3: Callable[[int, str, str], str] = _arrow45

def pad_right(x: int) -> Callable[[str, str], str]:
    return v3(x)


def _arrow46(v: str) -> Callable[[str, str], str]:
    return closure10(None, v)


v4: Callable[[str, str, str], str] = _arrow46
...
v5: Callable[[str, str, str], str] = _arrow48
...
v6: Callable[[int, int, str], str] = _arrow49
...
v15: Callable[[Array[str], str], str] = _arrow58

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v15(x)


def _arrow59(v: int) -> Callable[[str], str]:
    return closure37(None, v)


v16: Callable[[int, str], str] = _arrow59

def ellipsis(x: int) -> Callable[[str], str]:
    return v16(x)


def _arrow60(v: int64) -> Callable[[str], str]:
    return closure39(None, v)


v17: Callable[[int64, str], str] = _arrow60

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v17(x)


def _arrow61(v: Exception) -> str:
    return closure41(None, v)


v18: Callable[[Exception], str] = _arrow61
...
v19: Callable[[str, Array[str]], str] = _arrow63
