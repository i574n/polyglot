...
def closure16(unit_var: None, v0_1: int) -> Callable[[int, str], str]:
    def _arrow24(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure22(v0_1: Array[str], v1_1: str) -> Array[str]:
    ...
    x: Array[str] = split_1(v1_1, [join(method4(), v32)], None, 0)
    _v2 = x
    if _v2 is None:
...
def method5(v0_1: int64, v1_1: str) -> str:
    ...
    if v2_1 <= v0_1:
        ...
        v23: IEnumerable_1[str] = of_array([v16_1, "...", v1_1[int(to_int(v17_1)):int(to_int(v18_1)) + 1]])
...
def method6(v0_1: int, v1_1: Mut0) -> bool:
    return v1_1.l0 < v0_1
...
def closure40(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow35(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure42(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow36(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure44(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow37(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow39(v: str) -> Callable[[str], bool]:
    return closure0(None, v)


v0: Callable[[str, str], bool] = _arrow39

def contains(x: str) -> Callable[[str], bool]:
    return v0(x)


def _arrow40(v: str) -> Callable[[str], bool]:
    return closure2(None, v)


v1: Callable[[str, str], bool] = _arrow40

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow41(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow41

def pad_left(x: int) -> Callable[[str, str], str]:
    return v2(x)


def _arrow42(v: int) -> Callable[[str, str], str]:
    return closure7(None, v)


v3: Callable[[int, str, str], str] = _arrow42

def pad_right(x: int) -> Callable[[str, str], str]:
    return v3(x)


def _arrow43(v: str) -> Callable[[str, str], str]:
    return closure10(None, v)


v4: Callable[[str, str, str], str] = _arrow43

def replace(x: str) -> Callable[[str, str], str]:
    return v4(x)


def _arrow44(v: str) -> Callable[[str, str], str]:
    return closure13(None, v)


v5: Callable[[str, str, str], str] = _arrow44

def replace_regex(x: str) -> Callable[[str, str], str]:
    return v5(x)


def _arrow45(v: int) -> Callable[[int, str], str]:
    return closure16(None, v)


v6: Callable[[int, int, str], str] = _arrow45

def slice(x: int) -> Callable[[int, str], str]:
    return v6(x)


def _arrow46(v: str) -> Callable[[str], Array[str]]:
    return closure19(None, v)


v7: Callable[[str, str], Array[str]] = _arrow46

def split(x: str) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow47(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure21(None, v)


v8: Callable[[Array[str], str], Array[str]] = _arrow47
...
v9: Callable[[str, str], bool] = _arrow48
...
v10: Callable[[int, int, str], str] = _arrow49
...
v12: Callable[[str], str] = _arrow51

def to_upper(x: str) -> str:
    return v12(x)


def _arrow52(v: str) -> str:
    return closure30(None, v)


v13: Callable[[str], str] = _arrow52

def trim(x: str) -> str:
    return v13(x)


def _arrow54(v: Array[str]) -> Callable[[str], str]:
    return closure31(None, v)


v14: Callable[[Array[str], str], str] = _arrow54

def trim_end(x: Array[str]) -> Callable[[str], str]:
    return v14(x)


def _arrow56(v: Array[str]) -> Callable[[str], str]:
    return closure33(None, v)


v15: Callable[[Array[str], str], str] = _arrow56

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v15(x)


def _arrow57(v: int) -> Callable[[str], str]:
    return closure35(None, v)


v16: Callable[[int, str], str] = _arrow57

def ellipsis(x: int) -> Callable[[str], str]:
    return v16(x)


def _arrow58(v: int64) -> Callable[[str], str]:
    return closure37(None, v)


v17: Callable[[int64, str], str] = _arrow58

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v17(x)


def _arrow59(v: Exception) -> str:
    return closure39(None, v)


v18: Callable[[Exception], str] = _arrow59
...
v19: Callable[[str, Array[str]], str] = _arrow60

def concat_array_trailing(x: str) -> Callable[[Array[str]], str]:
    return v19(x)


def _arrow61(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure42(None, v)


v20: Callable[[str, IEnumerable_1[str]], str] = _arrow61

def concat(x: str) -> Callable[[IEnumerable_1[str]], str]:
    return v20(x)


def _arrow62(v: str) -> Callable[[Array[str]], str]:
    return closure44(None, v)


v21: Callable[[str, Array[str]], str] = _arrow62

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v21(x)


def _arrow63(v: str) -> Array[str]:
    return closure46(None, v)


v22: Callable[[str], Array[str]] = _arrow63
