...
def closure42(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow41(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure44(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow42(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow54(v: str) -> Callable[[str], bool]:
    return closure23(None, v)


v9: Callable[[str, str], bool] = _arrow54
