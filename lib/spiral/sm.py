...
def closure44(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow63(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure46(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow64(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow67
...
v1: Callable[[str, str], bool] = _arrow68
...
v2: Callable[[int, str, str], str] = _arrow69

def pad_left(x: int) -> Callable[[str, str], str]:
    return v2(x)


def _arrow70(v: int) -> Callable[[str, str], str]:
    return closure7(None, v)


v3: Callable[[int, str, str], str] = _arrow70
...
v4: Callable[[str, str, str], str] = _arrow71
...
def _arrow84(v: int) -> Callable[[str], str]:
    return closure37(None, v)


v16: Callable[[int, str], str] = _arrow84
