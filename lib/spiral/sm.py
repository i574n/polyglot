...
def closure7(unit_var: None, v0_1: int) -> Callable[[str], str]:
    def _arrow29(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure15(unit_var: None, v0_1: str) -> Callable[[str], Array[str]]:
    def _arrow37(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure27(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    def _arrow43(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure29(unit_var: None, v0_1: Array[str]) -> Callable[[str], str]:
    def _arrow44(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure36(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow47(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure38(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow48(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow50

def contains(x: str) -> Callable[[str], bool]:
    return v0(x)


def _arrow51(v: str) -> Callable[[str], bool]:
    return closure2(None, v)


v1: Callable[[str, str], bool] = _arrow51

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow52(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow52
...
v3: Callable[[int, str], str] = _arrow54
...
v4: Callable[[str, str, str], str] = _arrow55
...
v13: Callable[[Array[str], str], str] = _arrow65

def trim_end(x: Array[str]) -> Callable[[str], str]:
    return v13(x)


def _arrow66(v: Array[str]) -> Callable[[str], str]:
    return closure29(None, v)


v14: Callable[[Array[str], str], str] = _arrow66

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v14(x)


def _arrow67(v: int) -> Callable[[str], str]:
    return closure31(None, v)


v15: Callable[[int, str], str] = _arrow67

def ellipsis(x: int) -> Callable[[str], str]:
    return v15(x)


def _arrow68(v: int64) -> Callable[[str], str]:
    return closure33(None, v)


v16: Callable[[int64, str], str] = _arrow68

def ellipsis_end(x: int64) -> Callable[[str], str]:
    return v16(x)


def _arrow69(v: Exception) -> str:
    return closure35(None, v)


v17: Callable[[Exception], str] = _arrow69
...
v18: Callable[[str, Array[str]], str] = _arrow70

def concat_array_trailing(x: str) -> Callable[[Array[str]], str]:
    return v18(x)


def _arrow71(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure38(None, v)


v19: Callable[[str, IEnumerable_1[str]], str] = _arrow71
...
v20: Callable[[str, Array[str]], str] = _arrow72

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v20(x)


def _arrow73(v: str) -> Array[str]:
    return closure42(None, v)


v21: Callable[[str], Array[str]] = _arrow73
