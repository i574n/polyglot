...
def closure22(v0_1: Array[str], v1_1: str) -> Array[str]:
    ...
    v33: IEnumerable_1[str] = of_array(v0_1)
    x: Array[str] = split_1(v1_1, [join(method3(), v33)], None, 0)
    _v2 = x
    return value_2(_v2)
...
v3: Callable[[int, str, str], str] = _arrow34
...
v5: Callable[[str, str, str], str] = _arrow36
...
def _arrow39(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure21(None, v)


v8: Callable[[Array[str], str], Array[str]] = _arrow39
...
v15: Callable[[Array[str], str], str] = _arrow46

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v15(x)


def _arrow47(v: int) -> Callable[[str], str]:
    return closure35(None, v)


v16: Callable[[int, str], str] = _arrow47
...
v19: Callable[[str, Array[str]], str] = _arrow52
