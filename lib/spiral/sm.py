...
def closure40(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow26(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure42(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow27(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow29
...
v1: Callable[[str, str], bool] = _arrow30
...
v2: Callable[[int, str, str], str] = _arrow31
...
v3: Callable[[int, str, str], str] = _arrow32
...
v5: Callable[[str, str, str], str] = _arrow34
...
v8: Callable[[Array[str], str], Array[str]] = _arrow37
...
v10: Callable[[int, int, str], str] = _arrow39
...
def _arrow54(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure42(None, v)


v20: Callable[[str, IEnumerable_1[str]], str] = _arrow54
...
v21: Callable[[str, Array[str]], str] = _arrow56
