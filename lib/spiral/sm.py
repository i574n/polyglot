...
def closure0(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow11(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure2(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow12(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure7(unit_var: None, v0_1: int) -> Callable[[str, str], str]:
    def _arrow17(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure10(unit_var: None, v0_1: str) -> Callable[[str, str], str]:
    def _arrow20(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure13(unit_var: None, v0_1: str) -> Callable[[str, str], str]:
    def _arrow23(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure16(unit_var: None, v0_1: int) -> Callable[[int, str], str]:
    def _arrow25(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def closure21(unit_var: None, v0_1: Array[str]) -> Callable[[str], Array[str]]:
    def _arrow27(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Array[str]:
...
def closure23(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow28(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure32(unit_var: None, v0_1: str) -> Callable[[UH0], UH0]:
    def _arrow32(v: UH0, unit_var: Any=unit_var, v0_1: Any=v0_1) -> UH0:
...
def closure37(unit_var: None, v0_1: int) -> Callable[[str], str]:
    def _arrow55(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure39(unit_var: None, v0_1: int64) -> Callable[[str], str]:
    def _arrow58(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure44(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow61(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure46(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow62(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow64(v: str) -> Callable[[str], bool]:
    return closure0(None, v)


v0: Callable[[str, str], bool] = _arrow64
...
v1: Callable[[str, str], bool] = _arrow65

def ends_with(x: str) -> Callable[[str], bool]:
    return v1(x)


def _arrow67(v: int) -> Callable[[str, str], str]:
    return closure4(None, v)


v2: Callable[[int, str, str], str] = _arrow67
...
v3: Callable[[int, str, str], str] = _arrow68

def pad_right(x: int) -> Callable[[str, str], str]:
    return v3(x)


def _arrow69(v: str) -> Callable[[str, str], str]:
    return closure10(None, v)


v4: Callable[[str, str, str], str] = _arrow69

def replace(x: str) -> Callable[[str, str], str]:
    return v4(x)


def _arrow71(v: str) -> Callable[[str, str], str]:
    return closure13(None, v)


v5: Callable[[str, str, str], str] = _arrow71
...
def _arrow78(v: str) -> str:
    return closure28(None, v)


v11: Callable[[str], str] = _arrow78
...
v13: Callable[[str], str] = _arrow80

def trim(x: str) -> str:
    return v13(x)


def _arrow81(v: Array[str]) -> Callable[[str], str]:
    return closure31(None, v)


v14: Callable[[Array[str], str], str] = _arrow81

def trim_end(x: Array[str]) -> Callable[[str], str]:
    return v14(x)


def _arrow82(v: Array[str]) -> Callable[[str], str]:
    return closure35(None, v)


v15: Callable[[Array[str], str], str] = _arrow82

def trim_start(x: Array[str]) -> Callable[[str], str]:
    return v15(x)


def _arrow83(v: int) -> Callable[[str], str]:
    return closure37(None, v)


v16: Callable[[int, str], str] = _arrow83

def ellipsis(x: int) -> Callable[[str], str]:
    return v16(x)


def _arrow84(v: int64) -> Callable[[str], str]:
    return closure39(None, v)


v17: Callable[[int64, str], str] = _arrow84
...
def _arrow89(v: str) -> Callable[[IEnumerable_1[str]], str]:
    return closure44(None, v)


v20: Callable[[str, IEnumerable_1[str]], str] = _arrow89
...
v21: Callable[[str, Array[str]], str] = _arrow90

def join_0027(x: str) -> Callable[[Array[str]], str]:
    return v21(x)


def _arrow91(v: str) -> Array[str]:
    return closure48(None, v)


v22: Callable[[str], Array[str]] = _arrow91
