pub mod Runtime {
    ...
    pub fn method7(
        ...
        let v81: Runtime::US3 = defaultValue(Runtime::US3::US3_1, map(Runtime::method8(), v5));
        let v121: DateTime = match &v81 {
            Runtime::US3::US3_0(v81_0_0) => {
    ...
    pub fn method36(
        ...
        let v268: std::string::String = format!("{:#?}", v5);
        let v294: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v268)),
                (),
            );
            ()
        };
        ...
        let v328: std::string::String = format!("{:#?}", v6);
        let v354: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v328)),
                (),
            );
            ()
        };
        ...
        let v424: std::string::String = format!("{:#?}", v8);
        let v450: () = {
            Runtime::closure7(
                v10.clone(),
                sprintf!("{}", fable_library_rust::String_::fromString(v424)),
                (),
            );
            ()
        };
