pub mod Runtime {
    ...
    pub fn closure6(unitVar: (), unitVar_1: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let v584: &str = inline_colorization::color_yellow;
            let v586: &str = &*v557;
    ...
    pub fn closure22(
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let v591: &str = inline_colorization::color_bright_blue;
            let v593: &str = &*v564;
            let v595: &str = inline_colorization::color_reset;
            let v597: string = string("format!(\"{v591}{v593}{v595}\")");
            let v598: std::string::String = format!("{v591}{v593}{v595}");
            let v600: string = fable_library_rust::String_::fromString(v598);
            ...
            let v725: std::string::String = format!("{:#?}", v1_1);
            let v751: () = {
                Runtime::closure23(
                    v632.clone(),
                    sprintf!("{}", fable_library_rust::String_::fromString(v725)),
                    (),
                );
                ()
            };
            ...
            let v821: std::string::String = format!("{:#?}", v3);
            let v847: () = {
                Runtime::closure23(
                    v632.clone(),
                    sprintf!("{}", fable_library_rust::String_::fromString(v821)),
                    (),
                );
                ()
            };
            ...
            let v881: std::string::String = format!("{:#?}", v4);
            let v907: () = {
                Runtime::closure23(
                    v632.clone(),
                    sprintf!("{}", fable_library_rust::String_::fromString(v881)),
                    (),
                );
                ()
            };
            ...
            let v977: std::string::String = format!("{:#?}", v6);
            let v1003: () = {
                Runtime::closure23(
                    v632.clone(),
                    sprintf!("{}", fable_library_rust::String_::fromString(v977)),
                    (),
                );
                ()
            };
    ...
    pub fn closure34(v0_1: LrcPtr<TaskCanceledException>, unitVar: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let v660: std::string::String = format!("{:#?}", v0_1);
            let v686: () = {
                Runtime::closure23(
                    v626.clone(),
                    sprintf!("{}", fable_library_rust::String_::fromString(v660)),
                    (),
                );
                ()
            };
