pub mod Common {
    ...
    pub fn method0(
        ...
        let _v1: (Common::US2, Common::US3) = (
            match &v8 {
                ...
                _ => {
                    let v15_1: Common::US2 = if string("Debug") == v3.clone() {
                        Common::US2::US2_0(Common::US0::US0_1)
                    } else {
                        Common::US2::US2_1
                    };
                    match &v15_1 {
                        Common::US2::US2_0(v15_1_0_0) => Common::US2::US2_0(match &v15_1 {
                            Common::US2::US2_0(x) => x.clone(),
                            _ => unreachable!(),
                        }),
                        _ => {
    ...
    pub fn closure10(v0_1: i32, v1_1: LrcPtr<Exception>, unitVar: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let _v102: LrcPtr<MutCell<Option<Common::US3>>> = refCell(None::<Common::US3>);
            let v107: () = {
                Common::closure13(
                    patternInput_2.4.clone(),
                    Func1::new({
                        let _v102 = _v102.clone();
                        move |v: Option<Common::US3>| Common::closure12(_v102.clone(), v)
                    }),
                    (),
                );
                ()
            };
            let v122: Common::US3 = defaultValue(Common::US3::US3_1, _v102.get().clone());
            let v162: DateTime = match &v122 {
                Common::US3::US3_0(v122_0_0) => {
