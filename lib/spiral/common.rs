pub mod Common {
    ...
    pub fn closure10(v0_1: i32, v1_1: LrcPtr<Exception>, unitVar: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let _v70: LrcPtr<MutCell<Option<Common::US3>>> = refCell(None::<Common::US3>);
            let v75: () = {
                Common::closure13(
                    patternInput_2.4.clone(),
                    Func1::new({
                        let _v70 = _v70.clone();
                        move |v: Option<Common::US3>| Common::closure12(_v70.clone(), v)
                    }),
                    (),
                );
                ()
            };
            let v88: Common::US3 = defaultValue(Common::US3::US3_1, _v70.get().clone());
            let v128: DateTime = match &v88 {
                Common::US3::US3_0(v88_0_0) => {
