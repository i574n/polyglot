pub mod Common {
    ...
    pub fn closure0(
        ...
        let v5: string = Common::method1(Common::method0());
        let v11_1: Common::US1 = if string("Verbose") == v5.clone() {
        ...
        };
        {
            let x: (Common::US1, Common::US2) = (
                match &v11_1 {
                    Common::US1::US1_0(v11_1_0_0) => Common::US1::US1_0(match &v11_1 {
                        Common::US1::US1_0(x) => x.clone(),
                        _ => unreachable!(),
                    }),
                    _ => {
                        let v19: Common::US1 = if string("Debug") == v5.clone() {
                            Common::US1::US1_0(Common::US0::US0_1)
                        } else {
                            Common::US1::US1_1
                        };
                        match &v19 {
                            Common::US1::US1_0(v19_0_0) => Common::US1::US1_0(match &v19 {
                                Common::US1::US1_0(x) => x.clone(),
                                _ => unreachable!(),
                            }),
                            _ => {
                                let v27: Common::US1 = if string("Info") == v5.clone() {
                                    Common::US1::US1_0(Common::US0::US0_2)
                                } else {
                                    Common::US1::US1_1
                                };
                                match &v27 {
                                    Common::US1::US1_0(v27_0_0) => Common::US1::US1_0(match &v27 {
                                        Common::US1::US1_0(x) => x.clone(),
                                        _ => unreachable!(),
                                    }),
                                    _ => {
                                        let v35: Common::US1 = if string("Warning") == v5.clone() {
                                            Common::US1::US1_0(Common::US0::US0_3)
                                        } else {
                                            Common::US1::US1_1
                                        };
                                        match &v35 {
                                            Common::US1::US1_0(v35_0_0) => {
                                                Common::US1::US1_0(match &v35 {
                                                    Common::US1::US1_0(x) => x.clone(),
                                                    _ => unreachable!(),
                                                })
                                            }
    ...
    pub fn closure6(v0: i32, v1: Func0<()>, v2_1: i32, unitVar: ()) -> Common::US4 {
        if v2_1 < v0 {
            v1();
            Common::US4::US4_0
        } else {
    ...
    pub fn closure10(
        ...
        }
        {
            ...
            let _v38: LrcPtr<MutCell<Option<Common::US2>>> = refCell(None::<Common::US2>);
            {
            ...
            {
                let v65: Common::US2 = defaultValue(Common::US2::US2_1, _v38.get().clone());
                let v163: DateTime = match &v65 {
                    Common::US2::US2_0(v65_0_0) => {
    ...
    pub fn method7(v0: Common::US0, v1: Func0<string>, v2_1: Func0<(i32, LrcPtr<Exception>)>) {
        Common::method16(
            ...
            Func0::new({
                ...
                let v1 = v1.clone();
                let v2_1 = v2_1.clone();
                move || Common::closure10(v0.clone(), v1.clone(), v2_1.clone(), ())
            }),
        );
    }
        ...
        '_method6: loop {
            break '_method6 ({
                ...
                );
                {
                    ...
                    match &v9_1 {
                        Common::US5::US5_0(v9_1_0_0) => match &v9_1 {
    ...
    > {
        static v2: OnceInit<
            ...
            >,
        > = OnceInit::new();
        v2.get_or_init(|| Func1::new(move |v: Common::US0| Common::closure0((), v)))
            .clone()
    }
    ...
    pub fn v9() -> Func1<Func0<()>, LrcPtr<dyn IDisposable>> {
        static v9: OnceInit<Func1<Func0<()>, LrcPtr<dyn IDisposable>>> = OnceInit::new();
        v9.get_or_init(|| Func1::new(move |v: Func0<()>| Common::closure2((), v)))
            .clone()
    }
    ...
    pub fn v10() -> Func1<i32, Func1<Func0<()>, Option<()>>> {
        static v10: OnceInit<Func1<i32, Func1<Func0<()>, Option<()>>>> = OnceInit::new();
        v10.get_or_init(|| Func1::new(move |v: i32| Common::closure3((), v)))
            .clone()
    }
    ...
    pub fn v11() -> Func1<Func0<()>, Func0<()>> {
        ...
        v11.get_or_init(|| Func1::new(move |v: Func0<()>| Common::closure11((), v)))
            .clone()
    }
