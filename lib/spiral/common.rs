pub mod Common {
    ...
    pub fn closure0(
        ...
        let v9: Common::US2 = if string("Verbose") == v3_1.clone() {
            Common::US2::US2_0(Common::US0::US0_0)
        } else {
            Common::US2::US2_1
        };
        let v54: Common::US2 = match &v9 {
            Common::US2::US2_0(v9_0_0) => Common::US2::US2_0(match &v9 {
                Common::US2::US2_0(x) => x.clone(),
                _ => unreachable!(),
            }),
            _ => {
                let v17: Common::US2 = if string("Debug") == v3_1.clone() {
                    Common::US2::US2_0(Common::US0::US0_1)
                } else {
                    Common::US2::US2_1
                };
                match &v17 {
                    Common::US2::US2_0(v17_0_0) => Common::US2::US2_0(match &v17 {
                        Common::US2::US2_0(x) => x.clone(),
                        _ => unreachable!(),
                    }),
                    _ => {
                        let v25: Common::US2 = if string("Info") == v3_1.clone() {
                            Common::US2::US2_0(Common::US0::US0_2)
                        } else {
                            Common::US2::US2_1
                        };
                        match &v25 {
                            Common::US2::US2_0(v25_0_0) => Common::US2::US2_0(match &v25 {
                                Common::US2::US2_0(x) => x.clone(),
                                _ => unreachable!(),
                            }),
                            _ => {
                                let v33: Common::US2 = if string("Warning") == v3_1.clone() {
                                    Common::US2::US2_0(Common::US0::US0_3)
                                } else {
                                    Common::US2::US2_1
                                };
                                match &v33 {
                                    Common::US2::US2_0(v33_0_0) => Common::US2::US2_0(match &v33 {
                                        Common::US2::US2_0(x) => x.clone(),
                                        _ => unreachable!(),
                                    }),
                                    _ => {
                                        let v41: Common::US2 = if string("Critical") == v3_1.clone()
                                        {
                                        ...
                                        match &v41 {
                                            Common::US2::US2_0(v41_0_0) => {
                                                Common::US2::US2_0(match &v41 {
                                                    Common::US2::US2_0(x) => x.clone(),
                                                    _ => unreachable!(),
                                                })
                                            }
    ...
    pub fn closure11(
        ...
        }
        {
            ...
            let _v11: LrcPtr<MutCell<Option<Common::US1>>> = refCell(None::<Common::US1>);
            {
            ...
            {
                let v16: Common::US1 = defaultValue(Common::US1::US1_1, _v11.get().clone());
                let v35: DateTime = match &v16 {
                    Common::US1::US1_0(v16_0_0) => {
    ...
    pub fn method12(v0_1: Common::US0, v1_1: Func0<string>) {
        fn v2_1(
            v: Common::US0,
        ) -> (
            LrcPtr<Common::Mut0>,
    ...
    pub fn method13(v0_1: Func0<()>) -> Func0<()> {
        v0_1
    }
