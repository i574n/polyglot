pub mod Common {
    ...
    pub fn method2(v0_1: string) -> string {
        ...
        let v14_1: string = Common::method3();
            ...
            }
            {
                ...
                if if (patternInput_3.2.clone()).l0.get().clone() == false {
                    ...
                    }
                    {
                        ...
                        let _v92: LrcPtr<MutCell<Option<Common::US3>>> =
                        ...
                        {
                            let v107: Common::US3 =
                                defaultValue(Common::US3::US3_1, _v92.get().clone());
                            let v147: DateTime = match &v107 {
                                Common::US3::US3_0(v107_0_0) => {
                                    let v121: TimeSpan = TimeSpan::new_ticks(
                                        {
                                            let _arg: DateTime = DateTime::now();
                                            _arg.ticks()
                                        } - match &v107 {
