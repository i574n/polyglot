pub mod File_system {
    ...
    pub fn closure7(
        ...
        }
        {
            ...
            let _v39: LrcPtr<MutCell<Option<File_system::US1>>> = refCell(None::<File_system::US1>);
            {
            ...
            {
                let v44: File_system::US1 =
                    defaultValue(File_system::US1::US1_1, _v39.get().clone());
                let v63: DateTime = match &v44 {
                    File_system::US1::US1_0(v44_0_0) => {
    ...
    pub fn method26(v0_1: chrono::DateTime<chrono::Utc>) -> chrono::DateTime<chrono::Utc> {
        v0_1
    }
    pub fn method27(v0_1: chrono::DateTime<chrono::Local>) -> chrono::DateTime<chrono::Local> {
        v0_1
    }
        ...
        }
        {
            ...
            let v140: File_system::US3 = match &v121 {
                File_system::US11::US11_0(v121_0_0) => {
                    let v123: chrono::DateTime<chrono::Utc> = File_system::method26(match &v121 {
                    ...
                    let v131: chrono::DateTime<chrono::Local> = File_system::method27(v127);
            ...
            }
            {
                ...
                _v154.set(Some(zero));
                {
                    ...
                    let v186: string = File_system::method28();
    ...
    pub fn method31(v0_1: Guid) -> string {
        let _v1: MutCell<Option<string>> = MutCell::new(None::<string>);
        {
            let x: string = File_system::method34(
                File_system::method34(
                    File_system::method34(File_system::method32(), File_system::method33()),
    ...
    pub fn method24() -> string {
        ...
        {
            let x: string = File_system::method31(File_system::method25(new_guid(), v6_1));
            _v0.set(Some(x))
        }
        match &_v0.get().clone() {
            None => panic!("{}", string("base.run_target / _v0=None"),),
