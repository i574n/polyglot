...
def method5(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr90())) >= find(v13, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr91()))):
...
def closure7(unit_var: None, v0_1: int) -> Callable[[int], Async[bool]]:
    def _arrow92(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def closure15(v0_1: int | None, v1_1: bool) -> Callable[[int], Async[int64]]:
    def _arrow94(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
...
def closure14(unit_var: None, v0_1: int | None=None) -> Callable[[bool, int], Async[int64]]:
    def _arrow95(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[int], Async[int64]]:
...
def closure20(unit_var: None, v0_1: int | None=None) -> Callable[[int], Async[int]]:
    def _arrow96(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int]:
        return closure21(v0_1, v)

    return _arrow96


def _arrow97(__unit: None=None) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, None)


v0: Callable[[], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow97
...
def _arrow98(v: int) -> Async[bool]:
    return closure2(None, v)


v1: Callable[[int], Async[bool]] = _arrow98

def test_port_open(x: int) -> Async[bool]:
    return v1(x)


def _arrow99(v: int) -> Callable[[int], Async[bool]]:
    return closure7(None, v)


v2: Callable[[int, int], Async[bool]] = _arrow99

def test_port_open_timeout(x: int) -> Callable[[int], Async[bool]]:
    return v2(x)


def _arrow100(v: int | None=None) -> Callable[[bool, int], Async[int64]]:
    return closure14(None, v)


v3: Callable[[int | None, bool, int], Async[int64]] = _arrow100

def wait_for_port_access(x: int | None=None) -> Callable[[bool, int], Async[int64]]:
    return v3(x)


def _arrow101(v: int | None=None) -> Callable[[int], Async[int]]:
    return closure20(None, v)


v4: Callable[[int | None, int], Async[int]] = _arrow101
