...
def method1(__unit: None=None) -> tuple[US1, US2]:
    ...
    def _arrow144(__unit: None=None) -> US1:
    ...
    return (US1(0, v6.fields[0]) if (v6.tag == 0) else _arrow144(), US2(1) if (method2("AUTOMATION") != "True") else US2(0, from_value(ticks_1(now()), False)))
...
def method8(v0_1: US0) -> bool:
    ...
    if pattern_input[2].l0 == False:
        ...
        return find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr145())) >= find(v35, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr146()))
...
def method7(v0_1: str, v1_1: int) -> Async[bool]:
    def _arrow153(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
        v2539: Async[CancellationToken] = cancellation_token()
        def _arrow152(_arg: CancellationToken) -> Async[bool]:
            def _arrow151(_arg_1: IDisposable) -> Async[bool]:
                def _arrow149(__unit: None=None) -> Async[bool]:
                    v2631: Async[None] = await_task(None)
                    def _arrow148(__unit: None=None) -> Async[bool]:
                        return singleton.Return(True)

                    return singleton.Bind(v2631, _arrow148)

                def _arrow150(_arg_3: Exception) -> Async[bool]:
                    v2718: None
                    closure5(v1_1, _arg_3, None)
                    v2718 = None
                    return singleton.Return(False)

                return singleton.TryWith(singleton.Delay(_arrow149), _arrow150)

            return singleton.Using(None, _arrow151)

        return singleton.Bind(v2539, _arrow152)

    return singleton.Delay(_arrow153)
...
def closure3(unit_var: None, v0_1: str) -> Callable[[int], Async[bool]]:
    def _arrow154(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def method25(v0_1: Async[Any]) -> Async[US7]:
    def _arrow158(__unit: None=None, v0_1: Any=v0_1) -> Async[US7]:
        def _arrow157(_arg: Any) -> Async[US7]:
            return singleton.Return(None)

        return singleton.Bind(v0_1, _arrow157)

    return singleton.Delay(_arrow158)


def method28(v0_1: Async[US7]) -> Async[US8]:
    def _arrow160(__unit: None=None, v0_1: Any=v0_1) -> Async[US8]:
        def _arrow159(_arg: US7) -> Async[US8]:
            v74: US7 = _arg
...
def method29(v0_1: int, v1_1: Async[US8]) -> Async[US6]:
    def _arrow162(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[US6]:
        def _arrow161(_arg: US8) -> Async[US6]:
            v1019: US8 = _arg
            v1143: US6
            if v1019.tag == 0:
        ...
        return singleton.Bind(v1_1, _arrow161)
...
def method22(v0_1: int, v1_1: str, v2_1: int) -> Async[bool]:
    def _arrow166(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[bool]:
        v69: Async[US6] = method23(v0_1, method6(v1_1, v2_1))
        def _arrow165(_arg: US6) -> Async[bool]:
            v70: US6 = _arg
            v73: bool = v70.fields[0] if (v70.tag == 0) else False
            return singleton.Return(v73)

        return singleton.Bind(v69, _arrow165)
...
def closure12(v0_1: int, v1_1: str) -> Callable[[int], Async[bool]]:
    def _arrow167(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
...
def closure11(unit_var: None, v0_1: int) -> Callable[[str, int], Async[bool]]:
    def _arrow168(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[int], Async[bool]]:
...
def closure20(v0_1: int | None, v1_1: bool, v2_1: str) -> Callable[[int], Async[int64]]:
    def _arrow175(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int64]:
...
def closure19(v0_1: int | None, v1_1: bool) -> Callable[[str, int], Async[int64]]:
    def _arrow176(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Callable[[int], Async[int64]]:
...
def closure18(unit_var: None, v0_1: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    def _arrow177(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str, int], Async[int64]]:
...
def method43(v0_1: int | None, v1_1: str, v2_1: int) -> Async[int]:
    def _arrow179(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int]:
        ...
        def _arrow178(_arg: bool) -> Async[int]:
            if _arg == False:
        ...
        return singleton.Bind(v249, _arrow178)
...
def closure25(v0_1: int | None, v1_1: str) -> Callable[[int], Async[int]]:
    def _arrow180(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int]:
...
def closure24(unit_var: None, v0_1: int | None=None) -> Callable[[str, int], Async[int]]:
    def _arrow181(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[int], Async[int]]:
...
def _arrow182(__unit: None=None) -> None:
    closure0(None, None)


v1: Callable[[], None] = _arrow182
...
def _arrow184(v: str) -> Callable[[int], Async[bool]]:
    return closure3(None, v)


v16: Callable[[str, int], Async[bool]] = _arrow184

def test_port_open(x: str) -> Callable[[int], Async[bool]]:
    return v16(x)


def _arrow185(v: int) -> Callable[[str, int], Async[bool]]:
    return closure11(None, v)


v17: Callable[[int, str, int], Async[bool]] = _arrow185

def test_port_open_timeout(x: int) -> Callable[[str, int], Async[bool]]:
    return v17(x)


def _arrow186(v: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    return closure18(None, v)


v18: Callable[[int | None, bool, str, int], Async[int64]] = _arrow186

def wait_for_port_access(x: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    return v18(x)


def _arrow187(v: int | None=None) -> Callable[[str, int], Async[int]]:
    return closure24(None, v)


v19: Callable[[int | None, str, int], Async[int]] = _arrow187
