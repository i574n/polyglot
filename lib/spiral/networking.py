...
def closure0(unit_var: None, v0_1: US0) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    ...
    _v6 = some(None)
    def _arrow102(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> int64 | None:
        raise Exception("base.run_target / _v6=None")

    return (v2_1, v1_1, v3_1, _arrow102() if (_v6 is None) else value_1(_v6), v5_1)
...
def closure6(v0_1: US0, v1_1: Callable[[], str], v2_1: Callable[[], str], unit_var: None) -> str:
    ...
    _v82 = x_2
    def _arrow103(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, unit_var: Any=unit_var) -> str:
        raise Exception("base.run_target / _v82=None")

    return trim_end(trim_start(((((((((("" + v67) + " ") + (_arrow103() if (_v82 is None) else _v82)) + " #") + str(v68)) + " ") + v1_1(None)) + " / ") + v2_1(None)) + ""), " ", "/")
...
def method4(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr104())) >= find(v15, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr105()))):
...
def closure2(unit_var: None, v0_1: str) -> Callable[[int], Async[bool]]:
    def _arrow106(v: int, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[bool]:
...
def closure8(v0_1: int, v1_1: str) -> Callable[[int], Async[bool]]:
    def _arrow107(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
...
def closure7(unit_var: None, v0_1: int) -> Callable[[str, int], Async[bool]]:
    def _arrow108(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[int], Async[bool]]:
...
def closure17(v0_1: int | None, v1_1: bool, v2_1: str) -> Callable[[int], Async[int64]]:
    def _arrow109(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int64]:
...
def closure16(v0_1: int | None, v1_1: bool) -> Callable[[str, int], Async[int64]]:
    def _arrow110(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Callable[[int], Async[int64]]:
...
def closure15(unit_var: None, v0_1: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    def _arrow111(v: bool, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str, int], Async[int64]]:
...
def closure22(v0_1: int | None, v1_1: str) -> Callable[[int], Async[int]]:
    def _arrow112(v: int, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int]:
...
def closure21(unit_var: None, v0_1: int | None=None) -> Callable[[str, int], Async[int]]:
    def _arrow113(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[int], Async[int]]:
        return closure22(v0_1, v)

    return _arrow113


def _arrow114(v: US0) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, v)


v0: Callable[[US0], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow114
...
def _arrow115(v: str) -> Callable[[int], Async[bool]]:
    return closure2(None, v)


v2: Callable[[str, int], Async[bool]] = _arrow115

def test_port_open(x: str) -> Callable[[int], Async[bool]]:
    return v2(x)


def _arrow116(v: int) -> Callable[[str, int], Async[bool]]:
    return closure7(None, v)


v3: Callable[[int, str, int], Async[bool]] = _arrow116

def test_port_open_timeout(x: int) -> Callable[[str, int], Async[bool]]:
    return v3(x)


def _arrow117(v: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    return closure15(None, v)


v4: Callable[[int | None, bool, str, int], Async[int64]] = _arrow117

def wait_for_port_access(x: int | None=None) -> Callable[[bool, str, int], Async[int64]]:
    return v4(x)


def _arrow118(v: int | None=None) -> Callable[[str, int], Async[int]]:
    return closure21(None, v)


v5: Callable[[int | None, str, int], Async[int]] = _arrow118
