pub mod File_system {
    ...
    pub fn method1() -> (File_system::US1, File_system::US2) {
        ...
        (
            ...
            if File_system::method2(string("AUTOMATION")) != string("True") {
                ...
                File_system::US2::US2_0(unbox::<i64>(&defaultOf()))
            },
        )
    }
    ...
    pub fn method87(
        ...
        let v86 = File_system::method83();
        let v98: Result<std::path::PathBuf, string> = v85.map_err(|x| v86(x));
        let v101 = File_system::method85();
        let v102 = File_system::method86();
        ...
        match &v103 {
            ...
            File_system::US13::US13_1(v103_1_0) => File_system::method88(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
    ...
    pub fn method82(v0_1: string, v1_1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        ...
        match &v102 {
            ...
            File_system::US13::US13_1(v102_1_0) => File_system::method91(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
                    move |b0: u8, b1: string| {
    ...
    pub fn method93(
        ...
        let v10: () = defaultOf();
        let v36: i32 = unbox::<i32>(&defaultOf());
        let v61: i32 = unbox::<i32>(&defaultOf());
    ...
    pub fn method92(v0_1: string, v1_1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        let v9: () = defaultOf();
        let v35_1: i32 = unbox::<i32>(&defaultOf());
        let v60: i32 = unbox::<i32>(&defaultOf());
    ...
    pub fn method80(v0_1: string) -> string {
        if v0_1.clone() == string("") {
            ...
            let v31_1: File_system::US14 =
                defaultValue(File_system::US14::US14_1, map(File_system::method96(), v10));
