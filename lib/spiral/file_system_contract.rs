pub mod File_system {
    ...
    pub fn method3(v0_1: string, v1: string) -> string {
        sprintf!(
            "path: {} / ex: {} / {}",
            File_system::closure2((), v0_1),
            v1,
    ...
    pub fn closure6(v0_1: string, v1: string, unitVar: ()) -> string {
        File_system::method3(v0_1, v1)
    }
    pub fn method2(
        v0_1: string,
        v1: File_system::US2,
    ...
    pub fn closure35(unitVar: (), v0_1: string) -> Option<string> {
        ...
        {
            let x: File_system::US6 = unbox::<File_system::US6>(&defaultOf());
            _v1.set(Some(x))
        }
        {
