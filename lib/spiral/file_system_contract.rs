                    ...
                    }
                    {
                        ...
                        if if (patternInput_3.2.clone()).l0.get().clone() == false {
                            ...
                            }
                            {
                                ...
                                let v225: u64 = near_sdk::env::block_timestamp();
                                let _v226: LrcPtr<MutCell<Option<File_system::US3>>> =
                                ...
                                }
                                {
                                    let v241: File_system::US3 =
                                        defaultValue(File_system::US3::US3_1, _v226.get().clone());
                                    let v251: u64 = match &v241 {
                                    ...
                                    let v254: u64 = v251 / 60_u64 % 60_u64;
                                    let v256: u64 = v251 / 3600_u64 % 24_u64;
                                    ...
                                    let v558: &str = inline_colorization::color_yellow;
                                    let v560: &str = &*v520;
                                    let v562: &str = inline_colorization::color_reset;
                                    let v564: string = string("format!(\"{v558}{v560}{v562}\")");
                                    let v565: std::string::String = format!("{v558}{v560}{v562}");
                                    let v567: string =
                            ...
                            }
                            {
                                ...
                                if if (patternInput_9.2.clone()).l0.get().clone() == false {
                                    ...
                                    }
                                    {
                                        ...
                                        let v908: u64 = near_sdk::env::block_timestamp();
                                        let _v909: LrcPtr<MutCell<Option<File_system::US3>>> =
                                            refCell(None::<File_system::US3>);
                                        {
                                        ...
                                        {
                                            let v924: File_system::US3 = defaultValue(
                                                File_system::US3::US3_1,
                                                _v909.get().clone(),
                                            );
                                            let v934: u64 = match &v924 {
                                            ...
                                            let v937: u64 = v934 / 60_u64 % 60_u64;
                                            let v939: u64 = v934 / 3600_u64 % 24_u64;
                                            let v941: std::string::String =
                                                format!("{:02}:{:02}:{:02}", v939, v937, v935);
                                            let v943: string =
                                                fable_library_rust::String_::fromString(v941);
                                            let v1203: string =
                                                padLeft(toLower(string("Warning")), 7_i32, ' ');
                                            let v1241: &str = inline_colorization::color_yellow;
                                            let v1243: &str = &*v1203;
                                            let v1245: &str = inline_colorization::color_reset;
                                            let v1247: string =
