pub mod File_system {
    ...
    pub fn method53() -> Func1<Option<()>, File_system::US11> {
    ...
    pub fn closure42(v0_1: string, unitVar: ()) {
        let v8: Arc<Async<i64>> = getZero();
        let v34_1: Arc<Async<()>> = getZero();
        getZero::<()>();
        ();
        ()
    }
    ...
    pub fn method89(
        ...
        if (v2_1) >= 11_u8 {
            ...
            let v33_1: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v26_1);
            Err(v33_1)
        } else {
            if let File_system::US5::US5_0(v20_1_0_0) = &v20_1 {
                ...
                let v295: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v288);
                Err(v295)
            }
        }
    }
    pub fn method88(
        ...
        let v86 = File_system::method84();
        let v98: Result<std::path::PathBuf, string> = v85.map_err(|x| v86(x));
        let v101 = File_system::method86();
        let v102 = File_system::method87();
        ...
        match &v103 {
            ...
            File_system::US13::US13_1(v103_1_0) => File_system::method89(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
    ...
    pub fn method92(
        ...
        if (v2_1) >= 11_u8 {
            ...
            let v32_1: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v25_1);
            Err(v32_1)
        } else {
            if let File_system::US5::US5_0(v19_1_0_0) = &v19_1 {
                ...
                let v294: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v287);
                Err(v294)
            }
        }
    }
    pub fn method83(v0_1: string, v1_1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        ...
        let v85 = File_system::method84();
        let v97: Result<std::path::PathBuf, string> = v84.map_err(|x| v85(x));
        let v100 = File_system::method86();
        let v101 = File_system::method87();
        ...
        match &v102 {
            ...
            File_system::US13::US13_1(v102_1_0) => File_system::method92(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
                    move |b0: u8, b1: string| {
    ...
    pub fn method94(
        ...
        let v10: () = getZero();
        let v36: i32 = unbox::<i32>(&getZero());
        let v61: i32 = unbox::<i32>(&getZero());
    ...
    pub fn method93(v0_1: string, v1_1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        let v9: () = getZero();
        let v35_1: i32 = unbox::<i32>(&getZero());
        let v60: i32 = unbox::<i32>(&getZero());
    ...
    pub fn method81(v0_1: string) -> string {
        if (v0_1.clone()) == string("") {
            ...
            let v31_1: File_system::US14 =
                defaultValue(File_system::US14::US14_1, map(File_system::method97(), v10));
    ...
    pub fn method107(v0_1: string, v1_1: string) {
        if (File_system::method9(v0_1.clone())) == false {
            let v4: LrcPtr<dyn IDisposable> = File_system::method65(v0_1);
            ()
        }
        {
