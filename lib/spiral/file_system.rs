pub mod File_system {
    ...
    pub fn closure11(unitVar: (), v0_1: string) -> Option<string> {
        ...
        {
            let v39: File_system::US0 = getValue(_v1.get().clone());
            match &v39 {
                File_system::US0::US0_0(v39_0_0) => Some(match &v39 {
        ...
        '_method4: loop {
            break '_method4 ({
                ...
                })(getValue(_v4.get().clone()))
                {
                    ...
                    let v36: Option<string> = (File_system::method2())(v3_1.get().clone());
                    let v39: File_system::US0 =
                        defaultValue(File_system::US0::US0_1, map(File_system::method3(), v36));
                    match &v39 {
                        File_system::US0::US0_0(v39_0_0) => {
                            let v0_1_temp: string = v0_1.get().clone();
                            let v1_1_temp: bool = v1_1.get().clone();
                            let v2_1_temp: string = v2_1.get().clone();
                            let v3_1_temp: string = match &v39 {
                                File_system::US0::US0_0(x) => x.clone(),
                                _ => unreachable!(),
                            };
                            v0_1.set(v0_1_temp);
    ...
    pub fn method1(v0_1: string, v1_1: bool, v2_1: string) -> string {
        ...
        })(getValue(_v3.get().clone()))
        {
            ...
            let v35: Option<string> = (File_system::method2())(v2_1.clone());
            let v38: File_system::US0 =
                defaultValue(File_system::US0::US0_1, map(File_system::method3(), v35));
            match &v38 {
                File_system::US0::US0_0(v38_0_0) => File_system::method4(
                    v0_1.clone(),
                    v1_1,
                    v2_1.clone(),
                    match &v38 {
