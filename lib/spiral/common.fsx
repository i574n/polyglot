...
and method4 (v0 : (unit -> unit)) : (unit -> unit) =
    v0
...
and closure8 () () : string =
    ...
    v0
and closure9 (v0 : int32, v1 : exn) () : struct (int32 * exn) =
    struct (v0, v1)
and method8 () : string =
...
and method15 (v0 : Mut4, v1 : int32) : unit =
    ...
    v0.l0 <- v12
    ()
and method16 (v0 : Mut4, v1 : exn) : unit =
    let v4 : string = $"%A{v1}"
    method13(v0, v4)
and method12 (v0 : Mut4, v1 : int32, v2 : exn) : unit =
    let v3 : string = "{ "
    method13(v0, v3)
    method14(v0)
    let v4 : string = "retry"
    ...
    let v8 : string = " }"
    method13(v0, v8)
and closure10 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (int32 * exn))) () : string =
    ...
    let struct (v1161 : int32, v1162 : exn) = v2 ()
    let v1163 : string = ""
    let v1164 : Mut4 = {l0 = v1163} : Mut4
    method12(v1164, v1161, v1162)
...
and method17 (v0 : US0, v1 : (unit -> string)) : unit =
    ...
    if v67 then
        ...
        v113 v72
and method7 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (int32 * exn))) : unit =
    let v3 : (unit -> string) = closure10(v0, v1, v2)
    method17(v0, v3)
and closure7 (v0 : int32) (v1 : exn) : US5 =
    let v2 : US0 = US0_3
    let v3 : (unit -> string) = closure8()
    let v4 : (unit -> struct (int32 * exn)) = closure9(v0, v1)
    method7(v2, v3, v4)
    US5_1
and method6 (v0 : int32, v1 : (unit -> unit), v2 : int32) : US4 =
    let v5 : (US4 -> US5) = closure5()
    let v6 : (unit -> US4) = closure6(v0, v1, v2)
    let v7 : (exn -> US5) = closure7(v2)
    let v8 : US5 = US5_1
    let result = ref v8
    try
        result.Value <- v6 () |> v5 
...
and closure4 (v0 : int32) (v1 : (unit -> unit)) : unit option =
    ...
    match v3 with
    | US4_1 -> (* None *)
        let v13 : unit option = None
        v13
    | US4_0 -> (* Some *)
        let v6 : unit option = Some () 
        v6
and closure3 () (v0 : int32) : ((unit -> unit) -> unit option) =
    closure4(v0)
and method18 (v0 : (unit -> unit)) : (unit -> unit) =
    v0
and closure12 (v0 : Lazy<unit>) () : unit =
    v0.Value
    ()
and closure11 () (v0 : (unit -> unit)) : (unit -> unit) =
    let v1 : (unit -> unit) = method18(v0)
    let v4 : Lazy<unit> = lazy v1 ()
    closure12(v4)
let v38 : (US0 -> struct (Mut0 * Mut1 * Mut2 * Mut3 * int64 option)) = closure0()
let v39 : US0 = US0_0
if State.trace_state.IsNone then State.trace_state <- v38 v39 |> Some
let v45 : ((unit -> unit) -> System.IDisposable) = closure2()
let new_disposable x = v45 x
let v46 : (int32 -> ((unit -> unit) -> unit option)) = closure3()
