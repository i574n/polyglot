...
and closure2 () (v0 : (unit -> unit)) : System.IDisposable =
...
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v2 : System.IDisposable = new Disposable (fun () -> Fable.Core.RustInterop.emitRustExpr v0 "$0()" )
    v2 
    #endif
#if FABLE_COMPILER_RUST && WASM
    ...
    #endif
#else
    let v7 : (unit -> unit) = method2(v0)
    let v8 : System.IDisposable = { new System.IDisposable with member _.Dispose () = v7 () }
    v8 
    #endif
    |> fun x -> _v1 <- Some x
    let v9 : System.IDisposable = match _v1 with Some x -> x | None -> failwith "base.run_target / _v1=None"
    v9
