...
def closure5(v0_1: US0, v1_1: Callable[[], str], v2: Callable[[], str], unit_var: None) -> str:
    ...
    _v80 = x_1
    return trim_end(trim_start(((((((((("" + v66) + " ") + value(_v80)) + " #") + str(v67)) + " ") + v1_1(None)) + " / ") + v2(None)) + ""), " ", "/")
...
def method4(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr149())) >= find(v13, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr150()))):
...
def closure3(v0_1: US0, v1_1: Callable[[], str]) -> Callable[[Callable[[], str]], None]:
    def _arrow151(v: Callable[[], str], v0_1: Any=v0_1, v1_1: Any=v1_1) -> None:
...
def closure2(unit_var: None, v0_1: US0) -> Callable[[Callable[[], str], Callable[[], str]], None]:
    def _arrow152(v: Callable[[], str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[Callable[[], str]], None]:
        return closure3(v0_1, v)

    return _arrow152


def _arrow153(__unit: None=None) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, None)


v0: Callable[[], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow153
...
def _arrow154(v: US0) -> Callable[[Callable[[], str], Callable[[], str]], None]:
    return closure2(None, v)


v1: Callable[[US0, Callable[[], str], Callable[[], str]], None] = _arrow154
