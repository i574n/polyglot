pub mod Sm {
    ...
    pub fn closure14(v0_1: i32, v1_1: i32) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            let v1_1 = v1_1.clone();
            move |v: string| Sm::closure15(v0_1, v1_1, v)
        })
    }
    pub fn closure13(unitVar: (), v0_1: i32) -> Func1<i32, Func1<string, string>> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: i32| Sm::closure14(v0_1, v)
        })
    }
    pub fn closure17(v0_1: string, v1_1: string) -> Array<string> {
        split_1(v1_1, v0_1, -1_i32, 0_i32)
    }
    pub fn closure16(unitVar: (), v0_1: string) -> Func1<string, Array<string>> {
        Func1::new({
            let v0_1 = v0_1.clone();
    ...
    pub fn closure19(v0_1: Array<string>, v1_1: string) -> Array<string> {
    ...
    pub fn closure18(unitVar: (), v0_1: Array<string>) -> Func1<string, Array<string>> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure19(v0_1.clone(), v)
        })
    }
    pub fn closure21(v0_1: string, v1_1: string) -> bool {
        startsWith(v1_1, v0_1, false)
    }
    pub fn closure20(unitVar: (), v0_1: string) -> Func1<string, bool> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure21(v0_1.clone(), v)
        })
    }
    pub fn closure24(v0_1: i32, v1_1: i32, v2_1: string) -> string {
        substring2(v2_1, v0_1, v1_1)
    }
    pub fn closure23(v0_1: i32, v1_1: i32) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            let v1_1 = v1_1.clone();
            move |v: string| Sm::closure24(v0_1, v1_1, v)
        })
    }
    pub fn closure22(unitVar: (), v0_1: i32) -> Func1<i32, Func1<string, string>> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: i32| Sm::closure23(v0_1, v)
        })
    }
    pub fn closure25(unitVar: (), v0_1: string) -> string {
        toLower(v0_1)
    }
    pub fn closure26(unitVar: (), v0_1: string) -> string {
        toUpper(v0_1)
    }
    pub fn closure27(unitVar: (), v0_1: string) -> string {
        trim_1(v0_1)
    }
    pub fn closure29(v0_1: Array<char>, v1_1: string) -> string {
        trimEndChars(v1_1, v0_1)
    }
    pub fn closure28(unitVar: (), v0_1: Array<char>) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure29(v0_1.clone(), v)
        })
    }
    pub fn closure31(v0_1: Array<char>, v1_1: string) -> string {
        trimStartChars(v1_1, v0_1)
    }
    pub fn closure30(unitVar: (), v0_1: Array<char>) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure31(v0_1.clone(), v)
        })
    }
    pub fn closure33(v0_1: i32, v1_1: string) -> string {
    ...
    pub fn closure32(unitVar: (), v0_1: i32) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure33(v0_1, v)
        })
    }
    pub fn closure35(v0_1: i64, v1_1: string) -> string {
    ...
    pub fn closure34(unitVar: (), v0_1: i64) -> Func1<string, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: string| Sm::closure35(v0_1, v)
        })
    }
    pub fn closure36(unitVar: (), v0_1: LrcPtr<Exception>) -> string {
    ...
    pub fn closure38(v0_1: string, v1_1: Array<string>) -> string {
    ...
    pub fn closure37(unitVar: (), v0_1: string) -> Func1<Array<string>, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: Array<string>| Sm::closure38(v0_1.clone(), v)
        })
    }
    pub fn method2(v0_1: string) -> string {
        v0_1
    }
    pub fn closure40(v0_1: string, v1_1: LrcPtr<dyn IEnumerable_1<string>>) -> string {
    ...
    pub fn closure39(
        ...
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: LrcPtr<dyn IEnumerable_1<string>>| Sm::closure40(v0_1.clone(), v)
        })
    }
    pub fn closure42(v0_1: string, v1_1: Array<string>) -> string {
        join(v0_1, v1_1)
    }
    pub fn closure41(unitVar: (), v0_1: string) -> Func1<Array<string>, string> {
        Func1::new({
            let v0_1 = v0_1.clone();
            move |v: Array<string>| Sm::closure42(v0_1.clone(), v)
        })
    }
    pub fn method3(v0_1: i32, v1_1: LrcPtr<Sm::Mut1>) -> bool {
        v1_1.l0.get().clone() < v0_1
    }
    pub fn closure43(unitVar: (), v0_1: string) -> Array<char> {
    ...
    pub fn v5() -> Func1<i32, Func1<i32, Func1<string, string>>> {
        ...
        v5.get_or_init(|| Func1::new(move |v: i32| Sm::closure13((), v)))
            .clone()
    }
    ...
    pub fn v6() -> Func1<string, Func1<string, Array<string>>> {
        ...
        v6.get_or_init(|| Func1::new(move |v: string| Sm::closure16((), v)))
            .clone()
    }
    ...
    pub fn v7() -> Func1<Array<string>, Func1<string, Array<string>>> {
        ...
        v7.get_or_init(|| Func1::new(move |v: Array<string>| Sm::closure18((), v)))
            .clone()
    }
    ...
    pub fn v8() -> Func1<string, Func1<string, bool>> {
        ...
        v8.get_or_init(|| Func1::new(move |v: string| Sm::closure20((), v)))
            .clone()
    }
    ...
    pub fn v9() -> Func1<i32, Func1<i32, Func1<string, string>>> {
        ...
        v9.get_or_init(|| Func1::new(move |v: i32| Sm::closure22((), v)))
            .clone()
    }
    ...
    pub fn v10() -> Func1<string, string> {
        ...
        v10.get_or_init(|| Func1::new(move |v: string| Sm::closure25((), v)))
            .clone()
    }
    ...
    pub fn v11() -> Func1<string, string> {
        ...
        v11.get_or_init(|| Func1::new(move |v: string| Sm::closure26((), v)))
            .clone()
    }
    ...
    pub fn v12() -> Func1<string, string> {
        ...
        v12.get_or_init(|| Func1::new(move |v: string| Sm::closure27((), v)))
            .clone()
    }
    ...
    pub fn v13() -> Func1<Array<char>, Func1<string, string>> {
        ...
        v13.get_or_init(|| Func1::new(move |v: Array<char>| Sm::closure28((), v)))
            .clone()
    }
    ...
    pub fn v14() -> Func1<Array<char>, Func1<string, string>> {
        ...
        v14.get_or_init(|| Func1::new(move |v: Array<char>| Sm::closure30((), v)))
            .clone()
    }
    ...
    pub fn v15() -> Func1<i32, Func1<string, string>> {
        ...
        v15.get_or_init(|| Func1::new(move |v: i32| Sm::closure32((), v)))
            .clone()
    }
    ...
    pub fn v16() -> Func1<i64, Func1<string, string>> {
        ...
        v16.get_or_init(|| Func1::new(move |v: i64| Sm::closure34((), v)))
            .clone()
    }
    ...
    pub fn v17() -> Func1<LrcPtr<Exception>, string> {
        ...
        v17.get_or_init(|| Func1::new(move |v: LrcPtr<Exception>| Sm::closure36((), v)))
            .clone()
    }
    ...
    pub fn v18() -> Func1<string, Func1<Array<string>, string>> {
        ...
        v18.get_or_init(|| Func1::new(move |v: string| Sm::closure37((), v)))
            .clone()
    }
    ...
    pub fn v19() -> Func1<string, Func1<LrcPtr<dyn IEnumerable_1<string>>, string>> {
        static v19: OnceInit<Func1<string, Func1<LrcPtr<dyn IEnumerable_1<string>>, string>>> =
            OnceInit::new();
        v19.get_or_init(|| Func1::new(move |v: string| Sm::closure39((), v)))
            .clone()
    }
    ...
    pub fn v20() -> Func1<string, Func1<Array<string>, string>> {
        ...
        v20.get_or_init(|| Func1::new(move |v: string| Sm::closure41((), v)))
            .clone()
    }
    ...
    pub fn v21() -> Func1<string, Array<char>> {
        ...
        v21.get_or_init(|| Func1::new(move |v: string| Sm::closure43((), v)))
            .clone()
    }
