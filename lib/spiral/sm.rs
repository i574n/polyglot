pub mod Sm {
    ...
    pub fn closure15(v0_1: string, v1_1: string, v2_1: string) -> string {
        ...
        let v5_1: string = Sm::method1(v2_1);
        let v7_1: Result<regex::Regex, regex::Error> = regex::Regex::new(&v0_1);
        let v9_1: regex::Regex = v7_1.unwrap();
        let v11_1: std::borrow::Cow<str> = v9_1.replace_all(&v5_1, &*v3_1);
        let v13_1: std::string::String = String::from(v11_1);
        {
            let x: string = fable_library_rust::String_::fromString(v13_1);
            _v4.set(Some(x))
        }
        match &_v4.get().clone() {
    ...
    pub fn closure22(v0_1: Array<string>, v1_1: string) -> Array<string> {
        ...
        {
            let x: Array<string> = split_1(v1_1, join(Sm::method3(), toArray(v4_1)), -1_i32, 0_i32);
            _v2.set(Some(x))
        }
        match &_v2.get().clone() {
    ...
    pub fn closure31(unitVar: (), v0_1: Array<char>) -> Func1<string, string> {
        let v2_1: List<char> = ofArray_1(v0_1);
        let v8_1: LrcPtr<Sm::UH0> = foldBack(
        ...
        Func1::new({
            let v8_1 = v8_1.clone();
            move |v: string| Sm::closure34(v8_1.clone(), v)
        })
    }
    ...
    pub fn closure35(unitVar: (), v0_1: Array<char>) -> Func1<string, string> {
        ...
        Func1::new({
            let v8_1 = v8_1.clone();
            move |v: string| Sm::closure36(v8_1.clone(), v)
        })
    }
