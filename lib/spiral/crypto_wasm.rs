            ...
            }
            {
                ...
                if if (patternInput_3.2.clone()).l0.get().clone() == false {
                    ...
                    }
                    {
                        ...
                        let _v162: LrcPtr<MutCell<Option<Crypto::US3>>> =
                        ...
                        {
                            let v177: Crypto::US3 =
                                defaultValue(Crypto::US3::US3_1, _v162.get().clone());
                            let v217: DateTime = match &v177 {
                                Crypto::US3::US3_0(v177_0_0) => {
                                    let v191: TimeSpan = TimeSpan::new_ticks(
                                        {
                            ...
                            let v222: string = {
                                ...
                                v217.toString(provider)
                            };
                            let v521: string = padLeft(toLower(string("Verbose")), 7_i32, ' ');
                            let v548: &str = inline_colorization::color_bright_black;
                            let v550: &str = &*v521;
                            let v552: &str = inline_colorization::color_reset;
                            let v554: string = string("format!(\"{v548}{v550}{v552}\")");
                            let v555: std::string::String = format!("{v548}{v550}{v552}");
                            let v557: string = fable_library_rust::String_::fromString(v555);
