pub mod Crypto {
    ...
    pub fn closure2(v0_1: i32, v1_1: string, v2: u16, unitVar: ()) {
        ...
        if if (patternInput_1.2.clone()).l0.get().clone() == false {
            ...
            let _v137: LrcPtr<MutCell<Option<Crypto::US3>>> = refCell(None::<Crypto::US3>);
            let v142: () = {
                Crypto::closure9(
                    patternInput_2.4.clone(),
                    Func1::new({
                        let _v137 = _v137.clone();
                        move |v: Option<Crypto::US3>| Crypto::closure8(_v137.clone(), v)
                    }),
                    (),
                );
                ()
            };
            let v155: Crypto::US3 = defaultValue(Crypto::US3::US3_1, _v137.get().clone());
            let v195: DateTime = match &v155 {
                Crypto::US3::US3_0(v155_0_0) => {
            ...
            let v541: &str = inline_colorization::color_bright_black;
            let v543: &str = &*v514;
