pub mod Crypto {
    ...
    pub fn closure5(
        ...
        }
        {
            ...
            let _v38: LrcPtr<MutCell<Option<Crypto::US1>>> = refCell(None::<Crypto::US1>);
            {
            ...
            {
                let v43: Crypto::US1 = defaultValue(Crypto::US1::US1_1, _v38.get().clone());
