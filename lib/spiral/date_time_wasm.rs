pub mod Date_time {
    ...
    pub fn method0(v0_1: Guid, v1_1: DateTime) -> Guid {
        ...
        let _v188: LrcPtr<MutCell<Option<Date_time::US0>>> = refCell(None::<Date_time::US0>);
        {
            let x_2: Option<Date_time::US0> = match &v187 {
        ...
        {
            let v203: Date_time::US0 = defaultValue(Date_time::US0::US0_1, _v188.get().clone());
            let v223: Date_time::US1 = match &v203 {
                Date_time::US0::US0_0(v203_0_0) => {
            ...
            let v227: string = match &v223 {
                Date_time::US1::US1_0(v223_0_0) => match &v223 {
            ...
            let v306: string = Date_time::method1();
