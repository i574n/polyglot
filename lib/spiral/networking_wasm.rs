pub mod Networking {
    ...
    pub fn closure6(
        ...
        }
        {
            ...
            let _v39: LrcPtr<MutCell<Option<Networking::US2>>> = refCell(None::<Networking::US2>);
            {
            ...
            {
                let v44: Networking::US2 = defaultValue(Networking::US2::US2_1, _v39.get().clone());
                let v63: DateTime = match &v44 {
                    Networking::US2::US2_0(v44_0_0) => {
