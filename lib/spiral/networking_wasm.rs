pub mod Networking {
    ...
    pub fn closure6(
        ...
        }
        {
            ...
            let _v39: LrcPtr<MutCell<Option<Networking::US1>>> = refCell(None::<Networking::US1>);
            {
            ...
            {
                let v44: Networking::US1 = defaultValue(Networking::US1::US1_1, _v39.get().clone());
                let v63: DateTime = match &v44 {
                    Networking::US1::US1_0(v44_0_0) => {
