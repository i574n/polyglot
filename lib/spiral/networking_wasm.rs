pub mod Networking {
    ...
    pub fn method1(v0: string) -> string {
        ...
        let v31: string = Networking::method2();
        {
    ...
    pub fn closure6(
        ...
        }
        {
            ...
            let _v185: LrcPtr<MutCell<Option<Networking::US2>>> = refCell(None::<Networking::US2>);
            {
            ...
            {
                let v212: Networking::US2 =
                    defaultValue(Networking::US2::US2_1, _v185.get().clone());
                let v310: DateTime = match &v212 {
                    Networking::US2::US2_0(v212_0_0) => {
