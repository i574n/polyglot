...
def closure5(unit_var: None, v0_1: str) -> Callable[[UH0], UH0]:
    def _arrow115(v: UH0, unit_var: Any=unit_var, v0_1: Any=v0_1) -> UH0:
...
def method3(__unit: None=None) -> Callable[[str, UH0], UH0]:
    def _arrow116(v: str) -> Callable[[UH0], UH0]:
...
def method10(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr120())) >= find(v13, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr121()))):
...
def method11(__unit: None=None) -> Callable[[Callable[[tuple[bool, str, int]], Async[None]]], US6]:
    def _arrow122(v: Callable[[tuple[bool, str, int]], Async[None]]) -> US6:
...
def method12(__unit: None=None) -> Callable[[CancellationToken], US7]:
    def _arrow123(v: CancellationToken) -> US7:
...
def _arrow124(__unit: None=None) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, None)


v0: Callable[[], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow124
...
def _arrow125(__unit: None=None) -> bool:
    return closure2(None, None)


v1: Callable[[], bool] = _arrow125
...
v2: Callable[[], str] = _arrow126

def get_executable_suffix(__unit: None=None) -> str:
    return v2(None)


def _arrow127(v: str) -> Async[tuple[int, str]]:
    return closure4(None, v)


v3: Callable[[str], Async[tuple[int, str]]] = _arrow127

def execute_async(x: str) -> Async[tuple[int, str]]:
    return v3(x)


def _arrow128(_arg10: tuple[CancellationToken | None, str, Callable[[tuple[bool, str, int]], Async[None]] | None, str | None]) -> Async[tuple[int, str]]:
    return closure20(None, _arg10)


v4: Callable[[tuple[CancellationToken | None, str, Callable[[tuple[bool, str, int]], Async[None]] | None, str | None]], Async[tuple[int, str]]] = _arrow128
