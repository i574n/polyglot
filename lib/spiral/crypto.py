...
def method4(v0_1: US0) -> tuple[Mut1, Mut2, Mut3, Mut4, Mut5, int64 | None]:
    ...
    def _arrow57(__unit: None=None, v0_1: Any=v0_1) -> US2:
    ...
    _v1: tuple[US2, US3] = (US2(0, v235.fields[0]) if (v235.tag == 0) else _arrow57(), US3(0, ticks_1(now())) if (method6(method9()) == "True") else US3(1))
    v352: US3 = _v1[1]
    v351: US2 = _v1[0]
...
def method10(v0_1: Mut1, v1_1: Mut2, v2: Mut3, v3: Mut4, v4: Mut5, v5: int64 | None=None) -> str:
    ...
    def _arrow63(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2: Any=v2, v3: Any=v3, v4: Any=v4, v5: Any=v5) -> Any:
    ...
    return to_string(_arrow63() if (v238.tag == 0) else now(), method13())
...
def closure2(v0_1: int, v1_1: str, v2: uint16, unit_var: None) -> None:
    ...
    if False if (pattern_input[2].l0 == False) else (0 >= find(v37, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr87()))):
        v44: None
        v4(None)
        v44 = None
...
def _arrow93(v: str) -> str:
    return closure0(None, v)


v0: Callable[[str], str] = _arrow93
