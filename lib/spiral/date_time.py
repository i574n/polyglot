...
def method0(__unit: None=None) -> Callable[[chrono_DateTime_1[chrono_Utc]], US0]:
    def _arrow78(v: chrono_DateTime_1[chrono_Utc]) -> US0:
...
def closure0(unit_var: None, v0_1: str) -> Callable[[Any], str]:
    def _arrow79(v: Any, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure5(v0_1: str, v1_1: str) -> Callable[[str], str]:
    def _arrow80(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> str:
...
def closure4(unit_var: None, v0_1: str) -> Callable[[str, str], str]:
    def _arrow81(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Callable[[str], str]:
...
def method5(__unit: None=None) -> Callable[[str, str, str], str]:
    def _arrow82(v: str) -> Callable[[str, str], str]:
...
def closure7(unit_var: None, v0_1: str) -> Callable[[int64], str]:
    def _arrow83(v: int64, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure12(unit_var: None, v0_1: str) -> Callable[[Any], str]:
    def _arrow84(v: Any, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, Any], str] = _arrow85

def date_time_guid_from_date_time(x: str) -> Callable[[Any], str]:
    return v0(x)


def _arrow86(v: str) -> Any:
    return closure3(None, v)


v1: Callable[[str], Any] = _arrow86

def date_time_from_guid(x: str) -> Any:
    return v1(x)


def _arrow87(v: str) -> Callable[[int64], str]:
    return closure7(None, v)


v2: Callable[[str, int64], str] = _arrow87

def timestamp_guid_from_timestamp(x: str) -> Callable[[int64], str]:
    return v2(x)


def _arrow88(v: str) -> int64:
    return closure9(None, v)


v3: Callable[[str], int64] = _arrow88

def timestamp_from_guid(x: str) -> int64:
    return v3(x)


def _arrow89(v: Any) -> str:
    return closure10(None, v)


v4: Callable[[Any], str] = _arrow89

def new_guid_from_date_time(x: Any) -> str:
    return v4(x)


def _arrow90(v: int64) -> str:
    return closure11(None, v)


v5: Callable[[int64], str] = _arrow90

def new_guid_from_timestamp(x: int64) -> str:
    return v5(x)


def _arrow91(v: str) -> Callable[[Any], str]:
    return closure12(None, v)


v6: Callable[[str, Any], str] = _arrow91

def format(x: str) -> Callable[[Any], str]:
    return v6(x)


def _arrow92(v: Any) -> str:
    return closure14(None, v)


v7: Callable[[Any], str] = _arrow92
