...
def method1(__unit: None=None) -> Callable[[chrono_date_time_1[chrono_utc]], US0]:
    def _arrow105(v: chrono_date_time_1[chrono_utc]) -> US0:
...
def _arrow114(v: str) -> Any:
    return closure3(None, v)


v1: Callable[[str], Any] = _arrow114
