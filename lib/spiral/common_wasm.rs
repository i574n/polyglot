pub mod Common {
    ...
    pub fn closure10(
        ...
        }
        {
            ...
            let _v39: LrcPtr<MutCell<Option<Common::US2>>> = refCell(None::<Common::US2>);
            {
            ...
            {
                let v44: Common::US2 = defaultValue(Common::US2::US2_1, _v39.get().clone());
                let v63: DateTime = match &v44 {
                    Common::US2::US2_0(v44_0_0) => {
