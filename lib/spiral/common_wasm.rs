pub mod Common {
    ...
    pub fn closure10(
        ...
        }
        {
            ...
            let _v185: LrcPtr<MutCell<Option<Common::US2>>> = refCell(None::<Common::US2>);
            {
            ...
            {
                let v212: Common::US2 = defaultValue(Common::US2::US2_1, _v185.get().clone());
