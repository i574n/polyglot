pub mod Common {
    ...
    pub fn method0(
        ...
        let _v1: (Common::US1, Common::US2) = (Common::US1::US1_1, Common::US2::US2_1);
    ...
    pub fn method9(
        ...
        let v140: Common::US2 = defaultValue(Common::US2::US2_1, map(Common::method10(), v5));
        let v236: DateTime = match &v140 {
            Common::US2::US2_0(v140_0_0) => {
