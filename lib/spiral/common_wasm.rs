pub mod Common {
    ...
    pub fn closure11(
        ...
        }
        {
            ...
            let _v39: LrcPtr<MutCell<Option<Common::US1>>> = refCell(None::<Common::US1>);
            {
            ...
            {
                let v44: Common::US1 = defaultValue(Common::US1::US1_1, _v39.get().clone());
                let v63: DateTime = match &v44 {
                    Common::US1::US1_0(v44_0_0) => {
