...
def method0(__unit: None=None) -> Callable[[CancellationToken], US0]:
    def _arrow21(v: CancellationToken) -> US0:
...
def _arrow26(v: CancellationToken | None=None) -> tuple[CancellationToken, IDisposable]:
    return closure0(None, v)


v0: Callable[[CancellationToken | None], tuple[CancellationToken, IDisposable]] = _arrow26
