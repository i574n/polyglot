...
and closure10 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * int64 * string))) () : string =
    ...
    let v1141 : string = match _v1029 with Some x -> x | None -> failwith "base.run_target / _v1029=None"
    let v1160 : int64 = v14.l0
    let struct (v1161 : string, v1162 : int64, v1163 : string) = v2 ()
    let v1164 : string = ""
    let v1165 : Mut4 = {l0 = v1164} : Mut4
    method20(v1165, v1161, v1162, v1163)
...
and method18 (v0 : string, v1 : US8, v2 : US7, v3 : int64) : Async<int64> =
    ...
    let v273 : Async<int64> = method18(v0, v1, v2, v272)
    return! v273 
    (*
    let v274 : int64 = *)
    }
...
and closure7 (v0 : US6) (v1 : string) : Async<int64> =
    ...
    let struct (v56 : US7, v57 : US8) =
        ...
        | US6_0(v50, v51) -> (* Some *)
            struct (v50, v51)
    let v58 : int64 = 0L
    let v59 : Async<int64> = method18(v1, v57, v56, v58)
    v59 
    #endif
    |> fun x -> _v4 <- Some x
...
and method22 (v0 : string, v1 : int64) : Async<int64> =
    ...
    let v257 : Async<int64> = method22(v0, v256)
    return! v257 
    (*
    let v258 : int64 = *)
    }
...
#else
    let v49 : int64 = 0L
    let v50 : Async<int64> = method22(v0, v49)
    v50 
    #endif
    |> fun x -> _v3 <- Some x
    let v51 : Async<int64> = match _v3 with Some x -> x | None -> failwith "base.run_target / _v3=None"
...
and method23 (v0 : string, v1 : string) : bool =
    ...
    let v129 : bool =
        if v6 then
            ...
            let v69 : Vec<uint8> = method25(v54)
...
and method26 (v0 : string, v1 : int64) : Async<int64> =
    ...
    let v162 : Async<int64> = method26(v0, v161)
    return! v162 
    (*
    let v163 : int64 = *)
    }
...
#else
    let v49 : int64 = 0L
    let v50 : Async<int64> = method26(v0, v49)
    v50 
    #endif
    |> fun x -> _v3 <- Some x
    let v51 : Async<int64> = match _v3 with Some x -> x | None -> failwith "base.run_target / _v3=None"
...
and closure27 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * string * exn))) () : string =
    ...
    let v1141 : string = match _v1029 with Some x -> x | None -> failwith "base.run_target / _v1029=None"
    let v1160 : int64 = v14.l0
    let struct (v1161 : string, v1162 : string, v1163 : exn) = v2 ()
    let v1164 : string = ""
    let v1165 : Mut4 = {l0 = v1164} : Mut4
    method31(v1165, v1161, v1162, v1163)
    let v1166 : string = v1165.l0
    let v1169 : string = $"{v772} {v1141} #{v1160} %s{v1 ()} / {v1166}"
    let v1176 : char list = []
    let v1181 : (char list -> (char [])) = List.toArray
...
and method29 (v0 : string, v1 : string, v2 : int64) : Async<int64> =
    ...
    let v167 : Async<int64> = method29(v0, v1, v166)
    return! v167 
    (*
    *)
    }
...
#else
    let v50 : int64 = 0L
    let v51 : Async<int64> = method29(v0, v1, v50)
    v51 
    #endif
    |> fun x -> _v4 <- Some x
...
and closure39 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (int64 * string))) () : string =
    ...
    let v1141 : string = match _v1029 with Some x -> x | None -> failwith "base.run_target / _v1029=None"
    let v1160 : int64 = v14.l0
    let struct (v1161 : int64, v1162 : string) = v2 ()
    let v1163 : string = ""
    let v1164 : Mut4 = {l0 = v1163} : Mut4
    method40(v1164, v1161, v1162)
    let v1165 : string = v1164.l0
    let v1168 : string = $"{v772} {v1141} #{v1160} %s{v1 ()} / {v1165}"
    let v1175 : char list = []
    let v1180 : (char list -> (char [])) = List.toArray
...
and method33 (v0 : string, v1 : int64) : Async<string option> =
...
#else
        let v100 : int64 = 0L
        let v101 : Async<int64> = method22(v0, v100)
        v101 
        #endif
        |> fun x -> _v54 <- Some x
    ...
    if v950 then
        ...
        *) else
        ...
        let v1020 : Async<string option> = method33(v0, v1019)
        return! v1020 
        (*
        ()
    *)
...
#else
    let v49 : int64 = 0L
    let v50 : Async<string option> = method33(v0, v49)
    v50 
    #endif
    |> fun x -> _v3 <- Some x
...
and method51 (v0 : string) : string =
    v0
and method50 (v0 : string, v1 : string) : struct (string * string) =
...
and method49 (v0 : string, v1 : string) : string =
    ...
    let struct (v87 : string, v88 : string) = method50(v1, v0)
...
and method52 () : string =
...
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v3 : string = method53()
    let v4 : string = method1(v3)
    v4 
    #endif
#if FABLE_COMPILER_RUST && WASM
    let v5 : string = method53()
    let v6 : string = method1(v5)
    v6 
    #endif
#if FABLE_COMPILER_RUST && CONTRACT
    let v7 : string = method53()
    ...
    v18
and method46 (v0 : System.Guid) : string =
    let v3 : bool = true
    let mutable _v3 : string option = None 
...
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v4 : string = method47()
    let v5 : string = method48()
    let v6 : string = method49(v4, v5)
    let v7 : string = method52()
    let v8 : string = method49(v6, v7)
    let v11 : (System.Guid -> string) = _.ToString()
    let v12 : string = v11 v0
    let v19 : string = method49(v8, v12)
    v19 
    #endif
#if FABLE_COMPILER_RUST && WASM
    let v20 : string = method47()
    let v21 : string = method48()
    let v22 : string = method49(v20, v21)
    let v23 : string = method52()
    let v24 : string = method49(v22, v23)
    let v27 : (System.Guid -> string) = _.ToString()
    let v28 : string = v27 v0
    let v35 : string = method49(v24, v28)
    v35 
    #endif
#if FABLE_COMPILER_RUST && CONTRACT
    ...
    #endif
#if FABLE_COMPILER_TYPESCRIPT
    let v45 : string = method47()
    let v46 : string = method48()
    let v47 : string = method49(v45, v46)
    let v48 : string = method52()
    let v49 : string = method49(v47, v48)
    let v52 : (System.Guid -> string) = _.ToString()
    let v53 : string = v52 v0
    let v60 : string = method49(v49, v53)
    v60 
    #endif
#if FABLE_COMPILER_PYTHON
    let v61 : string = method47()
    let v62 : string = method48()
    let v63 : string = method49(v61, v62)
    let v64 : string = method52()
    let v65 : string = method49(v63, v64)
    let v68 : (System.Guid -> string) = _.ToString()
    let v69 : string = v68 v0
    let v76 : string = method49(v65, v69)
    v76 
    #endif
#else
    let v77 : string = method47()
    let v78 : string = method48()
    let v79 : string = method49(v77, v78)
    let v80 : string = method52()
    let v81 : string = method49(v79, v80)
    let v84 : (System.Guid -> string) = _.ToString()
    let v85 : string = v84 v0
    let v92 : string = method49(v81, v85)
    v92 
    #endif
    |> fun x -> _v3 <- Some x
...
and method41 () : string =
    ...
    let v22 : System.Guid = method42(v15, v5)
    let v23 : string = method46(v22)
    v23 
    #endif
#if FABLE_COMPILER_RUST && WASM
    ...
    let v43 : System.Guid = method42(v36, v26)
    let v44 : string = method46(v43)
    v44 
    #endif
#if FABLE_COMPILER_RUST && CONTRACT
    ...
    let v73 : System.Guid = method42(v66, v56)
    let v74 : string = method46(v73)
    v74 
    #endif
#if FABLE_COMPILER_PYTHON
    ...
    let v94 : System.Guid = method42(v87, v77)
    let v95 : string = method46(v94)
    v95 
    #endif
#else
    ...
    let v115 : System.Guid = method42(v108, v98)
    let v116 : string = method46(v115)
    v116 
    #endif
    |> fun x -> _v2 <- Some x
...
and closure42 () (v0 : std_io_Error) : std_string_String =
    ...
    v37
and method56 () : (std_io_Error -> std_string_String) =
    closure42()
and closure43 () () : US12 =
    US12_0
...
and closure46 (v0 : string, v1 : std_string_String) () : struct (string * std_string_String) =
    struct (v0, v1)
and method59 (v0 : Mut4, v1 : std_string_String) : unit =
    let v4 : string = $"%A{v1}"
    method15(v0, v4)
and method58 (v0 : Mut4, v1 : string, v2 : std_string_String) : unit =
    let v3 : string = "{ "
    method15(v0, v3)
    method16(v0)
    let v4 : string = "dir"
...
and closure47 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * std_string_String))) () : string =
    ...
    let v1258 : string = v1188.TrimEnd v1251 
    v1258
and method57 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * std_string_String))) : unit =
...
and closure49 (v0 : string) () : string =
    v0
and method61 (v0 : Mut4, v1 : string) : unit =
    let v2 : string = "{ "
    method15(v0, v2)
    method16(v0)
    let v3 : string = "dir"
...
and closure50 (v0 : US0, v1 : (unit -> string), v2 : (unit -> string)) () : string =
    ...
    let v1257 : string = v1187.TrimEnd v1250 
    v1257
and method60 (v0 : US0, v1 : (unit -> string), v2 : (unit -> string)) : unit =
...
and closure53 (v0 : string, v1 : string) () : struct (string * string) =
    struct (v0, v1)
and method65 (v0 : Mut4, v1 : string, v2 : string) : unit =
    let v3 : string = "{ "
    method15(v0, v3)
    method16(v0)
    let v4 : string = "dir"
...
and closure54 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * string))) () : string =
    ...
    let v1258 : string = v1188.TrimEnd v1251 
    v1258
and method64 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (string * string))) : unit =
...
and method66 (v0 : string) : (unit -> unit) =
    closure55(v0)
and method67 (v0 : string) : (unit -> unit) =
    closure55(v0)
and method54 (v0 : string) : System.IDisposable =
    let v3 : bool = true
    ...
    let v7 : (std_io_Error -> std_string_String) = method56()
...
and closure41 () () : struct (string * System.IDisposable) =
    ...
    let v1 : System.IDisposable = method54(v0)
    struct (v0, v1)
and method68 (v0 : string) : System.Guid =
    let v3 : bool = true
...
and closure56 () (v0 : string) : struct (string * System.IDisposable) =
    let v1 : System.Guid = method68(v0)
    let v2 : string = method46(v1)
    let v3 : System.IDisposable = method54(v2)
    struct (v2, v3)
...
and closure59 () (v0 : string) : string =
    ...
    v63
and method75 (v0 : string) : string option =
    let v3 : bool = true
...
and closure61 () (v0 : string) : string option =
    method75(v0)
and method74 () : (string -> string option) =
    closure61()
and method76 (v0 : string, v1 : string, v2 : string) : US13 =
    let v3 : string = method49(v2, v0)
    let v4 : bool = method7(v3)
    if v4 then
        US13_0(v2)
    else
        let v6 : (string -> string option) = method74()
        ...
        | US3_0(v45) -> (* Some *)
            method76(v0, v1, v45)
and method73 (v0 : string, v1 : string) : US13 =
    let v2 : string = method49(v1, v0)
    let v3 : bool = method7(v2)
    if v3 then
        US13_0(v1)
    else
        let v5 : (string -> string option) = method74()
...
and closure63 (v0 : string) () : string =
    v0
and method78 (v0 : Mut4, v1 : string) : unit =
    let v2 : string = "{ "
    method15(v0, v2)
    method16(v0)
    let v3 : string = "error"
...
and closure64 (v0 : US0, v1 : (unit -> string), v2 : (unit -> string)) () : string =
    ...
    let v1257 : string = v1187.TrimEnd v1250 
    v1257
and method77 (v0 : US0, v1 : (unit -> string), v2 : (unit -> string)) : unit =
...
and closure60 () () : string =
    ...
    let v3 : string = method49(v1, v2)
    let v4 : US13 = method73(v3, v0)
    let v13 : US3 =
        match v4 with
        | US13_1(v7) -> (* Error *)
            let v8 : US0 = US0_3
    ...
    let v29 : US3 =
        match v13 with
        | US3_1 -> (* None *)
            let v16 : string = method79()
            let v17 : string = method49(v1, v2)
            let v18 : US13 = method73(v17, v16)
            match v18 with
            | US13_1(v21) -> (* Error *)
                let v22 : US0 = US0_3
                let v23 : (unit -> string) = closure62()
                let v24 : (unit -> string) = closure63(v21)
                method77(v22, v23, v24)
                US3_1
            | US13_0(v19) -> (* Ok *)
                US3_0(v19)
        | US3_0(v14) -> (* Some *)
...
and method80 (v0 : string) : unit =
    ...
    let v55 : US3 =
        match v39 with
        | US3_1 -> (* None *)
            let v42 : string = method79()
            let v43 : string = method49(v27, v28)
            let v44 : US13 = method73(v43, v42)
            match v44 with
            | US13_1(v47) -> (* Error *)
                let v48 : US0 = US0_3
                let v49 : (unit -> string) = closure62()
                let v50 : (unit -> string) = closure63(v47)
                method77(v48, v49, v50)
                US3_1
            | US13_0(v45) -> (* Ok *)
                US3_0(v45)
        | US3_0(v40) -> (* Some *)
    ...
    let v59 : string =
        ...
        | US3_0(v56) -> (* Some *)
            v56
    let v60 : string = method49(v59, v27)
    let v61 : string = "target/trace"
    let v62 : string = method49(v60, v61)
    let v65 : bool = true
    ...
    let v128 : string = method49(v62, v25)
    let v131 : bool = true
