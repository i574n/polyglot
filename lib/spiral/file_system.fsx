...
and method2 (v0 : string, v1 : int64) : Async<int64> =
    ...
    #if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v10 : string = "std::fs::remove_dir_all(&*$0).unwrap()"
    ...
    #endif
        #if FABLE_COMPILER_PYTHON
        let v21 : string = $"%A{v11}"
        v21
    #endif
        |> fun x -> _v14 <- Some x
        let v22 : string = _v14.Value
        let v23 : US0 = US0_1
        let v24 : (unit -> string) = closure3()
        let v25 : (unit -> string) = closure4(v0, v22)
        method3(v23, v24, v25)
    ...
    do! v35 
    let v36 : int64 = v1 + 1L
    let v37 : Async<int64> = method2(v0, v36)
    return! v37 
    (*
    let v38 : int64 = *)
    }
    ...
    #endif
    #if FABLE_COMPILER_PYTHON
    let v41 : Async<int64> = null |> unbox<Async<int64>>
    v41
    #endif
    |> fun x -> _v2 <- Some x
...
and closure37 () (v0 : chrono_DateTime<chrono_Utc>) : US8 =
    US8_0(v0)
and method16 () : (chrono_DateTime<chrono_Utc> -> US8) =
    closure37()
and method17 (v0 : chrono_DateTime<chrono_Utc>) : chrono_DateTime<chrono_Utc> =
    v0
and method18 (v0 : chrono_DateTime<chrono_Local>) : chrono_DateTime<chrono_Local> =
    v0
and method19 () : string =
...
and closure36 () () : string =
    ...
    let v77 : string = method14(v38)
    let v78 : string = method15(v39)
    ...
    let v104 : (chrono_DateTime<chrono_Utc> -> US8) = method16()
    let v105 : US8 = US8_1
    ...
    let v125 : US9 =
        ...
        | US8_1 -> (* None *)
            US9_1
        | US8_0(v107) -> (* Some *)
            let v108 : chrono_DateTime<chrono_Utc> = method17(v107)
            ...
            let v116 : chrono_DateTime<chrono_Local> = method18(v112)
    ...
    let v261 : string = method14(v82)
    let v262 : string = method15(v224)
    ...
    let v343 : string = method14(v305)
    let v344 : string = method15(v306)
    ...
    let v370 : (chrono_DateTime<chrono_Utc> -> US8) = method16()
    let v371 : US8 = US8_1
    ...
    let v391 : US9 =
        ...
        | US8_1 -> (* None *)
            US9_1
        | US8_0(v373) -> (* Some *)
            let v374 : chrono_DateTime<chrono_Utc> = method17(v373)
            ...
            let v382 : chrono_DateTime<chrono_Local> = method18(v378)
    ...
    let v526 : string = method14(v348)
    let v527 : string = method15(v489)
...
and closure39 () (v0 : std_io_Error) : std_string_String =
    ...
    v12
and method22 () : (std_io_Error -> std_string_String) =
    closure39()
and closure40 () () : US10 =
    US10_0
...
and closure46 (v0 : string) () : unit =
    ...
    let v2 : bool = true in let mutable _v1 = v1
    #if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v3 : string = "std::fs::remove_dir_all(&*$0).unwrap()"
    Fable.Core.RustInterop.emitRustExpr v0 v3
    ()
    #endif
    #if FABLE_COMPILER_RUST && WASM
    null |> unbox<unit>
...
and closure38 () () : struct (string * System.IDisposable) =
    ...
    #endif
    #if !FABLE_COMPILER && !WASM && !CONTRACT
    let v559 : (unit -> unit) = method23(v537)
    ...
    #endif
    #if !FABLE_COMPILER && !WASM && !CONTRACT
    let v606 : (unit -> unit) = method24(v534)
...
and closure56 () (v0 : string) : string option =
    ...
    | US9_0(v56) -> (* Some *)
        ...
        v57
and method26 () : (string -> string option) =
    closure56()
and closure57 () (v0 : string) : US9 =
    US9_0(v0)
and method27 () : (string -> US9) =
    closure57()
and method28 (v0 : string, v1 : bool, v2 : string, v3 : string) : string =
    ...
    let v41 : string = method14(v3)
    let v42 : string = method15(v0)
    ...
    if v50 then
        ...
        let v51 : (string -> string option) = method26()
        let v52 : string option = v51 v3
        let v53 : (string -> US9) = method27()
        let v54 : US9 = US9_1
        ...
        | US9_1 -> (* None *)
            ...
            failwith<string> v58
        | US9_0(v56) -> (* Some *)
            method28(v0, v1, v2, v56)
and method25 (v0 : string, v1 : bool, v2 : string) : string =
    let v3 : string option = None
    let v4 : bool = true in let mutable _v3 = v3
    #if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    ...
    let v40 : string = method14(v2)
    let v41 : string = method15(v0)
    ...
    if v49 then
        ...
        let v50 : (string -> string option) = method26()
        let v51 : string option = v50 v2
        let v52 : (string -> US9) = method27()
        let v53 : US9 = US9_1
...
and closure58 () (v0 : string) : string =
    ...
    if v13 then
        ...
        let v15 : bool = true in let mutable _v14 = v14
        #if FABLE_COMPILER_RUST && !WASM && !CONTRACT
        let v16 : string = method29()
        let v17 : string = method30(v0)
        let v18 : string = method31()
        ...
        let v33 : string = $"{v32.[0] |> System.Char.ToLower}{v32.[1..]}"
        let v34 : string = "\\"
        let v35 : string = "/"
...
and method35 () : string =
    let v0 : string = ".paket"
    v0
and method37 (v0 : string, v1 : string, v2 : string) : string =
    let v3 : string option = None
    let v4 : bool = true in let mutable _v3 = v3
    #if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v5 : string = method9(v2)
    ...
    if v69 then
        ...
        let v70 : (string -> string option) = method26()
        let v71 : string option = v70 v2
        let v72 : (string -> US9) = method27()
        let v73 : US9 = US9_1
...
and method36 (v0 : string, v1 : string) : string =
    ...
    let v39 : string = method14(v1)
    let v40 : string = method15(v0)
    ...
    if v68 then
        ...
        let v69 : (string -> string option) = method26()
        let v70 : string option = v69 v1
        let v71 : (string -> US9) = method27()
        let v72 : US9 = US9_1
...
and closure60 () () : string =
    ...
    let v83 : string = method14(v46)
    let v84 : string = method38()
...
and method39 (v0 : string) : unit =
    ...
    let v34 : (chrono_DateTime<chrono_Utc> -> US8) = method16()
    let v35 : US8 = US8_1
    ...
    let v55 : US9 =
        ...
        | US8_1 -> (* None *)
            US9_1
        | US8_0(v37) -> (* Some *)
            let v38 : chrono_DateTime<chrono_Utc> = method17(v37)
            ...
            let v46 : chrono_DateTime<chrono_Local> = method18(v42)
    ...
    let v194 : string = method34()
    let v195 : string = method35()
    ...
    let v237 : string = method14(v200)
    let v238 : string = method38()
    ...
    let v280 : string = method14(v242)
    let v281 : string = method41()
    ...
    let v332 : string = method14(v285)
    let v333 : string = method15(v153)
