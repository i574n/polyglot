...
and method37 (v0 : int32 option, v1 : bool, v2 : string, v3 : int32, v4 : int64) : Async<int64> =
    ...
    let _v2139 =
        ...
        ()
    indent *)
    let v2846 : Async<int64> = _v2139 
    let _v5 = v2846 
    #endif
    let v2847 : Async<int64> = _v5 
    v2847
