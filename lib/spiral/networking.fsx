...
and closure3 (v0 : string) (v1 : int32) : Async<bool> =
    ...
    let v34 : US0 = US0_0
    let v35 : (unit -> string) = closure4()
    let v36 : (unit -> struct (int32 * string)) = closure5(v1, v33)
    method4(v34, v35, v36)
    return false 
    (*
    let v37 : bool = *)
...
and closure9 (v0 : int32, v1 : string) (v2 : int32) : Async<bool> =
    ...
    let v42 : US0 = US0_0
    let v43 : (unit -> string) = closure4()
    let v44 : (unit -> struct (int32 * string)) = closure5(v2, v41)
    method4(v42, v43, v44)
    return false 
    (*
    let v45 : bool = *)
    ...
    let v139 : US4 =
        ...
        | US6_1(v125) -> (* Error *)
            ...
            if v128 then
                ...
                let v131 : (unit -> int32) = closure13(v0)
                method14(v129, v130, v131)
                US4_1
            else
                let v133 : US0 = US0_4
                let v134 : (unit -> string) = closure15()
                let v135 : (unit -> struct (int32 * string)) = closure16(v0, v125)
                method16(v133, v134, v135)
                US4_1
        | US6_0(v123) -> (* Ok *)
            US4_0(v123)
    return v139 
    ...
    |> fun x -> _v121 <- Some x
    let v140 : Async<US4> = match _v121 with Some x -> x | None -> failwith "async.new_async_unit / _v121=None"
    v140 
    #endif
    |> fun x -> _v115 <- Some x
    let v141 : Async<US4> = match _v115 with Some x -> x | None -> failwith "base.run_target / _v115=None"
    return! v141 
    }
    |> fun x -> _v60 <- Some x
    let v142 : Async<US4> = match _v60 with Some x -> x | None -> failwith "async.new_async_unit / _v60=None"
    v142 
    #endif
    |> fun x -> _v54 <- Some x
    let v143 : Async<US4> = match _v54 with Some x -> x | None -> failwith "base.run_target / _v54=None"
    v143 
    #endif
    |> fun x -> _v48 <- Some x
    let v144 : Async<US4> = match _v48 with Some x -> x | None -> failwith "base.run_target / _v48=None"
    let! v144 = v144 
    let v145 : US4 = v144 
    let v148 : bool =
        match v145 with
    ...
    |> fun x -> _v9 <- Some x
    let v149 : Async<bool> = match _v9 with Some x -> x | None -> failwith "async.new_async_unit / _v9=None"
    v149 
    #endif
    |> fun x -> _v3 <- Some x
    let v150 : Async<bool> = match _v3 with Some x -> x | None -> failwith "base.run_target / _v3=None"
    v150
...
and closure24 (v0 : US0, v1 : (unit -> string), v2 : (unit -> struct (int32 * int64 * int32 option * bool))) () : string =
    ...
    let v328 : string = match _v216 with Some x -> x | None -> failwith "base.run_target / _v216=None"
    let v329 : int64 = v5.l0
    let struct (v330 : int32, v331 : int64, v332 : int32 option, v333 : bool) = v2 ()
    let v334 : string = ""
    let v335 : Mut4 = {l0 = v334} : Mut4
    method20(v335, v330, v331, v332, v333)
...
and method18 (v0 : int32 option, v1 : bool, v2 : string, v3 : int32, v4 : int64) : Async<int64> =
    ...
    let v206 : Async<bool> =
        ...
        | US7_1 -> (* None *)
            ...
            let v52 : (unit -> struct (int32 * string)) = closure5(v3, v49)
            method4(v50, v51, v52)
            return false 
            (*
            let v53 : bool = *)
        ...
        | US7_0(v56) -> (* Some *)
            ...
            let v98 : (unit -> struct (int32 * string)) = closure5(v3, v95)
            method4(v96, v97, v98)
            return false 
            (*
            let v99 : bool = *)
            ...
            let v193 : US4 =
                ...
                | US6_1(v179) -> (* Error *)
                    ...
                    if v182 then
                        ...
                        let v185 : (unit -> int32) = closure13(v56)
                        method14(v183, v184, v185)
                        US4_1
                    else
                        let v187 : US0 = US0_4
                        let v188 : (unit -> string) = closure15()
                        let v189 : (unit -> struct (int32 * string)) = closure16(v56, v179)
                        method16(v187, v188, v189)
                        US4_1
                | US6_0(v177) -> (* Ok *)
                    US4_0(v177)
            return v193 
            ...
            |> fun x -> _v175 <- Some x
            let v194 : Async<US4> = match _v175 with Some x -> x | None -> failwith "async.new_async_unit / _v175=None"
            v194 
            #endif
            |> fun x -> _v169 <- Some x
            let v195 : Async<US4> = match _v169 with Some x -> x | None -> failwith "base.run_target / _v169=None"
            return! v195 
            }
            |> fun x -> _v114 <- Some x
            let v196 : Async<US4> = match _v114 with Some x -> x | None -> failwith "async.new_async_unit / _v114=None"
            v196 
            #endif
            |> fun x -> _v108 <- Some x
            let v197 : Async<US4> = match _v108 with Some x -> x | None -> failwith "base.run_target / _v108=None"
            v197 
            #endif
            |> fun x -> _v102 <- Some x
            let v198 : Async<US4> = match _v102 with Some x -> x | None -> failwith "base.run_target / _v102=None"
            let! v198 = v198 
            let v199 : US4 = v198 
            let v202 : bool =
                match v199 with
            ...
            |> fun x -> _v63 <- Some x
            let v203 : Async<bool> = match _v63 with Some x -> x | None -> failwith "async.new_async_unit / _v63=None"
            v203 
            #endif
            |> fun x -> _v57 <- Some x
            let v204 : Async<bool> = match _v57 with Some x -> x | None -> failwith "base.run_target / _v57=None"
            v204
    let! v206 = v206 
    let v207 : bool = v206 
    let v208 : bool = v207 = v1
    if v208 then
        return v4 
        (*
        ()
        ...
        *) else
        let v209 : int64 = v4 % 100L
        let v210 : bool = v209 = 0L
        if v210 then
            let v211 : US0 = US0_0
            let v212 : (unit -> string) = closure22()
            let v213 : (unit -> struct (int32 * int64 * int32 option * bool)) = closure23(v0, v1, v3, v4)
            method19(v211, v212, v213)
        let v214 : bool = true
        let mutable _v214 : Async<unit> option = None 
        ...
        #endif
#if FABLE_COMPILER_TYPESCRIPT
        let v218 : Async<unit> = null |> unbox<Async<unit>>
        v218 
        #endif
#if FABLE_COMPILER_PYTHON
        ...
        #endif
        |> fun x -> _v214 <- Some x
        let v222 : Async<unit> = match _v214 with Some x -> x | None -> failwith "base.run_target / _v214=None"
        do! v222 
        let v223 : int64 = v4 + 1L
        let v224 : Async<int64> = method18(v0, v1, v2, v3, v223)
        return! v224 
        (*
        ()
    *)
    ...
    |> fun x -> _v11 <- Some x
    let v225 : Async<int64> = match _v11 with Some x -> x | None -> failwith "async.new_async_unit / _v11=None"
    v225 
    #endif
    |> fun x -> _v5 <- Some x
    let v226 : Async<int64> = match _v5 with Some x -> x | None -> failwith "base.run_target / _v5=None"
    v226
...
and method24 (v0 : int32 option, v1 : string, v2 : int32) : Async<int32> =
    ...
    let v204 : Async<bool> =
        ...
        | US7_1 -> (* None *)
            ...
            let v50 : (unit -> struct (int32 * string)) = closure5(v2, v47)
            method4(v48, v49, v50)
            return false 
            (*
            let v51 : bool = *)
        ...
        | US7_0(v54) -> (* Some *)
            ...
            let v94 : US0 = US0_0
            let v95 : (unit -> string) = closure4()
            let v96 : (unit -> struct (int32 * string)) = closure5(v2, v93)
            method4(v94, v95, v96)
            return false 
            (*
            let v97 : bool = *)
            ...
            let v191 : US4 =
                ...
                | US6_1(v177) -> (* Error *)
                    ...
                    if v180 then
                        ...
                        let v183 : (unit -> int32) = closure13(v54)
                        method14(v181, v182, v183)
                        US4_1
                    else
                        let v185 : US0 = US0_4
                        let v186 : (unit -> string) = closure15()
                        let v187 : (unit -> struct (int32 * string)) = closure16(v54, v177)
                        method16(v185, v186, v187)
                        US4_1
                | US6_0(v175) -> (* Ok *)
                    US4_0(v175)
            return v191 
            ...
            |> fun x -> _v173 <- Some x
            let v192 : Async<US4> = match _v173 with Some x -> x | None -> failwith "async.new_async_unit / _v173=None"
            v192 
            #endif
            |> fun x -> _v167 <- Some x
            let v193 : Async<US4> = match _v167 with Some x -> x | None -> failwith "base.run_target / _v167=None"
            return! v193 
            }
            |> fun x -> _v112 <- Some x
            let v194 : Async<US4> = match _v112 with Some x -> x | None -> failwith "async.new_async_unit / _v112=None"
            v194 
            #endif
            |> fun x -> _v106 <- Some x
            let v195 : Async<US4> = match _v106 with Some x -> x | None -> failwith "base.run_target / _v106=None"
            v195 
            #endif
            |> fun x -> _v100 <- Some x
            let v196 : Async<US4> = match _v100 with Some x -> x | None -> failwith "base.run_target / _v100=None"
            let! v196 = v196 
            let v197 : US4 = v196 
            let v200 : bool =
                match v197 with
            ...
            |> fun x -> _v61 <- Some x
            let v201 : Async<bool> = match _v61 with Some x -> x | None -> failwith "async.new_async_unit / _v61=None"
            v201 
            #endif
            |> fun x -> _v55 <- Some x
            let v202 : Async<bool> = match _v55 with Some x -> x | None -> failwith "base.run_target / _v55=None"
            v202
    let! v204 = v204 
    let v205 : bool = v204 
    ...
    if v206 then
        ...
        *) else
        let v207 : int32 = v2 + 1
        let v208 : Async<int32> = method24(v0, v1, v207)
        return! v208 
        (*
        ()
    *)
    ...
    |> fun x -> _v9 <- Some x
    let v209 : Async<int32> = match _v9 with Some x -> x | None -> failwith "async.new_async_unit / _v9=None"
    v209 
    #endif
    |> fun x -> _v3 <- Some x
    let v210 : Async<int32> = match _v3 with Some x -> x | None -> failwith "base.run_target / _v3=None"
    v210
...
let v4 : (int32 option -> (bool -> (string -> (int32 -> Async<int64>)))) = closure18()
let wait_for_port_access x = v4 x
let v5 : (int32 option -> (string -> (int32 -> Async<int32>))) = closure25()
