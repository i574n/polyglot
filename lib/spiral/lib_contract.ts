import { Mut3 as Mut3_4, Mut2 as Mut2_4, Mut1 as Mut1_4, Mut0 as Mut0_4, State_trace_state as State_trace_state_4, US0_$union, trace } from "../../lib/spiral/trace.fsx";
...
import { US0_US0_0, US0_US0_4, US0_US0_3, US0_US0_2, US0_US0_1, Mut3, Mut2, Mut1, Mut0, State_trace_state, create_temp_directory_name, create_temp_directory, new_file_uri, normalize_path, find_parent, get_source_directory, get_repository_root } from "../../lib/spiral/file_system.fsx";
...
import { US0_US0_0 as US0_US0_0_1, US0_US0_4 as US0_US0_4_1, US0_US0_3 as US0_US0_3_1, US0_US0_2 as US0_US0_2_1, US0_US0_1 as US0_US0_1_1, Mut3 as Mut3_1, Mut2 as Mut2_1, Mut1 as Mut1_1, Mut0 as Mut0_1, State_trace_state as State_trace_state_1 } from "../../lib/spiral/networking.fsx";
import { US0_US0_0 as US0_US0_0_2, US0_US0_4 as US0_US0_4_2, US0_US0_3 as US0_US0_3_2, US0_US0_2 as US0_US0_2_2, US0_US0_1 as US0_US0_1_2, Mut3 as Mut3_2, Mut2 as Mut2_2, Mut1 as Mut1_2, Mut0 as Mut0_2, State_trace_state as State_trace_state_2 } from "../../lib/spiral/runtime.fsx";
import { US0_US0_0 as US0_US0_0_3, US0_US0_4 as US0_US0_4_3, US0_US0_3 as US0_US0_3_3, US0_US0_2 as US0_US0_2_3, US0_US0_1 as US0_US0_1_3, Mut3 as Mut3_3, Mut2 as Mut2_3, Mut1 as Mut1_3, Mut0 as Mut0_3, State_trace_state as State_trace_state_3 } from "../../lib/spiral/common.fsx";
...
export function set_trace_level(new_level: US0_$union): void {
    ...
    patternInput[2].l0 = ((new_level.tag === /* US0_1 */ 1) ? US0_US0_1() : ((new_level.tag === /* US0_2 */ 2) ? US0_US0_2() : ((new_level.tag === /* US0_3 */ 3) ? US0_US0_3() : ((new_level.tag === /* US0_4 */ 4) ? US0_US0_4() : US0_US0_0()))));
    const patternInput_1: [Mut0_1, Mut1_1, Mut2_1, Option<int64>, Mut3_1] = value(State_trace_state_1());
    patternInput_1[2].l0 = ((new_level.tag === /* US0_1 */ 1) ? US0_US0_1_1() : ((new_level.tag === /* US0_2 */ 2) ? US0_US0_2_1() : ((new_level.tag === /* US0_3 */ 3) ? US0_US0_3_1() : ((new_level.tag === /* US0_4 */ 4) ? US0_US0_4_1() : US0_US0_0_1()))));
    const patternInput_2: [Mut0_2, Mut1_2, Mut2_2, Option<int64>, Mut3_2] = value(State_trace_state_2());
    patternInput_2[2].l0 = ((new_level.tag === /* US0_1 */ 1) ? US0_US0_1_2() : ((new_level.tag === /* US0_2 */ 2) ? US0_US0_2_2() : ((new_level.tag === /* US0_3 */ 3) ? US0_US0_3_2() : ((new_level.tag === /* US0_4 */ 4) ? US0_US0_4_2() : US0_US0_0_2()))));
    const patternInput_3: [Mut0_3, Mut1_3, Mut2_3, Option<int64>, Mut3_3] = value(State_trace_state_3());
    patternInput_3[2].l0 = ((new_level.tag === /* US0_1 */ 1) ? US0_US0_1_3() : ((new_level.tag === /* US0_2 */ 2) ? US0_US0_2_3() : ((new_level.tag === /* US0_3 */ 3) ? US0_US0_3_3() : ((new_level.tag === /* US0_4 */ 4) ? US0_US0_4_3() : US0_US0_0_3()))));
    const patternInput_4: [Mut0_4, Mut1_4, Mut2_4, Option<int64>, Mut3_4] = value(State_trace_state_4());
    patternInput_4[2].l0 = new_level;
}

export function get_trace_level(): US0_$union {
    const patternInput: [Mut0_4, Mut1_4, Mut2_4, Option<int64>, Mut3_4] = value(State_trace_state_4());
