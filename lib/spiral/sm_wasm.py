...
def closure0(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow7(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure2(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow8(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure7(unit_var: None, v0_1: int) -> Callable[[str], str]:
    def _arrow11(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow31(v: int) -> Callable[[str], str]:
    return closure7(None, v)


v3: Callable[[int, str], str] = _arrow31
...
def _arrow33(v: int) -> Callable[[int, str], str]:
    return closure12(None, v)


v5: Callable[[int, int, str], str] = _arrow33

def slice(x: int) -> Callable[[int, str], str]:
    return v5(x)


def _arrow34(v: str) -> Callable[[str], Array[str]]:
    return closure15(None, v)


v6: Callable[[str, str], Array[str]] = _arrow34

def split(x: str) -> Callable[[str], Array[str]]:
    return v6(x)


def _arrow35(v: Array[str]) -> Callable[[str], Array[str]]:
    return closure17(None, v)


v7: Callable[[Array[str], str], Array[str]] = _arrow35

def split_string(x: Array[str]) -> Callable[[str], Array[str]]:
    return v7(x)


def _arrow36(v: str) -> Callable[[str], bool]:
    return closure19(None, v)


v8: Callable[[str, str], bool] = _arrow36
...
v9: Callable[[int, int, str], str] = _arrow37

def substring(x: int) -> Callable[[int, str], str]:
    return v9(x)


def _arrow38(v: str) -> str:
    return closure24(None, v)


v10: Callable[[str], str] = _arrow38
...
def _arrow41(v: Array[str]) -> Callable[[str], str]:
    return closure27(None, v)


v13: Callable[[Array[str], str], str] = _arrow41
