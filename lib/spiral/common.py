...
def method7(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr61())) >= find(v13, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr62()))):
...
def closure3(unit_var: None, v0_1: int) -> Callable[[Callable[[], None]], None | None]:
    def _arrow63(v: Callable[[], None], unit_var: Any=unit_var, v0_1: Any=v0_1) -> None | None:
...
def _arrow69(v: Callable[[], None]) -> Callable[[], None]:
    return closure13(None, v)


v3: Callable[[Callable[[], None], None], None] = _arrow69
