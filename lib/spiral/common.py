...
def method0(v0_1: US0) -> tuple[Mut0, Mut1, Mut2, Mut3, Mut4, int64 | None]:
    ...
    _v1: tuple[US2, US3] = (US2(0, v235.fields[0]) if (v235.tag == 0) else _arrow56(), US3(0, ticks_1(now())) if (method2(method5()) == "True") else US3(1))
    v352: US3 = _v1[1]
    v351: US2 = _v1[0]
...
def closure3(unit_var: None, v0_1: Callable[[], None]) -> IDisposable:
    ...
    class ObjectExpr66(IDisposable):
...
def method9(v0_1: Mut0, v1_1: Mut1, v2_1: Mut2, v3: Mut3, v4: Mut4, v5: int64 | None=None) -> str:
    ...
    def _arrow73(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4, v5: Any=v5) -> Any:
    ...
    return to_string(_arrow73() if (v238.tag == 0) else now(), method12())
...
def closure9(v0_1: int, v1_1: Exception, unit_var: None) -> None:
    ...
    if False if (pattern_input[2].l0 == False) else (3 >= find(v36, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr86()))):
        v43: None
        v3(None)
        v43 = None
...
v16: Callable[[Callable[[], None]], IDisposable] = _arrow115
...
v17: Callable[[int, Callable[[], None]], None | None] = _arrow116
...
v18: Callable[[Callable[[], None], None], None] = _arrow117
