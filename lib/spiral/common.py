...
def method8(v0_1: Callable[[], None]) -> Callable[[], None]:
    return v0_1


def closure14(v0_1: Any, unit_var: None) -> None:
    v0_1.Value


def closure13(unit_var: None, v0_1: Callable[[], None]) -> Callable[[], None]:
    v1_1: Callable[[], None] = method8(v0_1)
    def _arrow66(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        v1_1(None)

    v2_1: Any = Lazy(_arrow66)
    def _arrow67(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure14(v2_1, None)

    return _arrow67


def _arrow68(__unit: None=None) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, None)


v0: Callable[[], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow68
...
def _arrow69(v: Callable[[], None]) -> IDisposable:
    return closure2(None, v)


v1: Callable[[Callable[[], None]], IDisposable] = _arrow69

def new_disposable(x: Callable[[], None]) -> IDisposable:
    return v1(x)


def _arrow70(v: int) -> Callable[[Callable[[], None]], None | None]:
    return closure3(None, v)


v2: Callable[[int, Callable[[], None]], None | None] = _arrow70

def retry_fn(x: int) -> Callable[[Callable[[], None]], None | None]:
    return v2(x)


def _arrow71(v: Callable[[], None]) -> Callable[[], None]:
    return closure13(None, v)


v3: Callable[[Callable[[], None], None], None] = _arrow71
