...
def method4(__unit: None=None) -> Callable[[int64], US4]:
    def _arrow38(v: int64) -> US4:
...
def method6(v0_1: US0, v1_1: Callable[[], str]) -> None:
    ...
    if False if (pattern_input_1[1].l0 == False) else (find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr53())) >= find(v13, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr56()))):
...
def method2(v0_1_mut: int, v1_1_mut: Callable[[], None], v2_1_mut: int) -> US2:
    while True:
...
def closure3(unit_var: None, v0_1: int) -> Callable[[Callable[[], None]], None | None]:
    def _arrow74(v: Callable[[], None], unit_var: Any=unit_var, v0_1: Any=v0_1) -> None | None:
        return closure4(v0_1, v)

    return _arrow74


def _arrow75(__unit: None=None) -> tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]:
    return closure0(None, None)


v0: Callable[[], tuple[Mut0, Mut1, Mut2, int64 | None, Mut3]] = _arrow75
...
v1: Callable[[Callable[[], None]], IDisposable] = _arrow76
...
v2: Callable[[int, Callable[[], None]], None | None] = _arrow77
