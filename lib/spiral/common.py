...
def closure2(v0_1: str | None, v1_1: Callable[[US1 | None], FSharpRef[US1 | None]], unit_var: None) -> None:
    def _arrow48(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, unit_var: Any=unit_var) -> US1 | None:
        x: str = v0_1
    ...
    ignore(v1_1(None if (v0_1 is None) else _arrow48()))
...
def method0(v0_1: US0) -> tuple[Mut0, Mut1, Mut2, Mut3, int64 | None]:
    ...
    _v1: tuple[US2, US3] = (US2(0, v178.fields[0]) if (v178.tag == 0) else _arrow53(), US3(0, ticks_1(now())) if (method2(method4()) == "True") else US3(1))
    v295: US3 = _v1[1]
    v294: US2 = _v1[0]
...
def closure4(unit_var: None, v0_1: Callable[[], None]) -> IDisposable:
    ...
    class ObjectExpr62(IDisposable):
...
def closure13(v0_1: int64 | None, v1_1: Callable[[US3 | None], FSharpRef[US3 | None]], unit_var: None) -> None:
    def _arrow67(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, unit_var: Any=unit_var) -> US3 | None:
        x: int64 = v0_1
    ...
    ignore(v1_1(None if (v0_1 is None) else _arrow67()))
...
def closure17(v0_1: str, unit_var: None) -> None:
    print(v0_1)


def closure16(unit_var: None, v0_1: str) -> None:
    v3: None
    closure17(v0_1, None)
    v3 = None
...
def closure10(v0_1: int, v1_1: Exception, unit_var: None) -> None:
    ...
    if False if (pattern_input_1[2].l0 == False) else (3 >= find(v61, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr76()))):
        v69: None
        ...
        def v350(v: US3 | None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, unit_var: Any=unit_var) -> FSharpRef[US3 | None]:
            return closure12(_v348, v)

        closure13(pattern_input_2[4], v350, None)
        v353 = None
        v368: US3 = default_arg(_v348.contents, US3(1))
        def _arrow81(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, unit_var: Any=unit_var) -> Any:
        ...
        v413: str = to_string(_arrow81() if (v368.tag == 0) else now(), method9())
        v559: str = method11()
        v567: Mut4 = Mut4(method12())
        v578: None
        closure14(v567, ("" + to_text(interpolate("%A%P()", [US0(0)]))) + "", None)
        v578 = None
        v582: Array[str] = split(v567.l0, [v559], None, 0)
        v585: str = v582[0]
        v589: Mut4 = Mut4(method12())
        v600: None
        closure14(v589, ("" + to_text(interpolate("%A%P()", [US0(3)]))) + "", None)
        v600 = None
        v603: str = v589.l0
        ...
        if v610.tag == 0:
            ...
            v618: str = method11()
            v626: Mut4 = Mut4(method12())
            v637: None
            closure14(v626, ("" + to_text(interpolate("%A%P()", [US0(1)]))) + "", None)
            v637 = None
            v641: Array[str] = split(v626.l0, [v618], None, 0)
            v644: str = v641[0]
            v648: Mut4 = Mut4(method12())
            v659: None
            closure14(v648, ("" + to_text(interpolate("%A%P()", [US0(3)]))) + "", None)
            v659 = None
            v662: str = v648.l0
            ...
            if v669.tag == 0:
                ...
                v677: str = method11()
                v685: Mut4 = Mut4(method12())
                v696: None
                closure14(v685, ("" + to_text(interpolate("%A%P()", [US0(2)]))) + "", None)
                v696 = None
                v700: Array[str] = split(v685.l0, [v677], None, 0)
                v703: str = v700[0]
                v707: Mut4 = Mut4(method12())
                v718: None
                closure14(v707, ("" + to_text(interpolate("%A%P()", [US0(3)]))) + "", None)
                v718 = None
                v721: str = v707.l0
        ...
        v802: str = ("\u001b[93m" + pad_left(v742.lower(), 7, " ")) + method13()
        v813: int64 = pattern_input_2[0].l0
        v815: Mut4 = Mut4(method12())
        v822: None
        closure14(v815, ("" + "{ ") + "", None)
        v822 = None
        v831: None
        closure14(v815, ("" + "retry") + "", None)
        v831 = None
        v840: None
        closure14(v815, ("" + " = ") + "", None)
        v840 = None
        v848: None
        closure14(v815, ("" + str(v0_1)) + "", None)
        v848 = None
        v857: None
        closure14(v815, ("" + "; ") + "", None)
        v857 = None
        v866: None
        closure14(v815, ("" + "ex") + "", None)
        v866 = None
        v874: None
        closure14(v815, ("" + " = ") + "", None)
        v874 = None
        v909: None
        closure14(v815, ("" + to_text(interpolate("%A%P()", [v1_1]))) + "", None)
        v909 = None
        v918: None
        closure14(v815, ("" + " }") + "", None)
        v918 = None
        v921: str = v815.l0
        v960: str = trim_end(trim_start(((((((((("" + v413) + " ") + v802) + " #") + str(v813)) + " ") + closure15(None, None)) + " / ") + v921) + "", *to_array(empty())), *to_array(of_array([" ", "/"])))
        closure16(None, v960)
        pattern_input[1].l0(v960)
...
def closure5(unit_var: None, v0_1: int) -> Callable[[Callable[[], None]], None | None]:
    def _arrow109(v: Callable[[], None], unit_var: Any=unit_var, v0_1: Any=v0_1) -> None | None:
        return closure6(v0_1, v)

    return _arrow109


def method14(v0_1: Callable[[], None]) -> Callable[[], None]:
    return v0_1


def closure19(v0_1: Any, unit_var: None) -> None:
    v0_1.Value


def closure18(unit_var: None, v0_1: Callable[[], None]) -> Callable[[], None]:
    v1_1: Callable[[], None] = method14(v0_1)
    def _arrow110(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        v1_1(None)

    v2_1: Any = Lazy(_arrow110)
    def _arrow111(__unit: None=None, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure19(v2_1, None)
...
def _arrow112(__unit: None=None) -> None:
    closure0(None, None)


v1: Callable[[], None] = _arrow112
...
def _arrow114(v: Callable[[], None]) -> IDisposable:
    return closure4(None, v)


v15: Callable[[Callable[[], None]], IDisposable] = _arrow114

def new_disposable(x: Callable[[], None]) -> IDisposable:
    return v15(x)


def _arrow115(v: int) -> Callable[[Callable[[], None]], None | None]:
    return closure5(None, v)


v16: Callable[[int, Callable[[], None]], None | None] = _arrow115

def retry_fn(x: int) -> Callable[[Callable[[], None]], None | None]:
    return v16(x)


def _arrow116(v: Callable[[], None]) -> Callable[[], None]:
    return closure18(None, v)


v17: Callable[[Callable[[], None], None], None] = _arrow116
