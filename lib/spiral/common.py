...
def method1(__unit: None=None) -> tuple[US1, US2]:
    ...
    def _arrow38(__unit: None=None) -> US1:
    ...
    return (US1(0, v6.fields[0]) if (v6.tag == 0) else _arrow38(), US2(1) if (method2("AUTOMATION") != "True") else US2(0, from_value(ticks_1(now()), False)))
