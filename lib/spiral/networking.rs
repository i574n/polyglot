pub mod Networking {
    ...
    pub fn closure5(
        ...
        }
        {
            ...
            let v13: Networking::US2 = defaultValue(
                Networking::US2::US2_1,
                map(Networking::method3(), patternInput.3.clone()),
            );
            let v31: DateTime = match &v13 {
                Networking::US2::US2_0(v13_0_0) => {
    ...
    pub fn closure19(v0_1: i32, v1_1: i64, unitVar: ()) -> string {
        sprintf!(
            "port: {} / retry: {} / {}",
            v0_1,
            v1_1,
