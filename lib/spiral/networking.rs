pub mod Networking {
    ...
    pub fn closure0(
        ...
        {
            let v38: Networking::US1 = if getValue(_v7.get().clone()) == string("True") {
            ...
            };
            {
                let x_1: Option<i64> = match &v38 {
                    Networking::US1::US1_0(v38_0_0) => Some(match &v38 {
    ...
    pub fn closure5(
        ...
        }
        {
            ...
            let _v10: LrcPtr<MutCell<Option<Networking::US1>>> = refCell(None::<Networking::US1>);
            {
                let x_2: Option<Networking::US1> = match &v7 {
            ...
            {
                let v15: Networking::US1 = defaultValue(Networking::US1::US1_1, _v10.get().clone());
                let v33: DateTime = match &v15 {
                    Networking::US1::US1_0(v15_0_0) => {
    ...
    pub fn method2(v0_1: Networking::US0, v1_1: Func0<string>) {
        fn v2_1() -> (
            LrcPtr<Networking::Mut0>,
            LrcPtr<Networking::Mut1>,
            LrcPtr<Networking::Mut2>,
    ...
    pub fn method3(v0_1: Option<i32>, v1_1: bool, v2_1: i32, v3_1: i64) -> Arc<Async<i64>> {
    ...
    pub fn closure15(v0_1: Option<i32>, v1_1: bool, v2_1: i32) -> Arc<Async<i64>> {
        Networking::method3(v0_1, v1_1, v2_1, 0_i64)
    }
    ...
    pub fn method4(v0_1: Option<i32>, v1_1: i32) -> Arc<Async<i32>> {
