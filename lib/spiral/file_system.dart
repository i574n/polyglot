...
bool US5__get_IsUS5_2(types.FSharpRef<US5, InOut> this$, void unitArg) {
    if (this$.tag == 2) {
        return true;
    } else {
        return false;
...
bool US5__get_IsUS5_3(types.FSharpRef<US5, InOut> this$, void unitArg) {
    if (this$.tag == 3) {
        return true;
    } else {
        return false;
...
bool US5__get_IsUS5_4(types.FSharpRef<US5, InOut> this$, void unitArg) {
    if (this$.tag == 4) {
        return true;
    } else {
        return false;
...
types.Tuple5<Mut0, Mut1, Mut2, types.Some<int>?, Mut3> closure0(void unitVar, void unitVar_1) {
    ...
    final v5_1 = Mut3((String v) {
        closure1(util.ignore(), v);
    });
    types.Some<types.Some<int>?>? _v6;
    final types.Some<int>? x = method1(null);
    _v6 = types.Some(x);
    return types.Tuple5(v1_1, v0_1, v3_1, types.value(_v6), v5_1);
}

String closure3(void unitVar, void unitVar_1) => 'file_system.delete_directory_async';

String closure5(void unitVar, String v0_1) {
    types.Some<String>? _v1;
    _v1 = const types.Some('');
    return types.value(_v1);
}

String closure6(void unitVar, void unitVar_1) => '';

String closure4(String v0_1, String v1_1, void unitVar) => 'path: ${closure5(util.ignore(), v0_1)} / ex: $v1_1 / ${closure6(util.ignore(), util.ignore())}';

US2 closure8(void unitVar, int v0_1) => US2_US2_0(v0_1);

US2 Function(int) method4() => (int v) => closure8(util.ignore(), v);

String method5() => '';

String closure7(US0 v0_1, String Function() v1_1, String Function() v2_1, void unitVar) {
...
void method6(US0 v0_1, String Function() v1_1) {
    ...
    final US0 v13_1 = patternInput_1.item3.l0;
    if ((patternInput_1.item2.l0 == false) ? false : (map.find<US0, int>(v0_1, map.ofSeq<US0, int>(const [types.Tuple2(US0(/* US0_0 */ 0), 0), types.Tuple2(US0(/* US0_1 */ 1), 1), types.Tuple2(US0(/* US0_2 */ 2), 2), types.Tuple2(US0(/* US0_3 */ 3), 3), types.Tuple2(US0(/* US0_4 */ 4), 4)], types.Comparer((US0 x, US0 y) => x.compareTo(y)))) >= map.find<US0, int>(v13_1, map.ofSeq<US0, int>(const [types.Tuple2(US0(/* US0_0 */ 0), 0), types.Tuple2(US0(/* US0_1 */ 1), 1), types.Tuple2(US0(/* US0_2 */ 2), 2), types.Tuple2(US0(/* US0_3 */ 3), 3), types.Tuple2(US0(/* US0_4 */ 4), 4)], types.Comparer((US0 x, US0 y) => x.compareTo(y)))))) {
        final v21 = v3_1.l0 + 1;
        v3_1.l0 = v21;
        final v22 = '${v1_1()}';
...
void method3(US0 v0_1, String Function() v1_1, String Function() v2_1) {
    method6(v0_1, () => closure7(v0_1, v1_1, v2_1, util.ignore()));
}
...
Async<int> closure2(void unitVar, String v0_1) {
    types.Some<Async<int>>? _v1;
    _v1 = const types.Some(null);
    return types.value(_v1);
}

String closure11(void unitVar, void unitVar_1) => 'file_system.wait_for_file_access';

String closure12(String v0_1, int v1_1, String v2_1, void unitVar) => 'path: ${closure5(util.ignore(), v0_1)} / retry: $v1_1 / ex: $v2_1 / ${closure6(util.ignore(), util.ignore())}';

Async<int> method7(String v0_1, US5 v1_1, US4 v2_1, int v3_1) {
    types.Some<Async<int>>? _v4;
    _v4 = const types.Some(null);
    return types.value(_v4);
}

Async<int> closure10(US3 v0_1, String v1_1) {
    types.Some<Async<int>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<int> Function(String) closure9(void unitVar, US3 v0_1) => (String v) => closure10(v0_1, v);
...
Async<int> closure13(void unitVar, String v0_1) {
    types.Some<Async<int>>? _v1;
    _v1 = const types.Some(null);
    return types.value(_v1);
}

Async<String> closure14(void unitVar, String v0_1) {
    types.Some<Async<String>>? _v1;
    _v1 = const types.Some(null);
    return types.value(_v1);
}

String method9(String v0_1) => v0_1;

Async<bool> closure16(String v0_1, String v1_1) {
    types.Some<Async<bool>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<bool> Function(String) closure15(void unitVar, String v0_1) => (String v) => closure16(v0_1, v);

Async<void> closure18(String v0_1, String v1_1) {
    types.Some<Async<void>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<void> Function(String) closure17(void unitVar, String v0_1) => (String v) => closure18(v0_1, v);

Async<void> closure20(String v0_1, String v1_1) {
    types.Some<Async<void>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<void> Function(String) closure19(void unitVar, String v0_1) => (String v) => closure20(v0_1, v);

String closure22(void unitVar, void unitVar_1) => 'delete_file_async';

String closure23(String v0_1, dynamic v1_1, void unitVar) {
    types.Some<String>? _v2;
    _v2 = const types.Some('');
    final v10_1 = types.value(_v2);
    return 'path: ${closure5(util.ignore(), v0_1)} / ex: $v10_1 / ${closure6(util.ignore(), util.ignore())}';
}

Async<int> method10(String v0_1, int v1_1) {
    types.Some<Async<int>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<int> closure21(void unitVar, String v0_1) {
    types.Some<Async<int>>? _v1;
    _v1 = const types.Some(null);
    return types.value(_v1);
}

String closure26(void unitVar, void unitVar_1) => 'move_file_async';

String closure27(String v0_1, String v1_1, dynamic v2_1, void unitVar) {
    types.Some<String>? _v3;
    _v3 = const types.Some('');
    final v11_1 = types.value(_v3);
    String v12_1(String v) => closure5(util.ignore(), v);
    return 'old_path: ${v12_1(v1_1)} / new_path: ${v12_1(v0_1)} / ex: $v11_1 / ${closure6(util.ignore(), util.ignore())}';
}

Async<int> method11(String v0_1, String v1_1, int v2_1) {
    types.Some<Async<int>>? _v3;
    _v3 = const types.Some(null);
    return types.value(_v3);
}

Async<int> closure25(String v0_1, String v1_1) {
    types.Some<Async<int>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<int> Function(String) closure24(void unitVar, String v0_1) => (String v) => closure25(v0_1, v);

US6 closure29(void unitVar, int v0_1) => US6_US6_0(v0_1);

US6 closure30(void unitVar, dynamic v0_1) => US6_US6_1(v0_1);

String closure31(void unitVar, void unitVar_1) => 'run_with_timeout_async';

String closure32(void unitVar, void unitVar_1) => 'timeout: ${1000} / ${closure6(util.ignore(), util.ignore())}';

String closure33(String v0_1, void unitVar) => 'run_with_timeout_async** / ex: $v0_1';

String closure34(void unitVar, void unitVar_1) => 'read_all_text_retry_async';

String method13(int v0_1, String v1_1) => 'retry: $v0_1 / ex: $v1_1 / ${closure6(util.ignore(), util.ignore())}';

String closure35(int v0_1, String v1_1, void unitVar) => method13(v0_1, v1_1);

Async<types.Some<String>?> method12(String v0_1, int v1_1) {
    types.Some<Async<types.Some<String>?>>? _v2;
    _v2 = const types.Some(null);
    return types.value(_v2);
}

Async<types.Some<String>?> closure28(void unitVar, String v0_1) {
    types.Some<Async<types.Some<String>?>>? _v1;
    _v1 = const types.Some(null);
    return types.value(_v1);
}

String closure37(void unitVar, void unitVar_1) {
    types.Some<String>? _v0;
    _v0 = const types.Some('');
    return types.value(_v0);
}

String method14(String v0_1) => v0_1;

String method15(String v0_1) => v0_1;

String closure36(void unitVar, void unitVar_1) {
    types.Some<String>? _v0;
    _v0 = const types.Some('');
    return types.value(_v0);
}

String closure39(void unitVar, void unitVar_1) => 'file_system.create_temp_directory';

String closure40(String v0_1, String v1_1, void unitVar) => 'temp_folder: $v0_1 / result: $v1_1 ${closure6(util.ignore(), util.ignore())}';

void closure41(String v0_1, void unitVar) {
    types.Some<Async<int>>? _v1;
    _v1 = const types.Some(null);
...
types.Tuple2<String, types.IDisposable> closure38(void unitVar, void unitVar_1) {
...
String closure42(void unitVar, void unitVar_1) => 'C:\\home\\git\\polyglot\\lib\\spiral';

bool closure46(void unitVar, String v0_1) {
    types.Some<bool>? _v1;
    _v1 = const types.Some(false);
    return types.value(_v1);
}

bool closure47(void unitVar, String v0_1) {
    types.Some<bool>? _v1;
    _v1 = const types.Some(false);
    return types.value(_v1);
}

types.Some<String>? closure48(void unitVar, String v0_1) {
    types.Some<US8>? _v1;
    _v1 = const types.Some(null);
...
types.Some<String>? Function(String) method17() => (String v) => closure48(util.ignore(), v);

US8 closure49(void unitVar, String v0_1) => US8_US8_0(v0_1);

US8 Function(String) method18() => (String v) => closure49(util.ignore(), v);

String method19(String v0_1_mut, bool v1_1_mut, String v2_1_mut, String v3_1_mut) {
    method19:
    while (true) {
        final v0_1 = v0_1_mut;
        final v1_1 = v1_1_mut;
        ...
        if ((v1_1 ? ((String v) => closure46(util.ignore(), v)) : ((String v_1) => closure47(util.ignore(), v_1)))(types.value(_v4))) {
            return v3_1;
        } else {
            final types.Some<String>? v40 = (method17())(v3_1);
            final US8 v43 = option_2.defaultValue(const US8(/* US8_1 */ 1), option_2.map<String, US8>(method18(), v40));
            if (v43.tag == /* US8_0 */ 0) {
                v0_1_mut = v0_1;
                v1_1_mut = v1_1;
                v2_1_mut = v2_1;
...
String method16(String v0_1, bool v1_1, String v2_1) {
    types.Some<String>? _v3;
    _v3 = const types.Some('');
    if ((v1_1 ? ((String v) => closure46(util.ignore(), v)) : ((String v_1) => closure47(util.ignore(), v_1)))(types.value(_v3))) {
        return v2_1;
    } else {
        final types.Some<String>? v39 = (method17())(v2_1);
        final US8 v42 = option_2.defaultValue(const US8(/* US8_1 */ 1), option_2.map<String, US8>(method18(), v39));
        if (v42.tag == /* US8_0 */ 0) {
            final v42_1 = v42 as US8_US8_0;
            return method19(v0_1, v1_1, v2_1, v42_1.f0_0);
        } else {
...
String closure45(String v0_1, bool v1_1, String v2_1) => method16(v0_1, v1_1, v2_1);

String Function(String) closure44(String v0_1, bool v1_1) => (String v) => closure45(v0_1, v1_1, v);

String Function(String) Function(bool) closure43(void unitVar, String v0_1) => (bool v) => closure44(v0_1, v);

String closure50(void unitVar, String v0_1) {
    types.Some<bool>? _v1;
    _v1 = const types.Some(false);
    if (types.value(_v1) == false) {
        return v0_1;
    } else {
        final c = v0_1.codeUnitAt(0);
        final v13_1 = '${c.toLowerCase()}${v0_1.substring(1)}';
        return v13_1.replaceAll('\\', '/');
    }
}

String closure51(void unitVar, String v0_1) => 'file:///${string.trimStart(v0_1, [47])}';

String method20() => 'polyglot';

String method21() => '.paket';

String method22() => 'polyglot';

String method23() => '.paket';

String method25(String v0_1_mut, String v1_1_mut, String v2_1_mut) {
    method25:
    while (true) {
        final v0_1 = v0_1_mut;
        final v1_1 = v1_1_mut;
        ...
        if (types.value(_v34)) {
            ...
            final types.Some<String>? v59 = (method17())(v2_1);
            final US8 v62 = option_2.defaultValue(const US8(/* US8_1 */ 1), option_2.map<String, US8>(method18(), v59));
            if (v62.tag == /* US8_0 */ 0) {
                v0_1_mut = v0_1;
                v1_1_mut = v1_1;
...
String method24(String v0_1, String v1_1) {
    types.Some<String>? _v2;
    _v2 = const types.Some('');
    ...
    if (types.value(_v33)) {
        ...
        final types.Some<String>? v58 = (method17())(v1_1);
        final US8 v61 = option_2.defaultValue(const US8(/* US8_1 */ 1), option_2.map<String, US8>(method18(), v58));
        if (v61.tag == /* US8_0 */ 0) {
            final v61_1 = v61 as US8_US8_0;
            return method25(v0_1, v1_1, v61_1.f0_0);
        } else {
...
String method26() => 'polyglot';

String closure52(void unitVar, void unitVar_1) {
    types.Some<String>? _v1;
    _v1 = const types.Some('');
    final v34 = method24(types.value(_v1), 'C:\\home\\git\\polyglot\\lib\\spiral');
    types.Some<String>? _v35;
    _v35 = const types.Some('');
    return types.value(_v35);
}

String method28() => 'target/polyglot/trace';

String method29() => 'target/polyglot/trace';

void method27(String v0_1) {
    types.Some<void>? _v1;
    null;
...
void closure54(void unitVar, String v0_1) {
    method27(v0_1);
}

void closure53(void unitVar, bool v0_1) {
    if (State_trace_state == null) {
        State_trace_state = types.Some(closure0(util.ignore(), util.ignore()));
    }
    final patternInput = types.value(State_trace_state);
    final v9_1 = v0_1 ? ((String v) {
        closure54(util.ignore(), v);
    }) : ((String v_1) {
        closure1(util.ignore(), v_1);
    });
    patternInput.item5.l0 = v9_1;
}

String closure56(String v0_1, String v1_1) {
    types.Some<String>? _v2;
    _v2 = const types.Some('');
    return types.value(_v2);
}

String Function(String) closure55(void unitVar, String v0_1) => (String v) => closure56(v0_1, v);

types.Tuple5<Mut0, Mut1, Mut2, types.Some<int>?, Mut3> v0() => closure0(util.ignore(), util.ignore());

Async<int> v1(String v) => closure2(util.ignore(), v);

Async<int> delete_directory_async(String x) => v1(x);

Async<int> Function(String) v2(US3 v) => closure9(util.ignore(), v);

Async<int> Function(String) wait_for_file_access(US3 x) => v2(x);

Async<int> v3(String v) => closure13(util.ignore(), v);

Async<int> wait_for_file_access_read(String x) => v3(x);

Async<String> v4(String v) => closure14(util.ignore(), v);

Async<String> read_all_text_async(String x) => v4(x);

Async<bool> Function(String) v5(String v) => closure15(util.ignore(), v);

Async<bool> Function(String) file_exists_content(String x) => v5(x);

Async<void> Function(String) v6(String v) => closure17(util.ignore(), v);

Async<void> Function(String) write_all_text_async(String x) => v6(x);

Async<void> Function(String) v7(String v) => closure19(util.ignore(), v);

Async<void> Function(String) write_all_text_exists(String x) => v7(x);

Async<int> v8(String v) => closure21(util.ignore(), v);

Async<int> delete_file_async(String x) => v8(x);

Async<int> Function(String) v9(String v) => closure24(util.ignore(), v);

Async<int> Function(String) move_file_async(String x) => v9(x);

Async<types.Some<String>?> v10(String v) => closure28(util.ignore(), v);

Async<types.Some<String>?> read_all_text_retry_async(String x) => v10(x);

String v11() => closure36(util.ignore(), util.ignore());

String create_temp_directory_name() => v11();

types.Tuple2<String, types.IDisposable> v12() => closure38(util.ignore(), util.ignore());

types.Tuple2<String, types.IDisposable> create_temp_directory() => v12();

String v13() => closure42(util.ignore(), util.ignore());

String get_source_directory() => v13();

String Function(String) Function(bool) v14(String v) => closure43(util.ignore(), v);

String Function(String) Function(bool) find_parent(String x) => v14(x);

String v15(String v) => closure50(util.ignore(), v);

String normalize_path(String x) => v15(x);

String v16(String v) => closure51(util.ignore(), v);

String new_file_uri(String x) => v16(x);

String v17() => closure52(util.ignore(), util.ignore());

String get_repository_root() => v17();

void v18(bool v) {
    closure53(util.ignore(), v);
}

void init_trace_file(bool x) {
    v18(x);
}

String Function(String) v19(String v) => closure55(util.ignore(), v);

String Function(String) op_LessDivideGreater(String x) => v19(x);
