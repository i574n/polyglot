    ...
    pub mod Spiral_builder {
                ...
                break '_method84 ({
                                ...
                                _ => {
                                    ...
                                    match &v488 {
                                        Spiral_builder::US23::US23_0(
                                            ...
                                            let v495: List<string> = Spiral_builder::method91(
                                                v488_0_0.clone(),
                                                empty::<string>(),
                                            );
                                            Spiral_builder::US16::US16_0(
                    ...
                    match &v517 {
                        Spiral_builder::US16::US16_0(
                            ...
                            let v524: i32 = Spiral_builder::method81(v519.clone(), 0_i32);
        ...
        pub fn method146(v0_1: string) -> string {
            ...
            if (v52.exists()) == false {
                ...
                }
                {
                    ...
                    let v153: string = ofChar(Spiral_builder::method166());
                    join(
                        if (v153.clone()) == string("\n") {
                            Spiral_builder::method167(v153.clone())
                        } else {
                            v153
                        },
                        toArray_1(_v144),
                ...
                let v168: std::path::PathBuf = v165.unwrap();
                let v182: std::path::Display = v168.display();
                let v206: std::string::String = format!("{}", v182);
                fable_library_rust::String_::fromString(v206)
            }
        }
            ...
            let result: sha2::Sha256 = sha2::Digest::new();
            {
                ...
                let v73: bool = true;
                {
                    ...
                    let v75: bool = true;
                    {
                        ...
                        let v101: string = Spiral_builder::method184();
                        let v107: string = join(
                            if (v101.clone()) == string("\n") {
                                Spiral_builder::method167(v101.clone())
                            } else {
                                v101
                            },
                            toArray_1(_v94),
        ...
        pub fn method187(
            ...
            Spiral_builder::method41(v9.clone(), v0_1);
            {
                ...
                let v30: List<string> = Spiral_builder::method91(
                ...
                let v45: string = Spiral_builder::method147(Spiral_builder::method28(
                    v4,
                    concat(new_array(&[v1_1, string(".fsproj")])),
                ));
                Spiral_builder::method41(v45.clone(),
        ...
        pub fn closure102(
            ...
            let v193: Spiral_builder::US46 = match &v19 {
                Spiral_builder::US45::US45_0(v19_0_0) => {
                    ...
                    let v73: string =
                        concat(new_array(&[v0_1.clone(), string("\\.(?<a>[\\d.]+)$")]));
        ...
        pub fn method20(
            ...
            let __future_init = Box::pin(async move {
                ...
                let v4783: Array<(string, string)> = if let Spiral_builder::US6::US6_0(
                    v21_0_0,
                    v21_0_1,
                ) = &v21
                {
                    ...
                    if (fable_library_rust::String_::fromString(v25.clone())) == string("cuda") {
                        ...
                        let v482: string = join(Spiral_builder::method40(), toArray_1(_v472));
                        let patternInput: (i32, string) = if (v482.clone()) == string("") {
                            (0_i32, string(""))
                        } else {
                        ...
                        let v542: i32 = patternInput.0.clone();
                        let patternInput_4: (
                            Spiral_builder::US5,
                            Spiral_builder::US5,
                            Spiral_builder::US5,
                            ...
                            let v611: string = patternInput_1.1.clone();
                            let v610: i32 = patternInput_1.0.clone();
                            let v612: i32 = get_Count(v600.clone());
                            let v613: Array<string> = new_init(&string(""), v612);
                            let v614: LrcPtr<Spiral_builder::Mut5> =
                                LrcPtr::new(Spiral_builder::Mut5 {
                                    l0: MutCell::new(0_i32),
                                });
                            while Spiral_builder::method72(v612, v614.clone()) {
                                let v616: i32 = v614.l0.get().clone();
                                let patternInput_2: (string, string) = v600[v616].clone();
                                let v619: string = sprintf!(
                                    "$env:{}=\'\'{}\'\'",
                                    patternInput_2.0.clone(),
                                    patternInput_2.1.clone()
                                );
                                v613.get_mut()[v616 as usize] = v619;
                                {
                                    let v620: i32 = (v616) + 1_i32;
                                    v614.l0.set(v620);
                                    ()
                                }
                            }
                            {
                                let v630: string = sprintf!(
                                    "pwsh -c \'{}; {}\'",
                                    join(string(";"), toArray_1(ofArray_1(v613.clone()))),
                                    v597
                                );
                                let patternInput_3: (
                                    Spiral_builder::US5,
                                    ...
                                    try_catch(
                                        || {
                                            result.set(Spiral_builder::closure62(
                                                (),
                                                Spiral_builder::closure63(v611.clone(), ()),
                                            ))
                                        },
                                        |ex: LrcPtr<Exception>| {
                                    ...
                                    {
                                        let v641: Spiral_builder::US5 = result.get().clone();
                                        let v651: Option<string> = match &v641 {
                                            Spiral_builder::US5::US5_0(v641_0_0) => Some(
                                                match &v641 {
                                                    Spiral_builder::US5::US5_0(x) => x.clone(),
                                                    _ => unreachable!(),
                                                }
                                        ...
                                        (
                                            ...
                                            Spiral_builder::US5::US5_0(v651.unwrap()),
                                        )
                                    }
                                } else {
                                    let v661: () = {
                        ...
                        let v713: Spiral_builder::US5 = patternInput_4.3.clone();
                        let v711: Spiral_builder::US5 = patternInput_4.1.clone();
                        let v710: Spiral_builder::US5 = patternInput_4.0.clone();
                        let v726: Array<(string, string)> = new_array(&[
                            (
                                string("extension"),
                                match &v710 {
                                    Spiral_builder::US5::US5_0(v710_0_0) => match &v710 {
                                        Spiral_builder::US5::US5_0(x) => x.clone(),
                                        _ => unreachable!(),
                                    }
                                    .clone(),
                        ...
                        let v728: Vec<(string, string)> = v726.to_vec();
                        let v731: Vec<LrcPtr<(std::string::String, std::string::String)>> = v728
                            .into_iter()
                            .map(|x| {
                            ...
                            .collect::<Vec<_>>();
                        let v732: string =
                            string("std::collections::BTreeMap::from_iter(v731.iter().map(|x| x.as_ref()).map(|&(ref k, ref v)| (k.clone(), v.clone())))");
                        let v733: std::collections::BTreeMap<
                            std::string::String,
                            std::string::String,
                        ...
                        let v735: Result<std::string::String, serde_json::Error> =
                            serde_json::to_string(&v733);
                        let v738: std::string::String = v735.unwrap();
                        new_array(&[(
                            string("command_result"),
                            fable_library_rust::String_::fromString(v738),
                        )])
                    } else {
                        if (fable_library_rust::String_::fromString(v25.clone())) == string("fable")
                        {
                            let v757: string = Spiral_builder::method140();
                            let v760: &str = &*v757;
                            let v783: Option<std::string::String> =
                                clap::ArgMatches::get_one(&v26.clone(), v760).cloned();
                            let v797: Spiral_builder::US7 = defaultValue(
                                Spiral_builder::US7::US7_1,
                                map(Spiral_builder::method23(), v783),
                            );
                            let v804: std::string::String = match &v797 {
                                Spiral_builder::US7::US7_0(v797_0_0) => match &v797 {
                                    Spiral_builder::US7::US7_0(x) => x.clone(),
                                    _ => unreachable!(),
                                }
                                .clone(),
                            ...
                            let v806: string = fable_library_rust::String_::fromString(v804);
                            let v807: string = Spiral_builder::method141();
                            let v810: &str = &*v807;
                            let v833: Option<std::string::String> =
                                clap::ArgMatches::get_one(&v26.clone(), v810).cloned();
                            let v847: Spiral_builder::US7 = defaultValue(
                                Spiral_builder::US7::US7_1,
                                map(Spiral_builder::method23(), v833),
                            );
                            let v857: Spiral_builder::US5 = match &v847 {
                                Spiral_builder::US7::US7_0(v847_0_0) => Spiral_builder::US5::US5_0(
                                    fable_library_rust::String_::fromString(
                                        match &v847 {
                                            Spiral_builder::US7::US7_0(x) => x.clone(),
                                            _ => unreachable!(),
                            ...
                            new_array(&[(
                                string("command_result"),
                                match &v857 {
                                    Spiral_builder::US5::US5_0(v857_0_0) => {
                                        let v859: clap::Command = Spiral_builder::method0();
                                        let v861: Spiral_builder::US22 =
                                        ...
                                        let v869: Array<string> = match &v861 {
                                            Spiral_builder::US22::US22_0(v861_0_0) => {
                                                v861_0_0.clone()
                                            }
                                            Spiral_builder::US22::US22_1(v861_1_0) => panic!(
                                                "{}",
                                                concat(new_array(&[
                                                    string(
                                        ...
                                        let v871: Vec<string> = v869.to_vec();
                                        let v873: bool = true;
                                        let _vec_map: Vec<_> = v871
                                            .into_iter()
                                            .map(|x| {
                                                //;
                                                let v875: string = x;
                                                let v878: &str = &*v875;
                                                let v902: std::string::String = String::from(v878);
                                                let v925: bool = true;
                                                v902
                                            })
                                            .collect::<Vec<_>>();
                                        let v927: Vec<std::string::String> = _vec_map;
                                        let v930: std::pin::Pin<
                                            Box<
                                                dyn std::future::Future<
                                        ...
                                        > = Spiral_builder::method20(
                                            v0_1.clone(),
                                            clap::Command::get_matches_from(v859, v927),
                                        );
                                        let v932: Result<string, string> = v930.await;
                                        v932.unwrap()
                                    }
                                    _ => string("{}"),
                                },
                            ...
                            if (fable_library_rust::String_::fromString(v25.clone()))
                                == string("dib")
                            {
                                let v955: string = Spiral_builder::method142();
                                let v958: &str = &*v955;
                                let v981: Option<std::string::String> =
                                    clap::ArgMatches::get_one(&v26.clone(), v958).cloned();
                                let v983: Option<string> = map(Spiral_builder::method143(), v981);
                                let v997: string = v983.unwrap();
                                let v998: string = Spiral_builder::method168();
                                let v1001: &str = &*v998;
                                let v1025: u8 = defaultValue(
                                    1_u8,
                                    clap::ArgMatches::get_one(&v26.clone(), v1001).cloned(),
                                );
                                let v1028: string = Spiral_builder::method169();
                                let v1031: &str = &*v1028;
                                let v1054: Option<string> =
                                    clap::ArgMatches::get_one(&v26.clone(), v1031).cloned();
                                let patternInput_5: (i32, string) = Spiral_builder::method170(
                                    defaultValue(
                                        Spiral_builder::US5::US5_1,
                                        map(Spiral_builder::method6(), v1054),
                                    ),
                                    v1025,
                                    v997.clone(),
                                    1_u8,
                                );
                                let v1074: string = patternInput_5.1.clone();
                                let v1073: i32 = patternInput_5.0.clone();
                                let patternInput_8: (i32, string) = if (v1073) != 0_i32 {
                                    (v1073, v1074.clone())
                                } else {
                                    ...
                                    let v1086: string = patternInput_6.1.clone();
                                    let v1085: i32 = patternInput_6.0.clone();
                                    let v1089: () = {
                                        Spiral_builder::closure78(v1086.clone(), v1085, ());
                                        ()
                                    };
                                    if (v1085) != 0_i32 {
                                        (
                                        ...
                                        let patternInput_7:
                                                ...
                                                Spiral_builder::method68(concat(new_array(&[string("pwsh -c \"$counter = 1; $path = \'"),
                                                                         ...
                                                                         true,
                                                                         None::<string>);
                                        let v1145: string = patternInput_7.1.clone();
                                        let v1144: i32 = patternInput_7.0.clone();
                                        let v1148: () = {
                                            Spiral_builder::closure79(v1145.clone(), v1144, ());
                                            ()
                                        };
                                        let v1189: string =
                                            concat(new_array(&[v997.clone(), string(".html")]));
                                        let v1193: Result<Vec<u8>, std::io::Error> =
                                            std::fs::read(&*v1189);
                                        let v1231: Vec<u8> =
                                            Spiral_builder::method27(v1193.unwrap());
                                        let v1233: Result<
                                            std::string::String,
                                            std::string::FromUtf8Error,
                                        > = std::string::String::from_utf8(v1231);
                                        let v1236: std::string::String = v1233.unwrap();
                                        let v1273: string = replace(
                                            fable_library_rust::String_::fromString(v1236),
                                            string("\r\n"),
                                            string("\n"),
                                        );
                                        let v1274: string =
                                            concat(new_array(&[v997.clone(), string(".html")]));
                                        std::fs::write(&*v1274, &*v1273).unwrap();
                                        ();
                                        {
                                            let v1278: string = concat(new_array(&[
                                                v997.clone(),
                                                string(".ipynb"),
                                            ]));
                                            let v1282: Result<Vec<u8>, std::io::Error> =
                                                std::fs::read(&*v1278);
                                            let v1320: Vec<u8> =
                                                Spiral_builder::method27(v1282.unwrap());
                                            let v1322: Result<
                                                std::string::String,
                                                std::string::FromUtf8Error,
                                            > = std::string::String::from_utf8(v1320);
                                            let v1325: std::string::String = v1322.unwrap();
                                            let v1363: string = replace(
                                                replace(
                                                    fable_library_rust::String_::fromString(v1325),
                                                    string("\r\n"),
                                                    string("\n"),
                                                ),
                                                string("\\r\\n"),
                                            ...
                                            let v1364: string =
                                                concat(new_array(&[v997, string(".ipynb")]));
                                            std::fs::write(&*v1364, &*v1363).unwrap();
                                            ();
                                            (v1144,
                                ...
                                let v1375: () = {
                                    Spiral_builder::closure80(v1372.clone(), v1371, ());
                                    ()
                                };
                                if (v1371) != 0_i32 {
                                    panic!(
                                ...
                                let patternInput_31: (
                                    ...
                                    == string("rust")
                                {
                                    let v1425: string = Spiral_builder::method140();
                                    let v1428: &str = &*v1425;
                                    ...
                                    let v1525: string = Spiral_builder::method179();
                                    let v1528: &str = &*v1525;
                                    let v1551: bool =
                                        clap::ArgMatches::get_flag(&v26.clone(), v1528);
                                    let v1552: string = Spiral_builder::method180();
                                    let v1555: &str = &*v1552;
                                    ...
                                    let v1603: string = Spiral_builder::method181();
                                    let v1606: &str = &*v1603;
                                    ...
                                    let v1799: Spiral_builder::US5 = match &v1751 {
                                        ...
                                        Spiral_builder::US12::US12_1(v1751_1_0) => {
                                            let v1757: () = {
                                                Spiral_builder::closure16(v1751_1_0.clone(), ());
                                                ()
                                            };
                                            Spiral_builder::US5::US5_1
                                        }
                                    ...
                                    let v1854: Spiral_builder::US5 = match &v1799 {
                                        ...
                                        _ => {
                                            let v1802: string = Spiral_builder::method39();
                                    ...
                                    let v1862: string = toLower(Spiral_builder::method39());
                                    ...
                                    if (Spiral_builder::method43(v1902.clone())) == false {
                                        let v1906: DateTime = DateTime::now();
                                        let v1926: string =
                                            toString(Spiral_builder::method190(new_guid(), v1906));
                                        let v1951: string =
                                                append((append((append((append((append((append((append((append((append((append((append((append((append(string("[package]\n"),
                                                                                                                                                       (concat(new_array(&[string("name = \"spiral_builder_"),
                                                                                                                                                                           v1926.clone(),
                                    ...
                                    {
                                        let v1955: string = Spiral_builder::method28(
                                            v1893.clone(),
                                            string("Cargo.toml"),
                                        );
                                        if (Spiral_builder::method43(v1955.clone())) == false {
                                            let v1959: DateTime = DateTime::now();
                                            let v1979: string = toString(
                                                Spiral_builder::method190(new_guid(), v1959),
                                            );
                                            let v2004: string =
                                                    append((append((append((append((append((append((append((append((append((append((append((append((append(string("[package]\n"),
                                                                                                                                                           (concat(new_array(&[string("name = \"spiral_builder_"),
                                                                   ...
                                                                   string("\n"))),
                                                           string("path = \"spiral_builder.rs\""));
                                            std::fs::write(&*v1955.clone(), &*v2004).unwrap();
                                            ();
                                            ()
                                        }
                                        {
                                            ...
                                            let v2011: string = Spiral_builder::method28(
                                                v1893.clone(),
                                                string("fable_modules/fable-library-rust"),
                                            );
                                            Spiral_builder::method195(v2009, v2011.clone());
                                            {
                                                ...
                                                let v2013: string = patternInput_9.1.clone();
                                                let v2012: i32 = patternInput_9.0.clone();
                                                let patternInput_18: (
                                                    Spiral_builder::US5,
                                                    Spiral_builder::US5,
                                                    Spiral_builder::US5,
                                                    ...
                                                    (
                                                        ...
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_0(v2013),
                                                    )
                                                } else {
                                                    let v2139: Vec<std::string::String> =
                                                            ...
                                                            &v1662
                                                        {
                                                            ...
                                                            let v2064 = Spiral_builder::method206();
                                                    ...
                                                    let v2141: bool = true;
                                                    let _vec_map : Vec<_> = v2139.into_iter().map(|x| { //;
                                                            let v2143:
                                                                    std::string::String =
                                                                x;
                                                            let v2145:
                                                                    string =
                                                                fable_library_rust::String_::fromString(v2143);
                                                            let v2160:
                                                                    string =
                                                                if contains(v2145.clone(),
                                                                            string("="))
                                                                   {
                                                                    v2145.clone()
                                                                } else {
                                                                    if endsWith3(v2145.clone(),
                                                                                 string("]"),
                                                                                 false)
                                                                       {
                                                                        concat(new_array(&[replace(v2145.clone(),
                                                                                                   string("["),
                                                                                                   string("={version=\'*\',features=[")),
                                                                                           string("}")]))
                                                                    } else {
                                                                        concat(new_array(&[v2145,
                                                                                           string("=\'*\'")]))
                                                                    }
                                                                };
                                                            let v2162: bool =
                                                                true; v2160 }).collect::<Vec<_>>();
                                                    let v2164: Vec<string> = _vec_map;
                                                    let v2166:
                                                                    Array<string> =
                                                                fable_library_rust::NativeArray_::array_from(v2164);
                                                    let _v2167: LrcPtr<dyn IEnumerable_1<string>> =
                                                        delay(Func0::new({
                                                            let v2166 = v2166.clone();
                                                            move || {
                                                                map_1(
                                                                    Func1::new({
                                                                        let v2166 = v2166.clone();
                                                    ...
                                                    let v2405:
                                                                ...
                                                                append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append((append(string("cargo-features = [\"profile-rustflags\"]\n\n[workspace]\nresolver = \"2\"\nmembers = [\"packages/Rust/*\"]\n\n[workspace.dependencies.fable_library_rust]\n"),
                                                                                                                                                                                                                                                                                                       (concat(new_array(&[string("path = \""),
                                                                                                                                                                                                                                                                                                                           Spiral_builder::method147(v1888.clone()),
                                                                                                                                                                                                                                                                                                                           string("/lib/rust/fable/fable_modules/fable-library-rust\"")]))))),
                                                                                                                                                                                                                                                                                               string("\n"))),
                                                    ...
                                                    Spiral_builder::method41(v1955.clone(), v2340);
                                                    Spiral_builder::method41(v1902, v2405);
                                                    {
                                                        let v2407: string =
                                                            Spiral_builder::method28(
                                                                v2011,
                                                        ...
                                                        if Spiral_builder::method43(v2407.clone()) {
                                                            let v2412: Result<
                                                                Vec<u8>,
                                                                std::io::Error,
                                                            ...
                                                            }
                                                            {
                                                                                        ...
                                                                                        false
                                                                                    {
                                                                                     ...
                                                                                     Func1::new({
                                                                                                    ...
                                                                                                    move
                                                                                                        |v_6:
                                                                                                             string|
                                                                                                        Spiral_builder::closure90(v2755.clone(),
                                                                                                                                  v_6)
                                                                                                })
                                                                                 })((if v2277
                                                                                        {
                                                                                         ...
                                                                                         Func1::new({
                                                                                                        ...
                                                                                                        move
                                                                                                            |v_4:
                                                                                                                 string|
                                                                                                            Spiral_builder::closure89(v2266.clone(),
                                                                                                                                      v2747.clone(),
                                                                                                                                      v_4)
                                                                                                    })
                                                                                     })(replace(replace(replace(replace(replace(replace(replace(replace(replace(Spiral_builder::method163(string("\\s\\sdefaultOf\\(\\);"),
                                                                                                                                                                                          string(" defaultOf::<()>();"),
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    let patternInput_11:
                                                                                    (i32,
                                                                                     string) =
                                                                                Spiral_builder::method68(v2765.clone(),
                                                                                                         None::<CancellationToken>,
                                                                                                         v2778.clone(),
                                                                                                         None::<Func1<(i32,
                                                                                                                       string,
                                                                                   ...
                                                                                   }
                                                                                   {
                                                                                    ...
                                                                                    let v2810:
                                                                                        ...
                                                                                        LrcPtr::new(Spiral_builder::Mut5{l0:
                                                                                                                             MutCell::new(0_i32),});
                                                                                    while Spiral_builder::method72(v2808,
                                                                                                                   v2810.clone())
                                                                                          {
                                                                                        let v2812:
                                                                                                i32 =
                                                                                            ...
                                                                                            concat(new_array(&[string("pwsh -c \'"),
                                                                                                               join(string(";"),
                                                                                                                    toArray_1(ofArray_1(new_array(&[join(string(";"),
                                                                                                                                                         toArray_1(ofArray_1(v2809.clone()))),
                                                                                                                                                    v2765])))),
                                                                                                               string("\'")]));
                                                                                        let patternInput_13:
                                                                                                (Spiral_builder::US5,
                                                                                            ...
                                                                                            if (v2805)
                                                                                                   ...
                                                                                                   0_i32
                                                                                               {
                                                                                                let v2841:
                                                                                                        () =
                                                                                                    {
                                                                                                        Spiral_builder::closure91(v1551,
                                                                                                                                  v2182.clone(),
                                                                                                                                  v2806.clone(),
                                                                                                                                  v2805,
                                                                                                                                  v2835.clone(),
                                                                                                ...
                                                                                                try_catch(||
                                                                                                              result_1.set(Spiral_builder::closure62((),
                                                                                                                                                     Spiral_builder::closure92(v2806.clone(),
                                                                                                                                                                               ()))),
                                                                                                          |ex_1:
                                                                                                               LrcPtr<Exception>|
                                                                                                              result_1.set(Spiral_builder::closure94(v2182.clone(),
                                                                                                                                                     v2806.clone(),
                                                                                                                                                     v2835,
                                                                                                                                                     ex_1.clone())));
                                                                                                {
                                                                                                    ...
                                                                                                    let v2899:
                                                                                                        ...
                                                                                                        match &v2889
                                                                                                            {
                                                                                                            Spiral_builder::US5::US5_0(v2889_0_0)
                                                                                                            =>
                                                                                                            Some(match &v2889
                                                                                                                     {
                                                                                                    ...
                                                                                                    (Spiral_builder::US5::US5_0(string("rs")),
                                                                                                     Spiral_builder::US5::US5_0(v2759.clone()),
                                                                                                     Spiral_builder::US5::US5_0(v2182.clone()),
                                                                                                     Spiral_builder::US5::US5_0(v2899.unwrap()))
                                                                                                }
                                                                                            };
                                                                                                 ...
                                                                                                 sprintf!("\'workspace/target/release/spiral_wasm -w {} -t Debug {}\'",
                                                                                                          ...
                                                                                                          if let Spiral_builder::US35::US35_0(v1662_0_0)
                                                                                                                 ...
                                                                                                                 &v1662
                                                                                                             {
                                                                                                              ...
                                                                                                              match &v2911
                                                                                                                  {
                                                                                                                  Spiral_builder::US36::US36_0(v2911_0_0)
                                                                                                                  =>
                                                                                                                  v2911_0_0.clone(),
                                                                                                                  Spiral_builder::US36::US36_1(v2911_1_0)
                                                                                                                  =>
                                                                                                                  v2911_1_0.clone(),
                                                                                                              }
                                                                                                          } else {
                                                                                        ...
                                                                                        if (v2805)
                                                                                               ...
                                                                                               0_i32
                                                                                           {
                                                                                            let patternInput_14:
                                                                                                    (i32,
                                                                                                     string) =
                                                                                                Spiral_builder::method68(v2922.clone(),
                                                                                                                         None::<CancellationToken>,
                                                                                                                         new_empty::<(string,
                                                                                                                                      string)>(),
                                                                                                                         None::<Func1<(i32,
                                                                                            ...
                                                                                            let patternInput_15:
                                                                                                ...
                                                                                                if (v2933)
                                                                                                   ...
                                                                                                   {
                                                                                                    (Spiral_builder::US5::US5_0(string("rs")),
                                                                                                     Spiral_builder::US5::US5_0(v2759),
                                                                                                     Spiral_builder::US5::US5_0(v2182.clone()),
                                                                                                     Spiral_builder::US5::US5_0(v2934.clone()))
                                                                                                } else {
                                                                                                    let v2942:
                                                                                                            () =
                                                                                                        {
                                                                                            ...
                                                                                            let v2993:
                                                                                                    () =
                                                                                                {
                                                                                                    Spiral_builder::closure97(v1551,
                                                                                                                              v2182.clone(),
                                                                                                                              v2806,
                                                                                                                              v2805,
                                                                                                                              v2910,
                                                                    ...
                                                                    if v1551 {
                                                                        ...
                                                                        let v3066:
                                                                                        bool =
                                                                                    Spiral_builder::method43(v3053.clone());
                                                                        let v3067:
                                                                                        bool =
                                                                                    Spiral_builder::method43(v3056.clone());
                                                                        let v3068:
                                                                                        bool =
                                                                                    Spiral_builder::method43(v3059.clone());
                                                                        let v3069:
                                                                                        bool =
                                                                                    Spiral_builder::method43(v3062.clone());
                                                                        let v3070:
                                                                                        bool =
                                                                                    Spiral_builder::method43(v3065.clone());
                                                                        let v3073: () = {
                                                                            Spiral_builder::closure98(v2182,
                                                                                                                  v3065.clone(),
                                                                                                                  v3070,
                                                                                                                  v3062.clone(),
                                                                                                                  v3069,
                                                                        ...
                                                                        let v3116: LrcPtr<
                                                                            Spiral_builder::UH4,
                                                                        > = if v3066 {
                                                                            LrcPtr::new(Spiral_builder::UH4::UH4_1(v3053,
                                                                                                                               v3066,
                                                                                                                               LrcPtr::new(Spiral_builder::UH4::UH4_0)))
                                                                        } else {
                                                                            LrcPtr::new(Spiral_builder::UH4::UH4_0)
                                                                        ...
                                                                        let v3118: LrcPtr<
                                                                            Spiral_builder::UH4,
                                                                        > = if v3067 {
                                                                            LrcPtr::new(Spiral_builder::UH4::UH4_1(v3056,
                                                                                                                               v3067,
                                                                                                                               v3116.clone()))
                                                                        } else {
                                                                            v3116
                                                                        ...
                                                                        let v3120: LrcPtr<
                                                                            Spiral_builder::UH4,
                                                                        > = if v3068 {
                                                                            LrcPtr::new(Spiral_builder::UH4::UH4_1(v3059,
                                                                                                                               v3068,
                                                                                                                               v3118.clone()))
                                                                        } else {
                                                                            v3118
                                                                        ...
                                                                        let v3122: LrcPtr<
                                                                            Spiral_builder::UH4,
                                                                        > = if v3069 {
                                                                            LrcPtr::new(Spiral_builder::UH4::UH4_1(v3062,
                                                                                                                               v3069,
                                                                                                                               v3120.clone()))
                                                                        } else {
                                                                            v3120
                                    ...
                                    let patternInput_30: (
                                        ...
                                        == string("typescript")
                                    {
                                        let v3132: string = Spiral_builder::method140();
                                        let v3135: &str = &*v3132;
                                        let v3158: Option<std::string::String> =
                                            clap::ArgMatches::get_one(&v26.clone(), v3135).cloned();
                                        let v3172: Spiral_builder::US7 = defaultValue(
                                            Spiral_builder::US7::US7_1,
                                            map(Spiral_builder::method23(), v3158),
                                        );
                                        let v3179: std::string::String = match &v3172 {
                                            Spiral_builder::US7::US7_0(v3172_0_0) => match &v3172 {
                                                Spiral_builder::US7::US7_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                            .clone(),
                                        ...
                                        let v3182: string = Spiral_builder::method25();
                                        let v3185: &str = &*v3182;
                                        let v3208: Option<Vec<std::string::String>> =
                                            clap::ArgMatches::get_many(&v26.clone(), v3185)
                                                .map(|x| x.cloned().into_iter().collect());
                                        let v3222: Spiral_builder::US11 = defaultValue(
                                            Spiral_builder::US11::US11_1,
                                            map(Spiral_builder::method26(), v3208),
                                        );
                                        let v3228: Vec<std::string::String> =
                                            new_empty::<std::string::String>().to_vec();
                                        let v3231: Vec<std::string::String> = match &v3222 {
                                            Spiral_builder::US11::US11_0(v3222_0_0) => match &v3222
                                            {
                                                Spiral_builder::US11::US11_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                        ...
                                        let v3235: Result<Vec<u8>, std::io::Error> =
                                            std::fs::read(&*v3181);
                                        let v3273: Vec<u8> =
                                            Spiral_builder::method27(v3235.unwrap());
                                        let v3275: Result<
                                            std::string::String,
                                            std::string::FromUtf8Error,
                                        > = std::string::String::from_utf8(v3273);
                                        let v3278: std::string::String = v3275.unwrap();
                                        let v3308: string =
                                            fable_library_rust::String_::fromString(v3278);
                                        let v3317: string = Spiral_builder::method183(sprintf!(
                                            "{:?}",
                                            (string("ts"), v3308.clone())
                                        ));
                                        let v3322:
                                                        Spiral_builder::US12 =
                                                    Spiral_builder::method31(Spiral_builder::method28(string("polyglot"),
                                                                                                      string(".devcontainer")),
                                                                             string("C:\\home\\git\\polyglot\\target\\Builder\\spiral_builder"));
                                        let v3370: Spiral_builder::US5 = match &v3322 {
                                            Spiral_builder::US12::US12_0(v3322_0_0) => {
                                                Spiral_builder::US5::US5_0(v3322_0_0.clone())
                                            }
                                            Spiral_builder::US12::US12_1(v3322_1_0) => {
                                                let v3328: () = {
                                                    Spiral_builder::closure16(
                                                        v3322_1_0.clone(),
                                                        (),
                                        ...
                                        let v3425: Spiral_builder::US5 = match &v3370 {
                                            Spiral_builder::US5::US5_0(v3370_0_0) => {
                                                Spiral_builder::US5::US5_0(
                                                    match &v3370 {
                                                        Spiral_builder::US5::US5_0(x) => x.clone(),
                                                        _ => unreachable!(),
                                            ...
                                            _ => {
                                                let v3373: string = Spiral_builder::method39();
                                                let v3375: Spiral_builder::US12 =
                                                    Spiral_builder::method31(
                                                        Spiral_builder::method28(
                                                            string("polyglot"),
                                                            string(".devcontainer"),
                                                ...
                                                match &v3375 {
                                                    Spiral_builder::US12::US12_0(v3375_0_0) => {
                                                        Spiral_builder::US5::US5_0(
                                                            v3375_0_0.clone(),
                                                        )
                                                    }
                                                    Spiral_builder::US12::US12_1(v3375_1_0) => {
                                                        let v3381: () = {
                                                            Spiral_builder::closure16(
                                                                v3375_1_0.clone(),
                                                                (),
                                        ...
                                        let v3430: string = Spiral_builder::method28(
                                            match &v3425 {
                                                Spiral_builder::US5::US5_0(v3425_0_0) => {
                                                    match &v3425 {
                                                        Spiral_builder::US5::US5_0(x) => x.clone(),
                                                        _ => unreachable!(),
                                                    }
                                        ...
                                        let v3433: string = toLower(Spiral_builder::method39());
                                        let v3437: string = toLower(v3430);
                                        let v3445: Spiral_builder::US12 =
                                            if startsWith3(v3433, v3437.clone(), false) {
                                                Spiral_builder::US12::US12_1(v3437.clone())
                                            } else {
                                                Spiral_builder::US12::US12_0(v3437)
                                            };
                                        let v3451: Result<string, string> = match &v3445 {
                                            Spiral_builder::US12::US12_0(v3445_0_0) => {
                                                Ok::<string, string>(v3445_0_0.clone())
                                            }
                                            Spiral_builder::US12::US12_1(v3445_1_0) => {
                                                Err::<string, string>(v3445_1_0.clone())
                                            }
                                        };
                                        let v3453: bool = true;
                                        let _result_unwrap_or_else = v3451.unwrap_or_else(|x| {
                                            //;
                                            let v3455: string = x;
                                            let v3457: bool = true;
                                            v3455
                                        });
                                        let v3459: string = _result_unwrap_or_else;
                                        let v3464: string = Spiral_builder::method186(
                                            Spiral_builder::US5::US5_0(v3317.clone()),
                                            string("spiral_builder"),
                                        ...
                                        let v3469: string = Spiral_builder::method187(
                                            v3308,
                                            string("spiral_builder"),
                                            LrcPtr::new(Spiral_builder::UH2::UH2_0),
                                            LrcPtr::new(Spiral_builder::UH2::UH2_1(
                                        ...
                                        let v3471: string = Spiral_builder::method28(
                                            v3459.clone(),
                                            string("lib/typescript/fable/fable_modules"),
                                        );
                                        let v3472: string = concat(new_array(&[
                                            string("fable-library-"),
                                            string("ts"),
                                        ]));
                                        let v3473: string =
                                            Spiral_builder::method230(v3472.clone());
                                        let v3475: async_walkdir::WalkDir =
                                            async_walkdir::WalkDir::new(&*v3471.clone());
                                        let v3478: async_walkdir::WalkDir =
                                            async_walkdir::WalkDir::filter(v3475, move |x| {
                                                Func1::new({
                                                    let v3472 = v3472.clone();
                                        ...
                                        let v3479 = Spiral_builder::method238(v3473);
                                        let v3481 = futures::stream::StreamExt::filter_map(
                                            v3478,
                                            |x| async { v3479(x) },
                                        );
                                        let v3483: std::pin::Pin<
                                            Box<
                                                dyn std::future::Future<
                                                    Output = Vec<(string, string)>,
                                                >,
                                            >,
                                        > = Box::pin(futures::stream::StreamExt::collect(v3481));
                                        let v3485: Vec<(string, string)> = v3483.await;
                                        let v3487: rayon::vec::IntoIter<(string, string)> =
                                            rayon::iter::IntoParallelIterator::into_par_iter(v3485);
                                        let v3490: rayon::iter::Map<
                                            rayon::vec::IntoIter<(string, string)>,
                                            _,
                                        > = rayon::iter::ParallelIterator::map(v3487, |x| {
                                            Func1::new(move |arg10_0040_20: (string, string)| {
                                                Spiral_builder::closure107((), arg10_0040_20)
                                            })(x)
                                        });
                                        let v3492: Vec<(string, string)> =
                                            rayon::iter::ParallelIterator::collect(v3490);
                                        let v3495: Option<(string, string)> = tryItem(
                                            0_i32,
                                            fable_library_rust::NativeArray_::array_from(v3492),
                                        );
                                        let v3510: Spiral_builder::US46 = defaultValue(
                                            Spiral_builder::US46::US46_1,
                                            map(Spiral_builder::method243(), v3495),
                                        );
                                        let v3516: () = {
                                            Spiral_builder::closure109(v3510.clone(), ());
                                            ()
                                        };
                                        ...
                                        );
                                        {
                                            ...
                                            let v3558: string = patternInput_19.1.clone();
                                            let v3557: i32 = patternInput_19.0.clone();
                                            Spiral_builder::method246(
                                                v3464.clone(),
                                                v3471,
                                                v3510.clone(),
                                            );
                                            {
                                                let patternInput_23: (
                                                    ...
                                                    (
                                                        ...
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_0(v3558),
                                                    )
                                                } else {
                                                    let v3609: bool = true;
                                                    let _vec_map : Vec<_> = v3231.into_iter().map(|x| { //;
                                                                let v3611:
                                                                        std::string::String =
                                                                    x;
                                                                let v3613:
                                                                        string =
                                                                    fable_library_rust::String_::fromString(v3611);
                                                                let v3619:
                                                                        string =
                                                                    if contains(v3613.clone(),
                                                                                string("="))
                                                                       {
                                                                        v3613.clone()
                                                                    } else {
                                                                ...
                                                                let v3621:
                                                                        bool =
                                                                    true; v3619 }).collect::<Vec<_>>();
                                                    let v3623: Vec<string> = _vec_map;
                                                    let v3625:
                                                                        Array<string> =
                                                                    fable_library_rust::NativeArray_::array_from(v3623);
                                                    let v3636: string = join(
                                                        string(",\n"),
                                                        toArray_1(delay(Func0::new({
                                                            let v3625 = v3625.clone();
                                                            move || {
                                                                map_1(
                                                                    Func1::new({
                                                                        let v3625 = v3625.clone();
                                                    ...
                                                    let v3652:
                                                                    ...
                                                                    append((append((append((append((append((append((append(string("{"),
                                                                                   ...
                                                                                   string("  },"))),
                                                                           string("}"));
                                                    let v3654: string = Spiral_builder::method28(
                                                        v3464.clone(),
                                                        string("package.json"),
                                                    );
                                                    let v3657: string = Spiral_builder::method28(
                                                        Spiral_builder::method28(
                                                            v3464.clone(),
                                                            string("../.."),
                                                        ),
                                                    ...
                                                    Spiral_builder::method41(v3654, v3652);
                                                    Spiral_builder::method41(v3657, string(""));
                                                    {
                                                        let v3660: string =
                                                            Spiral_builder::method28(
                                                                v3464,
                                                        ...
                                                        let v3706: Result<Vec<u8>, std::io::Error> =
                                                            std::fs::read(&*v3660.clone());
                                                        let v3744: Vec<u8> =
                                                            Spiral_builder::method27(
                                                                v3706.unwrap(),
                                                            );
                                                        let v3746: Result<
                                                            std::string::String,
                                                            std::string::FromUtf8Error,
                                                        > = std::string::String::from_utf8(v3744);
                                                        let v3749: std::string::String =
                                                            v3746.unwrap();
                                                        let v3779: string =
                                                            fable_library_rust::String_::fromString(
                                                                v3749,
                                                        ...
                                                        let v3785:
                                                                            bool =
                                                                        contains(v3779.clone(),
                                                                                 string("// spiral_builder.process_typescript"));
                                                        let v3794: string = if v3785 {
                                                            v3779.clone()
                                                        } else {
                                                        ...
                                                        if (v3785) == false {
                                                            Spiral_builder::method41(v3660.clone(),
                                                                                                 concat(new_array(&[v3794.clone(),
                                                                                                                    string("\n\n"),
                                                                                                                    string("// spiral_builder.process_typescript"),
                                                                                                                    string("\n")])));
                                                        }
                                                        {
                                                            ...
                                                            let v3835: Spiral_builder::US5 =
                                                                if (v3799.clone()) == string("") {
                                                                    Spiral_builder::US5::US5_1
                                                                } else {
                                                                    Spiral_builder::US5::US5_0(
                                                                        concat(new_array(&[
                                                            ...
                                                            let v3850:
                                                                                Array<(string,
                                                                                       string)> =
                                                                            toArray(Spiral_builder::method251(Spiral_builder::method250(match &v3835
                                                                                                                                            {
                                                                                                                                            Spiral_builder::US5::US5_0(v3835_0_0)
                                                                                                                                            =>
                                                            ...
                                                            let v3863:
                                                                            ...
                                                                            match &v3445
                                                                                ...
                                                                                =>
                                                                                Ok::<string,
                                                                                     string>(v3445_0_0.clone()),
                                                                                Spiral_builder::US12::US12_1(v3445_1_0)
                                                                                =>
                                                                                Err::<string,
                                                                                      string>(v3445_1_0.clone()),
                                                                            };
                                                            let patternInput_20:
                                                                                (i32,
                                                                                 string) =
                                                                            Spiral_builder::method68(v3797.clone(),
                                                                                                     None::<CancellationToken>,
                                                                                                     v3850.clone(),
                                                                                                     None::<Func1<(i32,
                                                                                                                   string,
                                                            ...
                                                            let v3881: i32 =
                                                                get_Count(v3850.clone());
                                                            let v3882: Array<string> =
                                                                new_init(&string(""), v3881);
                                                            let v3883: LrcPtr<
                                                                Spiral_builder::Mut5,
                                                            > = LrcPtr::new(Spiral_builder::Mut5 {
                                                                l0: MutCell::new(0_i32),
                                                            ...
                                                            while Spiral_builder::method72(
                                                                ...
                                                                let v3888: string = sprintf!(
                                                                    "$env:{}=\'\'{}\'\'",
                                                                    patternInput_21.0.clone(),
                                                                    patternInput_21.1.clone()
                                                                );
                                                                v3882.get_mut()[v3885 as usize] =
                                                                    v3888;
                                                                {
                                                                    let v3889: i32 =
                                                                        (v3885) + 1_i32;
                                                                ...
                                                                let patternInput_22: (
                                                                    ...
                                                                    try_catch(||
                                                                                                  result_2.set(Spiral_builder::closure62((),
                                                                                                                                         Spiral_builder::closure112(v3880.clone(),
                                                                                                                                                                    ()))),
                                                                                              |ex_2:
                                                                                                   LrcPtr<Exception>|
                                                                                                  result_2.set(Spiral_builder::closure113(v3660.clone(),
                                                                                                                                          v3880.clone(),
                                                                                                                                          v3899.clone(),
                                                                                                                                          ex_2.clone())));
                                                                    {
                                                                        ...
                                                                        let v3915:
                                                                                            ...
                                                                                            match &v3905
                                                                                                {
                                                                                                Spiral_builder::US5::US5_0(v3905_0_0)
                                                                                                =>
                                                                                                Some(match &v3905
                                                                                                         {
                                                                                                         Spiral_builder::US5::US5_0(x)
                                                                        ...
                                                                        (Spiral_builder::US5::US5_0(string("ts")),
                                                                                         Spiral_builder::US5::US5_0(v3794),
                                                                                         Spiral_builder::US5::US5_0(v3660.clone()),
                                                                                         Spiral_builder::US5::US5_0(v3915.unwrap()))
                                                                    }
                                                                } else {
                                                                    let v3924: () = {
                                        ...
                                        {
                                            let v3979: string = Spiral_builder::method140();
                                            let v3982: &str = &*v3979;
                                            let v4005: Option<std::string::String> =
                                                clap::ArgMatches::get_one(&v26.clone(), v3982)
                                                    .cloned();
                                            let v4019: Spiral_builder::US7 = defaultValue(
                                                Spiral_builder::US7::US7_1,
                                                map(Spiral_builder::method23(), v4005),
                                            );
                                            let v4026: std::string::String = match &v4019 {
                                                Spiral_builder::US7::US7_0(v4019_0_0) => {
                                                    match &v4019 {
                                                        Spiral_builder::US7::US7_0(x) => x.clone(),
                                                        _ => unreachable!(),
                                                    }
                                            ...
                                            let v4028: string =
                                                fable_library_rust::String_::fromString(v4026);
                                            let v4029: string = Spiral_builder::method25();
                                            let v4032: &str = &*v4029;
                                            let v4055: Option<Vec<std::string::String>> =
                                                clap::ArgMatches::get_many(&v26.clone(), v4032)
                                                    .map(|x| x.cloned().into_iter().collect());
                                            let v4069: Spiral_builder::US11 = defaultValue(
                                                Spiral_builder::US11::US11_1,
                                                map(Spiral_builder::method26(), v4055),
                                            );
                                            let v4075: Vec<std::string::String> =
                                                new_empty::<std::string::String>().to_vec();
                                            let v4078: Vec<std::string::String> = match &v4069 {
                                                Spiral_builder::US11::US11_0(v4069_0_0) => {
                                                    match &v4069 {
                                            ...
                                            let v4083: Result<Vec<u8>, std::io::Error> =
                                                std::fs::read(&*v4028);
                                            let v4121: Vec<u8> =
                                                Spiral_builder::method27(v4083.unwrap());
                                            let v4123: Result<
                                                std::string::String,
                                                std::string::FromUtf8Error,
                                            > = std::string::String::from_utf8(v4121);
                                            let v4126: std::string::String = v4123.unwrap();
                                            let v4156: string =
                                                fable_library_rust::String_::fromString(v4126);
                                            let v4165: string = Spiral_builder::method183(
                                                sprintf!("{:?}", (string("py"), v4156.clone())),
                                            );
                                            let v4170:
                                                                Spiral_builder::US12 =
                                                            Spiral_builder::method31(Spiral_builder::method28(string("polyglot"),
                                                                                                              string(".devcontainer")),
                                                                                     string("C:\\home\\git\\polyglot\\target\\Builder\\spiral_builder"));
                                            let v4218: Spiral_builder::US5 = match &v4170 {
                                                Spiral_builder::US12::US12_0(v4170_0_0) => {
                                                    Spiral_builder::US5::US5_0(v4170_0_0.clone())
                                                }
                                                Spiral_builder::US12::US12_1(v4170_1_0) => {
                                                    let v4176: () = {
                                                        Spiral_builder::closure16(
                                                            v4170_1_0.clone(),
                                                            (),
                                            ...
                                            let v4273: Spiral_builder::US5 = match &v4218 {
                                                Spiral_builder::US5::US5_0(v4218_0_0) => {
                                                    Spiral_builder::US5::US5_0(
                                                        match &v4218 {
                                                            Spiral_builder::US5::US5_0(x) => {
                                                                x.clone()
                                                ...
                                                _ => {
                                                    let v4221: string = Spiral_builder::method39();
                                                    let v4223: Spiral_builder::US12 =
                                                        Spiral_builder::method31(
                                                            Spiral_builder::method28(
                                                                string("polyglot"),
                                                                string(".devcontainer"),
                                                    ...
                                                    match &v4223 {
                                                        Spiral_builder::US12::US12_0(v4223_0_0) => {
                                                            Spiral_builder::US5::US5_0(
                                                                v4223_0_0.clone(),
                                                            )
                                                        }
                                                        Spiral_builder::US12::US12_1(v4223_1_0) => {
                                                            let v4229: () = {
                                                                Spiral_builder::closure16(
                                                                    v4223_1_0.clone(),
                                                                    (),
                                            ...
                                            let v4278: string = Spiral_builder::method28(
                                                match &v4273 {
                                                    Spiral_builder::US5::US5_0(v4273_0_0) => {
                                                        match &v4273 {
                                                            Spiral_builder::US5::US5_0(x) => {
                                                                x.clone()
                                                            }
                                            ...
                                            let v4281: string = toLower(Spiral_builder::method39());
                                            let v4285: string = toLower(v4278);
                                            let v4293: Spiral_builder::US12 =
                                                if startsWith3(v4281, v4285.clone(), false) {
                                                    Spiral_builder::US12::US12_1(v4285.clone())
                                                } else {
                                                    Spiral_builder::US12::US12_0(v4285)
                                                };
                                            let v4299: Result<string, string> = match &v4293 {
                                                Spiral_builder::US12::US12_0(v4293_0_0) => {
                                                    Ok::<string, string>(v4293_0_0.clone())
                                                }
                                                Spiral_builder::US12::US12_1(v4293_1_0) => {
                                                    Err::<string, string>(v4293_1_0.clone())
                                                }
                                            };
                                            let v4301: bool = true;
                                            let _result_unwrap_or_else =
                                                v4299.unwrap_or_else(|x| {
                                                    //;
                                                    let v4303: string = x;
                                                    let v4305: bool = true;
                                                    v4303
                                                });
                                            let v4307: string = _result_unwrap_or_else;
                                            let v4312: string = Spiral_builder::method186(
                                                Spiral_builder::US5::US5_0(v4165.clone()),
                                                string("spiral_builder"),
                                                Spiral_builder::US38::US38_0(
                                            ...
                                            let v4317: string = Spiral_builder::method187(
                                                v4156,
                                                string("spiral_builder"),
                                                LrcPtr::new(Spiral_builder::UH2::UH2_0),
                                                LrcPtr::new(Spiral_builder::UH2::UH2_1(
                                            ...
                                            );
                                            {
                                                ...
                                                let v4326: string = patternInput_24.1.clone();
                                                let v4325: i32 = patternInput_24.0.clone();
                                                let patternInput_28: (
                                                    Spiral_builder::US5,
                                                    Spiral_builder::US5,
                                                    Spiral_builder::US5,
                                                    ...
                                                    (
                                                        ...
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_1,
                                                        Spiral_builder::US5::US5_0(v4326),
                                                    )
                                                } else {
                                                    let v4377: bool = true;
                                                    let _vec_map : Vec<_> = v4078.into_iter().map(|x| { //;
                                                                    let v4379:
                                                                            std::string::String =
                                                                        x;
                                                                    let v4381:
                                                                            string =
                                                                        fable_library_rust::String_::fromString(v4379);
                                                                    let v4387:
                                                                            string =
                                                                        if contains(v4381.clone(),
                                                                                    string("="))
                                                                           {
                                                                            v4381.clone()
                                                                        } else {
                                                                    ...
                                                                    let v4389:
                                                                            bool =
                                                                        true; v4387 }).collect::<Vec<_>>();
                                                    let v4391: Vec<string> = _vec_map;
                                                    let v4393:
                                                                            Array<string> =
                                                                        fable_library_rust::NativeArray_::array_from(v4391);
                                                    let v4404: string = join(
                                                        string(",\n"),
                                                        toArray_1(delay(Func0::new({
                                                            let v4393 = v4393.clone();
                                                            move || {
                                                                map_1(
                                                                    Func1::new({
                                                                        let v4393 = v4393.clone();
                                                    ...
                                                    let v4420:
                                                                        ...
                                                                        append((append((append((append((append((append((append(string("{"),
                                                                                       ...
                                                                                       string("  },"))),
                                                                               string("}"));
                                                    let v4422: string = Spiral_builder::method28(
                                                        v4312.clone(),
                                                        string("package.json"),
                                                    );
                                                    let v4425: string = Spiral_builder::method28(
                                                        Spiral_builder::method28(
                                                            v4312.clone(),
                                                            string("../.."),
                                                        ),
                                                    ...
                                                    Spiral_builder::method41(v4422, v4420);
                                                    Spiral_builder::method41(v4425, string(""));
                                                    {
                                                        let v4428: string =
                                                            Spiral_builder::method28(
                                                                v4312,
                                                        ...
                                                        let v4474: Result<Vec<u8>, std::io::Error> =
                                                            std::fs::read(&*v4428.clone());
                                                        let v4512: Vec<u8> =
                                                            Spiral_builder::method27(
                                                                v4474.unwrap(),
                                                            );
                                                        let v4514: Result<
                                                            std::string::String,
                                                            std::string::FromUtf8Error,
                                                        > = std::string::String::from_utf8(v4512);
                                                        let v4517: std::string::String =
                                                            v4514.unwrap();
                                                        let v4547: string =
                                                            fable_library_rust::String_::fromString(
                                                                v4517,
                                                            );
                                                        let v4553: bool = contains(
                                                            v4547.clone(),
                                                            string(
                                                                "# spiral_builder.process_python",
                                                            ),
                                                        );
                                                        let v4565: string = if v4553 {
                                                            v4547.clone()
                                                        } else {
                                                        ...
                                                        if (v4553) == false {
                                                            Spiral_builder::method41(v4428.clone(),
                                                                                                     concat(new_array(&[v4565.clone(),
                                                                                                                        string("\n\n"),
                                                                                                                        string("# spiral_builder.process_python"),
                                                                                                                        string("\n")])));
                                                        }
                                                        {
                                                            ...
                                                            let v4582:
                                                                                ...
                                                                                match &v4293
                                                                                    ...
                                                                                    =>
                                                                                    Ok::<string,
                                                                                         string>(v4293_0_0.clone()),
                                                                                    Spiral_builder::US12::US12_1(v4293_1_0)
                                                                                    =>
                                                                                    Err::<string,
                                                                                          string>(v4293_1_0.clone()),
                                                                                };
                                                            let patternInput_25:
                                                                                    (i32,
                                                                                     string) =
                                                                                Spiral_builder::method68(v4568.clone(),
                                                                                                         None::<CancellationToken>,
                                                                                                         v4571.clone(),
                                                                                                         None::<Func1<(i32,
                                                                                                                       string,
                                                            ...
                                                            let v4600: i32 =
                                                                get_Count(v4571.clone());
                                                            let v4601: Array<string> =
                                                                new_init(&string(""), v4600);
                                                            let v4602: LrcPtr<
                                                                Spiral_builder::Mut5,
                                                            > = LrcPtr::new(Spiral_builder::Mut5 {
                                                                l0: MutCell::new(0_i32),
                                                            ...
                                                            while Spiral_builder::method72(
                                                                ...
                                                                let v4607: string = sprintf!(
                                                                    "$env:{}=\'\'{}\'\'",
                                                                    patternInput_26.0.clone(),
                                                                    patternInput_26.1.clone()
                                                                );
                                                                v4601.get_mut()[v4604 as usize] =
                                                                    v4607;
                                                                {
                                                                    let v4608: i32 =
                                                                        (v4604) + 1_i32;
                                                                ...
                                                                let patternInput_27: (
                                                                    ...
                                                                    try_catch(||
                                                                                                      result_3.set(Spiral_builder::closure62((),
                                                                                                                                             Spiral_builder::closure118(v4599.clone(),
                                                                                                                                                                        ()))),
                                                                                                  |ex_3:
                                                                                                       LrcPtr<Exception>|
                                                                                                      result_3.set(Spiral_builder::closure119(v4428.clone(),
                                                                                                                                              v4599.clone(),
                                                                                                                                              v4618.clone(),
                                                                                                                                              ex_3.clone())));
                                                                    {
                                                                        ...
                                                                        let v4634:
                                                                                                ...
                                                                                                match &v4624
                                                                                                    {
                                                                                                    Spiral_builder::US5::US5_0(v4624_0_0)
                                                                                                    =>
                                                                                                    Some(match &v4624
                                                                                                             {
                                                                                                             Spiral_builder::US5::US5_0(x)
                                                                        ...
                                                                        (Spiral_builder::US5::US5_0(string("py")),
                                                                                             Spiral_builder::US5::US5_0(v4565),
                                                                                             Spiral_builder::US5::US5_0(v4428.clone()),
                                                                                             Spiral_builder::US5::US5_0(v4634.unwrap()))
                                                                    }
                                                                } else {
                                                                    let v4643: () = {
                                ...
                                let v4752: Spiral_builder::US5 = patternInput_31.3.clone();
                                let v4751: Spiral_builder::US5 = patternInput_31.2.clone();
                                let v4750: Spiral_builder::US5 = patternInput_31.1.clone();
                                let v4749: Spiral_builder::US5 = patternInput_31.0.clone();
                                new_array(&[
                                    (
                                        string("extension"),
                                        match &v4749 {
                                            Spiral_builder::US5::US5_0(v4749_0_0) => match &v4749 {
                                                Spiral_builder::US5::US5_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                            .clone(),
                                    ...
                                    (
                                        string("code"),
                                        match &v4750 {
                                            Spiral_builder::US5::US5_0(v4750_0_0) => match &v4750 {
                                                Spiral_builder::US5::US5_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                            .clone(),
                                    ...
                                    (
                                        string("code_path"),
                                        match &v4751 {
                                            Spiral_builder::US5::US5_0(v4751_0_0) => match &v4751 {
                                                Spiral_builder::US5::US5_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                            .clone(),
                                    ...
                                    (
                                        string("output"),
                                        match &v4752 {
                                            Spiral_builder::US5::US5_0(v4752_0_0) => match &v4752 {
                                                Spiral_builder::US5::US5_0(x) => x.clone(),
                                                _ => unreachable!(),
                                            }
                                            .clone(),
                ...
                let v4785: Vec<(string, string)> = v4783.to_vec();
                let v4788: Vec<LrcPtr<(std::string::String, std::string::String)>> = v4785
                    .into_iter()
                    .map(|x| {
                    ...
                    .collect::<Vec<_>>();
                let v4789: string =
                string("std::collections::BTreeMap::from_iter(v4788.iter().map(|x| x.as_ref()).map(|&(ref k, ref v)| (k.clone(), v.clone())))");
                let v4790: std::collections::BTreeMap<std::string::String, std::string::String> =
                    std::collections::BTreeMap::from_iter(
                        v4788
                            .iter()
                            .map(|x| x.as_ref())
                ...
                let v4792: Result<std::string::String, serde_json::Error> =
                    serde_json::to_string(&v4790);
                let v4793 = Spiral_builder::method261();
                let v4796: Result<std::string::String, string> = v4792.map_err(|x| v4793(x));
                let v4809: bool = true;
                let _result_map_ = v4796.map(|x| {
                    //;
                    let v4811: std::string::String = x;
                    let v4813: string = fable_library_rust::String_::fromString(v4811);
                    let v4815: bool = true;
                    v4813
                });
                let v4818: Result<string, string> = Spiral_builder::method262(_result_map_);
                let v4821: string = string("}");
                let v4825: bool = true;
                let v4822 = v4818;
                let v4837: string = append(
                    (append(
                        (append((append(string("true; v4822 "), (v4821))), string("); "))),
                        string(""),
                    )),
                    string(" // rust.fix_closure\'"),
                );
