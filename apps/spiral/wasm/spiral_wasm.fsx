...
and method29 (v0 : Vec<uint8>, v1 : uint8) : std_pin_Pin<Box<Dyn<std_future_Future<Result<US4, anyhow_Error>>>>> =
    ...
    let v257 : near_workspaces_result_ExecutionFinalResult = method42(v70)
    ...
    let v306 : near_workspaces_result_ExecutionFinalResult = method45(v70)
    ...
    let v445 : string = method52(v314, v1, v259)
    ...
    let v468 : Result<US4, anyhow_Error> =
        if v446 then
            ...
            if v449 then
                ...
                v464
    let v469 : Result<US4, anyhow_Error> = method53(v468)
    let v470 : string = ""
    let v471 : string = "}"
...
and method28 (v0 : Vec<uint8>, v1 : uint8) : std_pin_Pin<Box<Dyn<std_future_Future<US6>>>> =
    ...
    let _v8 = v17 
    #endif
    let v18 : Result<US4, std_string_String> = _v8 
    let v21 : (US4 -> US7) = closure28()
    let v22 : (std_string_String -> US7) = closure29()
    let v23 : US7 = match v18 with Ok x -> v21 x | Error x -> v22 x
    let v265 : US6 =
        match v23 with
        | US7_1(v132) -> (* Error *)
            let v133 : bool = v1 >= 15uy
            if v133 then
                let v134 : unit = ()
                let v135 : (unit -> unit) = closure30(v1, v132)
                let v136 : unit = (fun () -> v135 (); v134) ()
                let v176 : unit = ()
                let v177 : (unit -> unit) = closure31()
                let v178 : unit = (fun () -> v177 (); v176) ()
                let v181 : string = "true; let __future_init = Box::pin(async move { //"
                let v182 : bool = Fable.Core.RustInterop.emitRustExpr () v181 
                let struct (v183 : uint8, v184 : US4) = method59(v1)
                let v185 : string = ""
                let v186 : string = "}"
                let v187 : string = v185 + v186 
                let v188 : _ = struct (v183, v184) 
                let v189 : unit = ()
                
#if FABLE_COMPILER || WASM || CONTRACT
                
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
                let v190 : string = $"true; let v188 = $0"
                let v191 : bool = Fable.Core.RustInterop.emitRustExpr v188 v190 
                let _v189 = v191 
                #endif
#if FABLE_COMPILER_RUST && WASM
                let v192 : string = $"true; let v188 = $0"
                let v193 : bool = Fable.Core.RustInterop.emitRustExpr v188 v192 
                let _v189 = v193 
                #endif
#if FABLE_COMPILER_RUST && CONTRACT
                let v194 : string = $"true; let v188 = $0"
                let v195 : bool = Fable.Core.RustInterop.emitRustExpr v188 v194 
                let _v189 = v195 
                #endif
#if FABLE_COMPILER_TYPESCRIPT
                let v196 : bool = true
                ...
                #endif
                let v199 : bool = _v189 
                let v202 : string = $"true; v188 " + v187 + "); " + v185 + " // rust.fix_closure'"
                let v203 : bool = Fable.Core.RustInterop.emitRustExpr () v202 
                let v204 : string = "__future_init"
                let v205 : _ = Fable.Core.RustInterop.emitRustExpr () v204 
                let v206 : string = "v205"
                let v207 : std_pin_Pin<Box<Dyn<std_future_Future<struct (uint8 * US4)>>>> = Fable.Core.RustInterop.emitRustExpr () v206 
                let v208 : string = "v207.await"
                let struct (v209 : uint8, v210 : US4) = Fable.Core.RustInterop.emitRustExpr () v208 
                US6_0(v209, v210)
            else
                let v212 : unit = ()
                let v213 : (unit -> unit) = closure32(v1, v132)
                let v214 : unit = (fun () -> v213 (); v212) ()
                let v254 : unit = ()
                let v255 : (unit -> unit) = closure33()
                let v256 : unit = (fun () -> v255 (); v254) ()
                let v259 : uint8 = v1 + 1uy
                let v260 : std_pin_Pin<Box<Dyn<std_future_Future<US6>>>> = method28(v0, v259)
                let v261 : string = "v260.await"
                let v262 : US6 = Fable.Core.RustInterop.emitRustExpr () v261 
                v262
        | US7_0(v24) -> (* Ok *)
            match v24 with
            | US4_1 -> (* None *)
                let v25 : string = "true; let __future_init = Box::pin(async move { //"
                let v26 : bool = Fable.Core.RustInterop.emitRustExpr () v25 
                let struct (v27 : uint8, v28 : US4) = method59(v1)
                let v29 : string = ""
                let v30 : string = "}"
                let v31 : string = v29 + v30 
                let v32 : _ = struct (v27, v28) 
                let v33 : unit = ()
                
#if FABLE_COMPILER || WASM || CONTRACT
                
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
                let v34 : string = $"true; let v32 = $0"
                let v35 : bool = Fable.Core.RustInterop.emitRustExpr v32 v34 
                let _v33 = v35 
                #endif
#if FABLE_COMPILER_RUST && WASM
                let v36 : string = $"true; let v32 = $0"
                let v37 : bool = Fable.Core.RustInterop.emitRustExpr v32 v36 
                let _v33 = v37 
                #endif
#if FABLE_COMPILER_RUST && CONTRACT
                let v38 : string = $"true; let v32 = $0"
                let v39 : bool = Fable.Core.RustInterop.emitRustExpr v32 v38 
                let _v33 = v39 
                #endif
#if FABLE_COMPILER_TYPESCRIPT
                let v40 : bool = true
                ...
                #endif
                let v43 : bool = _v33 
                let v46 : string = $"true; v32 " + v31 + "); " + v29 + " // rust.fix_closure'"
                ...
                let v50 : string = "v49"
                let v51 : std_pin_Pin<Box<Dyn<std_future_Future<struct (uint8 * US4)>>>> = Fable.Core.RustInterop.emitRustExpr () v50 
                let v52 : string = "v51.await"
                let struct (v53 : uint8, v54 : US4) = Fable.Core.RustInterop.emitRustExpr () v52 
                US6_0(v53, v54)
            | US4_0(v56) -> (* Some *)
                let v57 : unit = ()
                let v58 : (unit -> unit) = closure34(v1, v56)
                let v59 : unit = (fun () -> v58 (); v57) ()
                let v99 : string = "true; let __future_init = Box::pin(async move { //"
                let v100 : bool = Fable.Core.RustInterop.emitRustExpr () v99 
                let struct (v101 : uint8, v102 : US4) = method63(v1, v56)
                let v103 : string = ""
                let v104 : string = "}"
                let v105 : string = v103 + v104 
                let v106 : _ = struct (v101, v102) 
                let v107 : unit = ()
                
#if FABLE_COMPILER || WASM || CONTRACT
                
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
                let v108 : string = $"true; let v106 = $0"
                let v109 : bool = Fable.Core.RustInterop.emitRustExpr v106 v108 
                let _v107 = v109 
                #endif
#if FABLE_COMPILER_RUST && WASM
                let v110 : string = $"true; let v106 = $0"
                let v111 : bool = Fable.Core.RustInterop.emitRustExpr v106 v110 
                let _v107 = v111 
                #endif
#if FABLE_COMPILER_RUST && CONTRACT
                let v112 : string = $"true; let v106 = $0"
                let v113 : bool = Fable.Core.RustInterop.emitRustExpr v106 v112 
                let _v107 = v113 
                #endif
#if FABLE_COMPILER_TYPESCRIPT
                let v114 : bool = true
                ...
                #endif
                let v117 : bool = _v107 
                let v120 : string = $"true; v106 " + v105 + "); " + v103 + " // rust.fix_closure'"
                let v121 : bool = Fable.Core.RustInterop.emitRustExpr () v120 
                let v122 : string = "__future_init"
                let v123 : _ = Fable.Core.RustInterop.emitRustExpr () v122 
                let v124 : string = "v123"
                let v125 : std_pin_Pin<Box<Dyn<std_future_Future<struct (uint8 * US4)>>>> = Fable.Core.RustInterop.emitRustExpr () v124 
                let v126 : string = "v125.await"
                let struct (v127 : uint8, v128 : US4) = Fable.Core.RustInterop.emitRustExpr () v126 
                US6_1(v127, v128)
    let v266 : US6 = method64(v265)
    let v267 : string = ""
    let v268 : string = "}"
...
#if FABLE_COMPILER_RUST && !WASM && !CONTRACT
    let v272 : string = $"true; let v270 = $0"
    let v273 : bool = Fable.Core.RustInterop.emitRustExpr v270 v272 
    let _v271 = v273 
    #endif
#if FABLE_COMPILER_RUST && WASM
    let v274 : string = $"true; let v270 = $0"
    let v275 : bool = Fable.Core.RustInterop.emitRustExpr v270 v274 
    let _v271 = v275 
    #endif
#if FABLE_COMPILER_RUST && CONTRACT
    let v276 : string = $"true; let v270 = $0"
    let v277 : bool = Fable.Core.RustInterop.emitRustExpr v270 v276 
    let _v271 = v277 
    #endif
#if FABLE_COMPILER_TYPESCRIPT
    let v278 : bool = true
    ...
    #endif
    let v281 : bool = _v271 
    let v284 : string = $"true; v270 " + v269 + "); " + v267 + " // rust.fix_closure'"
    let v285 : bool = Fable.Core.RustInterop.emitRustExpr () v284 
    let v286 : string = "__future_init"
    let v287 : _ = Fable.Core.RustInterop.emitRustExpr () v286 
    let v288 : string = "v287"
    let v289 : std_pin_Pin<Box<Dyn<std_future_Future<US6>>>> = Fable.Core.RustInterop.emitRustExpr () v288 
    v289
...
and method24 (v0 : clap_ArgMatches) : std_pin_Pin<Box<Dyn<std_future_Future<Result<uint8, anyhow_Error>>>>> =
    ...
    let v100 : unit = ()
    let v101 : (unit -> unit) = closure35(v99)
    ...
    v188
and closure36 () (v0 : uint8) : US8 =
    US8_0(v0)
and closure37 () (v0 : std_string_String) : US8 =
    US8_1(v0)
and closure0 () (v0 : (string [])) : int32 =
    ...
    let v290 : string = "futures::executor::block_on($0)"
    let v291 : Result<uint8, anyhow_Error> = Fable.Core.RustInterop.emitRustExpr v289 v290 
    let v292 : (anyhow_Error -> std_string_String) = method54()
    let v293 : unit = ()
    ...
    let v295 : Result<uint8, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v291, v292) v294 
    let _v293 = v295 
    #endif
#if FABLE_COMPILER_RUST && WASM
    let v296 : string = "$0.map_err(|x| $1(x))"
    let v297 : Result<uint8, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v291, v292) v296 
    let _v293 = v297 
    #endif
#if FABLE_COMPILER_RUST && CONTRACT
    let v298 : string = "$0.map_err(|x| $1(x))"
    let v299 : Result<uint8, std_string_String> = Fable.Core.RustInterop.emitRustExpr struct (v291, v292) v298 
    let _v293 = v299 
    #endif
#if FABLE_COMPILER_TYPESCRIPT
    let v300 : Result<uint8, std_string_String> = match v291 with Ok x -> Ok x | Error x -> Error (v292 x)
    let _v293 = v300 
    #endif
#if FABLE_COMPILER_PYTHON
    let v301 : Result<uint8, std_string_String> = match v291 with Ok x -> Ok x | Error x -> Error (v292 x)
    let _v293 = v301 
    #endif
#else
    let v302 : Result<uint8, std_string_String> = match v291 with Ok x -> Ok x | Error x -> Error (v292 x)
    let _v293 = v302 
    #endif
    let v303 : Result<uint8, std_string_String> = _v293 
    let v306 : (uint8 -> US8) = closure36()
    let v307 : (std_string_String -> US8) = closure37()
    let v308 : US8 = match v303 with Ok x -> v306 x | Error x -> v307 x
    match v308 with
    | US8_1(v329) -> (* Error *)
        match v285 with
        | US4_0(v330) -> (* Some *)
            ...
            if v331 then
                ...
                let v333 : string = Fable.Core.RustInterop.emitRustExpr v329 v332 
                let v334 : bool = v333.Contains v330 
                if v334 then
                    ()
                else
                    let v337 : string = $"spiral_wasm.main / exception: '{v330}' / error: {v329}"
                    let v338 : unit = ()
                    ...
                    let v340 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v337 v339 
                    let _v338 = v340 
                    #endif
#if FABLE_COMPILER_RUST && WASM
                    let v341 : string = "Err($0)"
                    let v342 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v337 v341 
                    let _v338 = v342 
                    #endif
#if FABLE_COMPILER_RUST && CONTRACT
                    let v343 : string = "Err($0)"
                    let v344 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v337 v343 
                    let _v338 = v344 
                    #endif
#if FABLE_COMPILER_TYPESCRIPT
                    let v345 : Result<unit, string> = v337 |> Error
                    let _v338 = v345 
                    #endif
#if FABLE_COMPILER_PYTHON
                    let v346 : Result<unit, string> = v337 |> Error
                    let _v338 = v346 
                    #endif
#else
                    let v347 : Result<unit, string> = v337 |> Error
                    let _v338 = v347 
                    #endif
                    let v348 : Result<unit, string> = _v338 
                    let v351 : unit = ()
                    ...
                    Fable.Core.RustInterop.emitRustExpr v348 v352 
                    let _v351 = () 
                    #endif
#if FABLE_COMPILER_RUST && WASM
                    let v353 : string = "$0.unwrap()"
                    Fable.Core.RustInterop.emitRustExpr v348 v353 
                    let _v351 = () 
                    #endif
#if FABLE_COMPILER_RUST && CONTRACT
                    let v354 : string = "$0.unwrap()"
                    Fable.Core.RustInterop.emitRustExpr v348 v354 
                    let _v351 = () 
                    #endif
#if FABLE_COMPILER_TYPESCRIPT
                    match v348 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
                    let _v351 = () 
                    #endif
#if FABLE_COMPILER_PYTHON
                    match v348 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
        ...
        | _ ->
            ...
            let v357 : uint8 = Fable.Core.RustInterop.emitRustExpr v303 v356 
            let _v355 = v357 
            #endif
#if FABLE_COMPILER_RUST && WASM
            let v358 : string = "$0.unwrap()"
            let v359 : uint8 = Fable.Core.RustInterop.emitRustExpr v303 v358 
            let _v355 = v359 
            #endif
#if FABLE_COMPILER_RUST && CONTRACT
            let v360 : string = "$0.unwrap()"
            let v361 : uint8 = Fable.Core.RustInterop.emitRustExpr v303 v360 
            let _v355 = v361 
            #endif
#if FABLE_COMPILER_TYPESCRIPT
            let v362 : uint8 = match v303 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
            let _v355 = v362 
            #endif
#if FABLE_COMPILER_PYTHON
            let v363 : uint8 = match v303 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
            let _v355 = v363 
            #endif
#else
            let v364 : uint8 = match v303 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
            let _v355 = v364 
            #endif
            let v365 : uint8 = _v355 
            ()
    | US8_0(v309) -> (* Ok *)
        match v285 with
        | US4_0(v310) -> (* Some *)
            let v311 : string = $"spiral_wasm.main / retries: {v309} / exception: '{v310}'"
            let v312 : unit = ()
            ...
            let v314 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v311 v313 
            let _v312 = v314 
            #endif
#if FABLE_COMPILER_RUST && WASM
            let v315 : string = "Err($0)"
            let v316 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v311 v315 
            let _v312 = v316 
            #endif
#if FABLE_COMPILER_RUST && CONTRACT
            let v317 : string = "Err($0)"
            let v318 : Result<unit, string> = Fable.Core.RustInterop.emitRustExpr v311 v317 
            let _v312 = v318 
            #endif
#if FABLE_COMPILER_TYPESCRIPT
            let v319 : Result<unit, string> = v311 |> Error
            let _v312 = v319 
            #endif
#if FABLE_COMPILER_PYTHON
            let v320 : Result<unit, string> = v311 |> Error
            let _v312 = v320 
            #endif
#else
            let v321 : Result<unit, string> = v311 |> Error
            let _v312 = v321 
            #endif
            let v322 : Result<unit, string> = _v312 
            let v325 : unit = ()
            ...
            Fable.Core.RustInterop.emitRustExpr v322 v326 
            let _v325 = () 
            #endif
#if FABLE_COMPILER_RUST && WASM
            let v327 : string = "$0.unwrap()"
            Fable.Core.RustInterop.emitRustExpr v322 v327 
            let _v325 = () 
            #endif
#if FABLE_COMPILER_RUST && CONTRACT
            let v328 : string = "$0.unwrap()"
            Fable.Core.RustInterop.emitRustExpr v322 v328 
            let _v325 = () 
            #endif
#if FABLE_COMPILER_TYPESCRIPT
            match v322 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
            let _v325 = () 
            #endif
#if FABLE_COMPILER_PYTHON
            match v322 with Ok x -> x | Error e -> failwith $"resultm.unwrap' / e: {e}"
