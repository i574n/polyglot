...
and closure14 (v0 : US4 option ref) (v1 : US4 option) : US4 option ref =
    v0.Value <- v1 
    v0
and closure15 (v0 : std_string_String option, v1 : (US4 option -> US4 option ref)) () : unit =
    match v0 with
    | Some x -> (
    (fun () ->
    (fun () ->
...
and closure27 () () : string =
    let v0 : string = ""
    v0
and closure26 (v0 : Result<near_workspaces_result_ExecutionResult<near_workspaces_result_Value>, near_workspaces_result_ExecutionResult<near_primitives_errors_TxExecutionError>>) () : unit =
    let v1 : unit = ()
    let v2 : (unit -> unit) = closure2()
    let v3 : unit = (fun () -> v2 (); v1) ()
    let struct (v16 : Mut0, v17 : Mut1, v18 : Mut2, v19 : Mut3, v20 : int64 option) = State.trace_state.Value
...
and closure29 () () : string =
    let v0 : string = ""
    v0
and closure28 (v0 : Vec<Ref<near_workspaces_result_ExecutionOutcome>>) () : unit =
    let v1 : unit = ()
    let v2 : (unit -> unit) = closure2()
    let v3 : unit = (fun () -> v2 (); v1) ()
    let struct (v16 : Mut0, v17 : Mut1, v18 : Mut2, v19 : Mut3, v20 : int64 option) = State.trace_state.Value
...
and closure31 () () : string =
    let v0 : string = ""
    v0
and closure30 (v0 : Ref<Slice<near_workspaces_result_ExecutionOutcome>>) () : unit =
    let v1 : unit = ()
    let v2 : (unit -> unit) = closure2()
    let v3 : unit = (fun () -> v2 (); v1) ()
    let struct (v16 : Mut0, v17 : Mut1, v18 : Mut2, v19 : Mut3, v20 : int64 option) = State.trace_state.Value
...
and closure35 () () : string =
    let v0 : string = ""
    v0
and closure34 (v0 : Result<std_string_String, near_workspaces_error_Error>) () : unit =
    let v1 : unit = ()
    let v2 : (unit -> unit) = closure2()
    let v3 : unit = (fun () -> v2 (); v1) ()
    let struct (v16 : Mut0, v17 : Mut1, v18 : Mut2, v19 : Mut3, v20 : int64 option) = State.trace_state.Value
...
and method10 (v0 : clap_ArgMatches) : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, anyhow_Error>>>>> =
    ...
    let v10 : (US4 option -> US4 option ref) = closure14(v9)
    let v11 : unit = ()
    let v12 : (unit -> unit) = closure15(v7, v10)
    ...
    let v3101 : string = "  true; println!(\"\\n\\n state_main transact result: {:#?}\", v2322.clone()); //"
    let v3102 : bool = Fable.Core.RustInterop.emitRustExpr () v3101 
    let v3103 : string = "  true; println!(\"\\n\\n print_usd:\"); //"
    let v3104 : bool = Fable.Core.RustInterop.emitRustExpr () v3103 
    let v3105 : string = "  true; print_usd(v2322.clone()); //"
    let v3106 : bool = Fable.Core.RustInterop.emitRustExpr () v3105 
    let v3107 : string = "$0.into_result()"
    let v3108 : Result<near_workspaces_result_ExecutionResult<near_workspaces_result_Value>, near_workspaces_result_ExecutionResult<near_primitives_errors_TxExecutionError>> = Fable.Core.RustInterop.emitRustExpr v2322 v3107 
    let v3109 : unit = ()
    let v3110 : (unit -> unit) = closure26(v3108)
    let v3111 : unit = (fun () -> v3110 (); v3109) ()
    let v3872 : near_workspaces_result_ExecutionFinalResult = method12(v2322)
    let v3873 : string = "v3872.receipt_failures()"
    let v3874 : Vec<Ref<near_workspaces_result_ExecutionOutcome>> = Fable.Core.RustInterop.emitRustExpr () v3873 
    let v3875 : unit = ()
    let v3876 : (unit -> unit) = closure28(v3874)
    let v3877 : unit = (fun () -> v3876 (); v3875) ()
    let v4638 : near_workspaces_result_ExecutionFinalResult = method13(v2322)
    let v4639 : string = "v4638.receipt_outcomes()"
    let v4640 : Ref<Slice<near_workspaces_result_ExecutionOutcome>> = Fable.Core.RustInterop.emitRustExpr () v4639 
    let v4641 : unit = ()
    let v4642 : (unit -> unit) = closure30(v4640)
    let v4643 : unit = (fun () -> v4642 (); v4641) ()
    let v5404 : string = "$0.json()"
    let v5405 : Result<std_string_String, near_workspaces_error_Error> = Fable.Core.RustInterop.emitRustExpr v2322 v5404 
    let v5406 : unit = ()
    let v5407 : (unit -> unit) = closure32(v5405)
    let v5408 : unit = (fun () -> v5407 (); v5406) ()
    let v6169 : string = "$0.borsh()"
    let v6170 : Result<std_string_String, near_workspaces_error_Error> = Fable.Core.RustInterop.emitRustExpr v2322 v6169 
    let v6171 : unit = ()
    let v6172 : (unit -> unit) = closure34(v6170)
    let v6173 : unit = (fun () -> v6172 (); v6171) ()
    let v6934 : string = "  true; println!(\"\\n\\n worker: {:#?}\", v781); //"
    let v6935 : bool = Fable.Core.RustInterop.emitRustExpr () v6934 
    let v6936 : string = "  true; println!(\"\\n\\n contract: {:#?}\", v1550); //"
    let v6937 : bool = Fable.Core.RustInterop.emitRustExpr () v6936 
    let v6938 : string = "$0.len()"
    let v6939 : unativeint = Fable.Core.RustInterop.emitRustExpr v3874 v6938 
    let v6940 : (unativeint -> int32) = int32
    let v6941 : int32 = v6940 v6939
    let v6942 : bool = v6941 = 0
    let v6949 : Result<unit, anyhow_Error> =
        if v6942 then
            let v6943 : Result<unit, anyhow_Error> = Ok () 
            v6943
        else
            let v6944 : string = "anyhow::anyhow!($0)"
            let v6945 : string = "<error>"
            let v6946 : anyhow_Error = Fable.Core.RustInterop.emitRustExpr v6945 v6944 
            let v6947 : string = "Err(v6946)"
            let v6948 : Result<unit, anyhow_Error> = Fable.Core.RustInterop.emitRustExpr () v6947 
            v6948
    let v6950 : Result<unit, anyhow_Error> = method14(v6949)
    let v6951 : string = ""
    let v6952 : string = "}"
    let v6953 : string = v6951 + v6952 
    let v6954 : string = "true; v6950 " + v6953 + "); " + v6951 + " // rust.fix_closure'"
    let v6955 : bool = Fable.Core.RustInterop.emitRustExpr () v6954 
    let v6956 : string = "__result"
    let v6957 : _ = Fable.Core.RustInterop.emitRustExpr () v6956 
    let v6958 : string = "v6957"
    let v6959 : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, anyhow_Error>>>>> = Fable.Core.RustInterop.emitRustExpr () v6958 
    v6959
and closure1 () (v0 : (string [])) : int32 =
    ...
    let v769 : clap_Command = method9()
    let v770 : string = "clap::Command::get_matches($0)"
    let v771 : clap_ArgMatches = Fable.Core.RustInterop.emitRustExpr v769 v770 
    let v772 : std_pin_Pin<Box<Dyn<std_future_Future<Result<unit, anyhow_Error>>>>> = method10(v771)
    let v773 : string = $"tokio::runtime::Builder::new_multi_thread().enable_all().build().unwrap()"
    let v774 : _ = Fable.Core.RustInterop.emitRustExpr () v773 
    let v775 : string = "v774.handle().block_on($0)"
    let v776 : Result<unit, anyhow_Error> = Fable.Core.RustInterop.emitRustExpr v772 v775 
    let v777 : string = "$0.unwrap()"
    Fable.Core.RustInterop.emitRustExpr v776 v777 
    0
