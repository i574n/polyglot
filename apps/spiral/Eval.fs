        ...
        then
            ...
            let testsToggled, traceToggled, builderCommands =
                ...
                if mold |> Directory.Exists then
                    ...
                    let builderCommands =
                        ...
                        |> Array.filter (fun x ->
                            let appdata =
                                ...
                                then appdata |> SpiralSm.replace " (Some Wasm)" ""
                                elif x |> SpiralSm.contains "-c"
                                then appdata |> SpiralSm.replace " (Some Contract)" ""
                    ...
                    appdata |> SpiralSm.contains "tests = false" |> not,
                    appdata |> SpiralSm.contains "trace = false" |> not,
                    builderCommands
