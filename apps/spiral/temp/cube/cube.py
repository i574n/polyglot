...
def closure2(v0_1: float, v1: float, v2: float, _arg: tuple[float, float]) -> IEnumerable_1[tuple[int, float, str]]:
    v3: float = _arg[0]
    v5: float = -v3
    def _arrow265(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[float]:
        v77: Mut0 = Mut0(v5)
        def _arrow262(__unit: None=None) -> bool:
            return method9(v3, v77)

        def _arrow264(__unit: None=None) -> IEnumerable_1[float]:
            def _arrow263(__unit: None=None) -> IEnumerable_1[float]:
                v81: float = v77.l0 + 0.6
                v77.l0 = v81
                return empty()

            return append(singleton(v77.l0), delay(_arrow263))

        return enumerate_while(_arrow262, delay(_arrow264))

    v151: IEnumerable_1[float] = method10(delay(_arrow265))
    ...
    def _arrow268(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[tuple[int, float, str]]:
        def _arrow267(cube_x: float) -> IEnumerable_1[tuple[int, float, str]]:
            def _arrow266(cube_y: float) -> IEnumerable_1[tuple[int, float, str]]:
                return choose(v153, v152(cube_x)(cube_y))

            return collect(_arrow266, v151)

        return collect(_arrow267, v151)

    return delay(_arrow268)


def method8(v0_1: float, v1: float, v2: float) -> Callable[[tuple[float, float]], IEnumerable_1[tuple[int, float, str]]]:
    def _arrow269(_arg10: tuple[float, float], v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> IEnumerable_1[tuple[int, float, str]]:
...
def closure6(v0_1: Array[US4], v1: int) -> Callable[[tuple[float, str]], None]:
    def _arrow270(_arg10: tuple[float, str], v0_1: Any=v0_1, v1: Any=v1) -> None:
...
def method6(v0_1: int, v1: int, v2: float, v3: float, v4: float) -> Async[None]:
    def _arrow284(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Async[None]:
        ...
        def _arrow273(_arg_1: int) -> Async[None]:
            ...
            def _arrow282(__unit: None=None) -> Async[None]:
                ...
                def _arrow281(__unit: None=None) -> Async[None]:
                    ...
                    def _arrow278(__unit: None=None) -> Async[None]:
                        ...
                        return singleton_1.Combine(singleton_1.ReturnFrom(v3720), singleton_1.Delay(_arrow277))

                    def _arrow279(__unit: None=None) -> Async[None]:
                        return singleton_1.Zero()

                    return singleton_1.Combine(_expr276() if v3715 else _arrow278(), singleton_1.Delay(_arrow279))

                return singleton_1.Bind(v3702, _arrow281)

            return singleton_1.Combine(_expr275() if v3676 else singleton_1.Zero(), singleton_1.Delay(_arrow282))

        return singleton_1.Combine(singleton_1.For(range_big_int(0, 1, 44 - 1), _arrow273), singleton_1.Delay(_arrow283))
...
def _arrow285(v: Array[str]) -> None:
    closure0(None, v)


v0: Callable[[Array[str]], None] = _arrow285
