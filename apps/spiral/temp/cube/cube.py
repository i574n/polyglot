...
def closure2(v0_1: float, v1: float, v2: float, _arg: tuple[float, float]) -> IEnumerable_1[tuple[int, float, str]]:
    ...
    def _arrow296(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[float]:
        ...
        def _arrow295(__unit: None=None) -> IEnumerable_1[float]:
            ...
            return append(singleton(v77.l0), delay(_arrow294))

        return enumerate_while(_arrow293, delay(_arrow295))

    v151: IEnumerable_1[float] = method10(delay(_arrow296))
    ...
    def _arrow300(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[tuple[int, float, str]]:
        def _arrow299(cube_x: float) -> IEnumerable_1[tuple[int, float, str]]:
            ...
            return collect(_arrow298, v151)

        return collect(_arrow299, v151)
...
def method6(v0_1: int, v1: int, v2: float, v3: float, v4: float) -> Async[None]:
    def _arrow315(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Async[None]:
        ...
        def _arrow304(_arg_1: int) -> Async[None]:
            ...
            def _arrow312(__unit: None=None) -> Async[None]:
                ...
                def _arrow311(__unit: None=None) -> Async[None]:
                    ...
                    def _arrow309(__unit: None=None) -> Async[None]:
                        ...
                        return singleton_1.Combine(singleton_1.ReturnFrom(v3720), singleton_1.Delay(_arrow308))

                    def _arrow310(__unit: None=None) -> Async[None]:
                        return singleton_1.Zero()

                    return singleton_1.Combine(_expr307() if v3715 else _arrow309(), singleton_1.Delay(_arrow310))

                return singleton_1.Bind(v3702, _arrow311)

            return singleton_1.Combine(_expr306() if v3676 else singleton_1.Zero(), singleton_1.Delay(_arrow312))

        return singleton_1.Combine(singleton_1.For(range_big_int(0, 1, 44 - 1), _arrow304), singleton_1.Delay(_arrow313))

    return singleton_1.Delay(_arrow315)
...
def _arrow320(v: Array[str]) -> None:
    closure0(None, v)


v0: Callable[[Array[str]], None] = _arrow320
