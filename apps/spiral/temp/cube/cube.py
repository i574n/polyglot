...
def closure3(v0_1: float, v1: float, v2: float, v3: float, v4: float, v5: float) -> Callable[[float], FSharpList[US3]]:
    def _arrow280(v: float, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4, v5: Any=v5) -> FSharpList[US3]:
...
def method11(v0_1: float, v1: float, v2: float, v3: float, v4: float) -> Callable[[float, float], FSharpList[US3]]:
    def _arrow281(v: float, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Callable[[float], FSharpList[US3]]:
...
def method13(__unit: None=None) -> Callable[[US3], tuple[int, float, str] | None]:
    def _arrow282(v: US3) -> tuple[int, float, str] | None:
...
def closure2(v0_1: float, v1: float, v2: float, _arg: tuple[float, float]) -> IEnumerable_1[tuple[int, float, str]]:
    v3: float = _arg[0]
    v5: float = -v3
    def _arrow286(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[float]:
        v77: Mut0 = Mut0(v5)
        def _arrow283(__unit: None=None) -> bool:
            return method9(v3, v77)

        def _arrow285(__unit: None=None) -> IEnumerable_1[float]:
            def _arrow284(__unit: None=None) -> IEnumerable_1[float]:
                v81: float = v77.l0 + 0.6
                v77.l0 = v81
                return empty()

            return append(singleton(v77.l0), delay(_arrow284))

        return enumerate_while(_arrow283, delay(_arrow285))

    v151: IEnumerable_1[float] = method10(delay(_arrow286))
    ...
    def _arrow289(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[tuple[int, float, str]]:
        def _arrow288(cube_x: float) -> IEnumerable_1[tuple[int, float, str]]:
            def _arrow287(cube_y: float) -> IEnumerable_1[tuple[int, float, str]]:
                return choose(v153, v152(cube_x)(cube_y))

            return collect(_arrow287, v151)

        return collect(_arrow288, v151)

    return delay(_arrow289)


def method8(v0_1: float, v1: float, v2: float) -> Callable[[tuple[float, float]], IEnumerable_1[tuple[int, float, str]]]:
    def _arrow290(_arg10: tuple[float, float], v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> IEnumerable_1[tuple[int, float, str]]:
...
def closure6(v0_1: Array[US4], v1: int) -> Callable[[tuple[float, str]], None]:
    def _arrow292(_arg10: tuple[float, str], v0_1: Any=v0_1, v1: Any=v1) -> None:
...
def method6(v0_1: int, v1: int, v2: float, v3: float, v4: float) -> Async[None]:
    def _arrow307(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Async[None]:
        ...
        def _arrow295(_arg_1: int) -> Async[None]:
            ...
            def _arrow305(__unit: None=None) -> Async[None]:
                ...
                def _arrow304(__unit: None=None) -> Async[None]:
                    ...
                    def _arrow302(__unit: None=None) -> Async[None]:
                        ...
                        return singleton_1.Combine(singleton_1.ReturnFrom(v3720), singleton_1.Delay(_arrow301))

                    def _arrow303(__unit: None=None) -> Async[None]:
                        return singleton_1.Zero()

                    return singleton_1.Combine(_expr300() if v3715 else _arrow302(), singleton_1.Delay(_arrow303))

                return singleton_1.Bind(v3702, _arrow304)

            return singleton_1.Combine(_expr299() if v3676 else singleton_1.Zero(), singleton_1.Delay(_arrow305))

        return singleton_1.Combine(singleton_1.For(range_big_int(0, 1, 44 - 1), _arrow295), singleton_1.Delay(_arrow306))

    return singleton_1.Delay(_arrow307)
...
def _arrow308(v: Array[str]) -> None:
    closure0(None, v)


v0: Callable[[Array[str]], None] = _arrow308
