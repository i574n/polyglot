...
def method6(v0_1: int, v1: int, v2: float, v3: float, v4: float) -> Async[None]:
    def _arrow317(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Async[None]:
            ...
            def _arrow315(__unit: None=None) -> Async[None]:
                ...
                def _arrow314(__unit: None=None) -> Async[None]:
                    ...
                    def _arrow312(__unit: None=None) -> Async[None]:
                        ...
                        return singleton_1.Combine(singleton_1.ReturnFrom(v3720), singleton_1.Delay(_arrow311))

                    def _arrow313(__unit: None=None) -> Async[None]:
                        return singleton_1.Zero()

                    return singleton_1.Combine(_expr308() if v3715 else _arrow312(), singleton_1.Delay(_arrow313))

                return singleton_1.Bind(v3702, _arrow314)

            return singleton_1.Combine(_expr306() if v3676 else singleton_1.Zero(), singleton_1.Delay(_arrow315))

        return singleton_1.Combine(singleton_1.For(range_big_int(0, 1, 44 - 1), _arrow304), singleton_1.Delay(_arrow316))

    return singleton_1.Delay(_arrow317)
