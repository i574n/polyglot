...
def closure3(v0_1: float, v1: float, v2: float, v3: float, v4: float, v5: float) -> Callable[[float], FSharpList[US3]]:
    def _arrow220(v: float, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4, v5: Any=v5) -> FSharpList[US3]:
...
def method9(v0_1: float, v1: float, v2: float, v3: float, v4: float) -> Callable[[float, float], FSharpList[US3]]:
    def _arrow221(v: float, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Callable[[float], FSharpList[US3]]:
...
def method11(__unit: None=None) -> Callable[[US3], tuple[int, float, str] | None]:
    def _arrow222(v: US3) -> tuple[int, float, str] | None:
...
def closure2(v0_1: float, v1: float, v2: float, _arg: tuple[float, float]) -> IEnumerable_1[tuple[int, float, str]]:
    v3: float = _arg[0]
    v5: float = -v3
    def _arrow226(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[float]:
        v7: Mut0 = Mut0(v5)
        def _arrow223(__unit: None=None) -> bool:
            return method7(v3, v7)

        def _arrow225(__unit: None=None) -> IEnumerable_1[float]:
            def _arrow224(__unit: None=None) -> IEnumerable_1[float]:
                v11: float = v7.l0 + 0.6
                v7.l0 = v11
                return empty()

            return append(singleton(v7.l0), delay(_arrow224))

        return enumerate_while(_arrow223, delay(_arrow225))

    v16: IEnumerable_1[float] = method8(delay(_arrow226))
    v17: Callable[[float, float], FSharpList[US3]] = method9(v0_1, v1, v2, v3, _arg[1])
    v18: Callable[[US3], tuple[int, float, str] | None] = method11()
    def _arrow229(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, _arg: Any=_arg) -> IEnumerable_1[tuple[int, float, str]]:
        def _arrow228(cube_x: float) -> IEnumerable_1[tuple[int, float, str]]:
            def _arrow227(cube_y: float) -> IEnumerable_1[tuple[int, float, str]]:
                return choose(v18, v17(cube_x)(cube_y))

            return collect(_arrow227, v16)

        return collect(_arrow228, v16)

    return delay(_arrow229)


def method6(v0_1: float, v1: float, v2: float) -> Callable[[tuple[float, float]], IEnumerable_1[tuple[int, float, str]]]:
    def _arrow230(_arg10: tuple[float, float], v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2) -> IEnumerable_1[tuple[int, float, str]]:
...
def closure6(v0_1: Array[US4], v1: int) -> Callable[[tuple[float, str]], None]:
    def _arrow231(_arg10: tuple[float, str], v0_1: Any=v0_1, v1: Any=v1) -> None:
...
def method4(v0_1: int, v1: int, v2: float, v3: float, v4: float) -> Async[None]:
    def _arrow243(__unit: None=None, v0_1: Any=v0_1, v1: Any=v1, v2: Any=v2, v3: Any=v3, v4: Any=v4) -> Async[None]:
        ...
        def _arrow232(_arg_1: int) -> Async[None]:
            ...
            def _arrow241(__unit: None=None) -> Async[None]:
                ...
                def _arrow240(__unit: None=None) -> Async[None]:
                    ...
                    def _arrow238(__unit: None=None) -> Async[None]:
                        ...
                        return singleton_1.Combine(singleton_1.ReturnFrom(v167), singleton_1.Delay(_arrow237))

                    def _arrow239(__unit: None=None) -> Async[None]:
                        return singleton_1.Zero()

                    return singleton_1.Combine(_expr236() if v162 else _arrow238(), singleton_1.Delay(_arrow239))

                return singleton_1.Bind(v150, _arrow240)

            return singleton_1.Combine(_expr235() if v129 else singleton_1.Zero(), singleton_1.Delay(_arrow241))

        return singleton_1.Combine(singleton_1.For(range_big_int(0, 1, 44 - 1), _arrow232), singleton_1.Delay(_arrow242))

    return singleton_1.Delay(_arrow243)
...
def _arrow244(v: Array[str]) -> None:
    closure0(None, v)


v0: Callable[[Array[str]], None] = _arrow244
