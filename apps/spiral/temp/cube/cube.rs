...
mod module_62c167ba {
    pub mod Cube {
        ...
        impl core::fmt::Display for Cube::US0 {
        ...
        impl core::fmt::Display for Cube::US1 {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                write!(f, "{}", core::any::type_name::<Self>())
            }
        }
        ...
        impl core::fmt::Display for Cube::US2 {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                write!(f, "{}", core::any::type_name::<Self>())
            }
        }
        ...
        impl core::fmt::Display for Cube::Mut0 {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                write!(f, "{}", core::any::type_name::<Self>())
            }
        }
        ...
        impl core::fmt::Display for Cube::US3 {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                write!(f, "{}", core::any::type_name::<Self>())
            }
        }
        ...
        impl core::fmt::Display for Cube::US4 {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                write!(f, "{}", core::any::type_name::<Self>())
            }
        }
        ...
        pub fn method3() -> Func1<string, Cube::US2> {
        ...
        pub fn method1(v0_1: string) -> string {
            ...
            let v14: string = Cube::method2();
            v13.unwrap_or(v14)
        }
        pub fn method5(v0_1: f64, v1: f64, v2: f64) -> (f64, f64, f64) {
            (v0_1, v1, v2)
        }
        pub fn method7(v0_1: f64, v1: LrcPtr<Cube::Mut0>) -> bool {
            v1.l0.get().clone() < v0_1
        }
        pub fn method8(v0_1: LrcPtr<dyn IEnumerable_1<f64>>) -> LrcPtr<dyn IEnumerable_1<f64>> {
            v0_1
        }
        pub fn method10(
            v0_1: f64,
            ...
            let v45: f64 = 1.0_f64 / (v15 * v26 - v9 * v26 + v0_1 * v10 + 100.0_f64);
            let v52: f64 = 40.0_f64 * v45;
            let v78: i32 = (160_i32 as f64 / 2.0_f64 + v7 + v52 * (v25 + v27 * v12) * 2.0_f64)
                as i32
                + (44_i32 as f64 / 2.0_f64
                    + v52 * (v19 * v12 + v23 * v12 - v11 * v20 + v16 * v20 - v27 * v20))
                    as i32
                    * 160_i32;
            if if v78 >= 0_i32 { v78 < 7040_i32 } else { false } {
        ...
        pub fn closure4(
            ...
            let v12: f64 = -v5;
            ofArray(new_array(&[
                Cube::method10(v5, v6, v7, ';', v0_1, v1, v2, v4),
                Cube::method10(v3, v6, v5, '\\', v0_1, v1, v2, v4),
                Cube::method10(v7, v6, v12, '/', v0_1, v1, v2, v4),
                Cube::method10(v12, v6, v3, '=', v0_1, v1, v2, v4),
                Cube::method10(v5, v7, -v6, '>', v0_1, v1, v2, v4),
                Cube::method10(v5, v3, v6, '<', v0_1, v1, v2, v4),
            ]))
        }
        pub fn closure3(
            v0_1: f64,
        ...
        pub fn method11() -> Func1<Cube::US3, Option<(i32, f64, char)>> {
        ...
        pub fn closure2(
            ...
            let v5: f64 = -v3;
            let v16: LrcPtr<dyn IEnumerable_1<f64>> = Cube::method8(delay(Func0::new({
                let v3 = v3.clone();
                let v5 = v5.clone();
                move || {
                    let v7: LrcPtr<Cube::Mut0> = LrcPtr::new(Cube::Mut0 {
                        l0: MutCell::new(v5),
                    });
                    enumerateWhile(
                        Func0::new({
                            let v7 = v7.clone();
                            move || Cube::method7(v3, v7.clone())
                        }),
                        delay(Func0::new({
                            let v7 = v7.clone();
                            move || {
                                append(
                                    singleton(v7.l0.get().clone()),
                                    delay(Func0::new({
                                        let v7 = v7.clone();
                                        move || {
                                            let v11: f64 = v7.l0.get().clone() + 0.6_f64;
                                            v7.l0.set(v11);
                                            ();
                                            empty::<f64>()
                                        }
            ...
            let v17 = Cube::method9(v0_1, v1, v2, v3, _arg.1.clone());
            let v18 = Cube::method11();
            delay(Func0::new({
                let v16 = v16.clone();
                let v17 = v17.clone();
                let v18 = v18.clone();
                            ...
                            move |cube_x: f64| {
                                collect(
                                    Func1::new({
                                        ...
                                        let v18 = v18.clone();
                                        move |cube_y: f64| {
                                            choose(v18.clone(), ofList(v17(cube_x)(cube_y)))
                                        }
                                    }),
                                    v16.clone(),
                                )
        ...
        pub fn method4(v0_1: i32, v1: i32, v2: f64, v3: f64, v4: f64) -> Arc<Async<()>> {
            defaultOf()
        }
